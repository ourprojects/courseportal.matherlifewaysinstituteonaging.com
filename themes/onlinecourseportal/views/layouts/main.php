...
<body>
	...
	<div id="page">
				...
				$this->widget(
							...
							array('items' => array(
									...
									array('label' => '<span id="menu-forum" title="{t}Forum{/t}"></span>',
											'url' => PhpbbModule::getInstance()->getForumUrlWithSid(),
		...
		<div id="footer" style="background-image: url('<?php echo $theme->getImagesUrl('bg-foot.jpg'); ?>');">
			<div class="container">
				<div class="logo">
					<a href="http://www.matherlifewaysinstituteonaging.com/" target="_blank" title="{t}Mather LifeWays Institute on Aging{/t}"> <img src="<?php echo $theme->getImagesUrl('logo-footer.jpg'); ?>" alt="{t}Logo{/t}" />
					</a>
				</div>
				<div id="icons">
					<a class="twitter" href="http://twitter.com/aginginaction" title="{t}Twitter{/t}" rel="nofollow" target="_blank"
						...
						-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; "> </a> <a class="linkedin" href="http://www.linkedin.com/in/kenadams60201" title="{t}LinkedIn{/t}" rel="nofollow" target="_blank"
						style="background-image: url('<?php echo $theme->getImagesUrl('icon-linkedin.png'); ?>');"> </a> <a class="youtube" href="http://www.youtube.com/matherlifeways" title="{t}YouTube{/t}" rel="nofollow" target="_blank"
						style="background-image: url('<?php echo $theme->getImagesUrl('icon-youtube.png'); ?>');"> </a>
				</div>
				<div id="copyright">
					<ul>
