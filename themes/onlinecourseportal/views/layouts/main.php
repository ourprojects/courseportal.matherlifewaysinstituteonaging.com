	...
	<div class="container" id="page">
		...
		<div id="header">
			...
			<div id="mainmenu">
				...
				if(!isset($this->menu))
					$this->menu = array(
									array('label' => '<span id="menu-home" title="'.Yii::t('onlinecourseportal', 'Home').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('home/index')),
									array('label' => '<span id="menu-contact" title="'.Yii::t('onlinecourseportal', 'Contact Us').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('home/contact')),
									array('label' => '<span id="menu-register" title="'.Yii::t('onlinecourseportal', 'Register').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('user/register'),
											'visible' => Yii::app()->user->isGuest),
									array('label' => '<span id="menu-login" title="'.Yii::t('onlinecourseportal', 'Login').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('user/login'),
											'visible' => Yii::app()->user->isGuest),
									array('label' => '<span id="menu-profile" title="'.Yii::t('onlinecourseportal', 'Profile / Files').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('user/profile'),
											'visible' => !Yii::app()->user->isGuest),
									array('label' => '<span id="menu-forum" title="'.Yii::t('onlinecourseportal', 'Forum').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('forum/index'),
											'visible' => !Yii::app()->user->isGuest),
									array('label' => '<span id="menu-courses" title="'.Yii::t('onlinecourseportal', 'Courses').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('course/index'),
											'visible' => !Yii::app()->user->isGuest),
									array('label' => '<span id="menu-admin" title="'.Yii::t('onlinecourseportal', 'Admin').'"></span>',
											'url' => Yii::app()->createAbsoluteUrl('admin/index'),
											'visible' => Yii::app()->user->isAdmin),
									array('label' => '<span id="menu-logout" title="'.Yii::t('onlinecourseportal', 'Logout').'"></span>',
