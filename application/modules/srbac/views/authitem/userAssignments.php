...
<table class="srbacDataGrid" width="100%">
	<tr>
		...
		<th class="operations"><?php echo Yii::t('srbac','Operations')?>
		</th>
	</tr>
	<tr>
		<td valign="top" colspan="3">
			<table class="roles">
				...
				<tr>
					<td><b><?php echo $i ?> </b> <?php foreach ($roles as $j=>$tasks) { ?>
						<table class="tasks">
							<tr>
								<td valign="top"><?php echo $j; ?>
									<table class="operations">
										<tr>
											<td valign="top"><?php foreach ($tasks as $j=>$opers) { ?> <?php echo $opers."<br />";  ?>
												<?php } ?>
											</td>
										</tr>
									</table>
