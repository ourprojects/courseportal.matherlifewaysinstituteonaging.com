...
<div style="margin: 10px" id="obsoleteList">
	<table class="srbacDataGrid" style="width: 50%">
		<tr>
			<th>
			<?php echo Yii::t("srbac","The following items doesn't seem to belong to a controller"); ?>
			</th>
		<tr>
		<tr>
			<td>
				<div class="srbacForm">
					...
					<div>
						<?php echo SHtml::checkBoxList("items", "", $items, array("checkAll"=>Yii::t('srbac','Check All')));?>
					</div>
					<div class="action">
						<?php
...
<table class="srbacDataGrid" style="width: 50%">
	<tr>
		<th>
		<?php echo Yii::t("srbac", "No authItems that don't belong to a controller were found"); ?>
		</th>
	</tr>
</table>
<?php endif; ?>
