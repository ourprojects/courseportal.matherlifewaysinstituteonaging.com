...
class ManageController extends SBaseController
{
		...
		switch($ajax)
		{
			...
			case 'autoGeneratedAuthItem-grid':
				...
				$params = array(
						...
						'updateGridIds' => array('autoMissingAuthItem-grid', 'autoObsoleteAuthItem-grid'),
	...
	public function actionCreate()
	{
		...
		{
			$this->createNewAuthItem($_POST['AuthItem']);
		}
		else
		{
			if(isset($_POST['AuthItems']))
			{
				...
				{
					$this->createNewAuthItem($attributes);
				}
				$this->_model = new AuthItem;
			}
		}
	...
	public function createNewAuthItem($attributes)
	{
		$this->_model = new AuthItem;
