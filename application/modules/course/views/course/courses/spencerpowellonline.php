...
<div id="sidebar">
	<div class="box-sidebar one">
		...
		<p>{t}Please click the button below to access your personal Activity Log.{/t}</p>
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('spencer/166312138.png'); ?>" id="certificate" alt="{t}Image{/t}">
	</div>
	<div class="box-sidebar one">
		...
		<p>
			<a href="#lesson-3-slide-1" data-fancybox-group="lesson-3" class="teal lesson-3 button">Contact Facilitator</a>
		</p>
		<img src="<?php echo $this->getImagesUrl('spencer/80608570.png'); ?>" alt="{t}Facilitator{/t}" id="facilitator">
	</div>
</div>
...
<div class="column-wide">
	...
	<table style="border: solid black; padding: 0px;">
				<tr>
					<td>
					<h4>{t}Module{/t}</h4>
					</td>		
...
data-fancybox-group="lesson-1" class="hide lesson-1"></a><a href="#lesson-1-slide-22" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-23"
					...
					<tr>
					<td>
					<h4>{t}Memory Strategy / Activity{/t}</h4>
					</td>		
					
					<td>
					<ul class="modules">
					<li>
						<a href="#lesson-2-slide-1" data-fancybox-group="lesson-2" class="teal lesson-2 button">{t}Improving Attention{/t}</a> 
