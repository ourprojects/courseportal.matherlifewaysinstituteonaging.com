	...
	<div id="lesson3">
		...
		<div id="lesson-3-slide-26" class="course-slide">
			<div class="content">
				...
				<hr />
				<p class="forum">Without looking back at the previous slide, try and answer the following questions on the Forum:</p>
				<ul class="forum">
					<li>What were the categories?</li>
					<li>What was on the list?</li>
				</ul>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-3-slide-30" class="course-slide">
			<div class="content">
				...
				<p class="forum">
					If possible, please share your goals on the Forum to help with <u>encouragement </u>and <u>accountability</u>.
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-3-slide-31" class="course-slide">
			<div class="content">
				...
				<p class="forum">3. Discussion of participant reactions / experiences (2-3 minutes). Any reactions? What did you notice / how did it feel? Problems? Post your responses to the Forum.</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
	...
	<div id="lesson-4">
		...
		<div id="lesson-4-slide-19" class="course-slide">
			<div class="content">
				...
				<hr />
				<ul>
					<li>How does intellectual stimulation help you invest in your Cognitive Reserve?</li>
					<li>What types of intellectual activities seem protective?</li>
					<li>Why would you want to diversify your intellectual investments?</li>
					<li>What is the one “rule of thumb” mental activity that likely has the biggest effect on maintaining brain function?</li>
					<li>What is this week’s Memory Strategy?</li>
					<li>What is Working Memory?</li>
					<li>What are some ways to make associations to improve your memory?</li>
					<li>What are your goals for this week?</li>
				</ul>
	...
	<div id="lesson-6">
		...
		<div id="lesson-6-slide-2" class="course-slide">
			<div class="content">
				...
				<p class="forum">Please answer the following quetsions on the Forum:</p>
				<ul class="forum">
					<li>How did you do with your goals from last week?</li>
					<li>Those of you who met your goals, are there any tips or pointers you could share with the class about how you went about those goals? (give an example, was it easy to develop a habit of meeting your goal first thing in the morning or right before bed?)</li>
					<li>Those of you who had trouble this week, was there a particular barrier that you encountered? Do you have a concrete plan for overcoming that barrier and achieving your goals for the coming week.</li>
				</ul>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
...
" target="_blank">Beautiful-Minds.com</a>
		...
		<div id="lesson-7-slide-15" class="course-slide">
			<div class="content">
				...
				<p>
				This is easy to do in a conversation. Simply repeat what the other person said in the form of a question. It may seem awkward at first, but you may do it naturally already without realizing it. It is standard practice of conversation. “The Empire State Building is at the corner of 34th street and 5th Avenue, you say?”{/t}
				</p>
