	...
	<table>
		...
		<tr>
			...
			<td>
				<ul class="modules">
					<li>
						<a href="#lesson-9-slide-1" data-fancybox-group="lesson-9" class="teal lesson-9 button">{t}Improving Attention{/t}</a> <a href="#lesson-9-slide-2" data-fancybox-group="lesson-9" class="hide lesson-9"></a> <a href="#lesson-9-slide-3" data-fancybox-group="lesson-9" class="hide lesson-9"></a>
					</li>
					<li>
						<a href="#lesson-10-slide-1" data-fancybox-group="lesson-10" class="teal lesson-10 button">{t}Visualization{/t}</a> <a href="#lesson-10-slide-2" data-fancybox-group="lesson-10" class="hide lesson-10"></a> <a href="#lesson-10-slide-3" data-fancybox-group="lesson-10" class="hide lesson-10"></a>
					</li>
					<li>
						<a href="#lesson-11-slide-1" data-fancybox-group="lesson-11" class="teal lesson-11 button">{t}Chunking{/t}</a> <a href="#lesson-11-slide-2" data-fancybox-group="lesson-11" class="hide lesson-11"></a>
					</li>
					<li>
						<a href="#lesson-12-slide-1" data-fancybox-group="lesson-12" class="teal lesson-12 button">{t}Attach Meaning{/t}</a> <a href="#lesson-12-slide-2" data-fancybox-group="lesson-12" class="hide lesson-12"></a>
					</li>
					<li>
						<a href="#lesson-13-slide-1" data-fancybox-group="lesson-13" class="teal lesson-13 button">{t}Mindfulness{/t}</a> <a href="#lesson-13-slide-2" data-fancybox-group="lesson-13" class="hide lesson-13"></a>
					</li>
					<li>
						<a href="#lesson-14-slide-1" data-fancybox-group="lesson-14" class="teal lesson-14 button">{t}External Memory Aids{/t}</a> <a href="#lesson-14-slide-2" data-fancybox-group="lesson-14" class="hide lesson-14"></a>
					</li>
					<li>
						<a href="#lesson-15-slide-1" data-fancybox-group="lesson-15" class="teal lesson-15 button">{t}Rehearsal{/t}</a> <a href="#lesson-15-slide-2" data-fancybox-group="lesson-15" class="hide lesson-15"></a>
					</li>
					<li>
						<a href="#lesson-16-slide-1" data-fancybox-group="lesson-16" class="teal lesson-16 button">{t}Compassion{/t}</a> <a href="#lesson-16-slide-2" data-fancybox-group="lesson-16" class="hide lesson-16"></a>
					</li>
				</ul>
			</td>
		</tr>
