  ...
  <div id="lesson3">
    ...
    <div id="lesson-3-slide-30" class="course-slide">
      <div class="content">
        ...
        <p class="forum">If possible, please share your goals on the Forum to help with <u>encouragement </u>and <u>accountability</u>.</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    <div id="lesson-3-slide-31" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li>There is no need to change the breath. Just notice the breath wherever you feel it (long pause)
            (about half-way through) When you notice that you’ve become distracted or lost in thought, gently bring awareness back to your breathing
            (after 5 minutes can ring meditation bell or simply say) Open your eyes</li>
        </ul>
        <p class="forum">3. Discussion of participant reactions / experiences (2-3 minutes). 
          Any reactions?
          What did you notice / how did it feel? 
          Problems? Post your responses to the Forum.</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
  ...
  <div id="lesson-6">
    ...
    <div id="lesson-6-slide-15" class="course-slide">
      <div class="content">
        ...
        <blockquote>
          <p>Pick the right calendar for your lifestyle.  There are lots of different types of calendars.  
            The standard 1-month calendar that hangs on the wall is good for having your appointments out in the open so you can reference it in a glance.  
            Date books that come in one week per page or even one day per page may be what you need if you are particularly busy or if you want to jot memory notes about what you’ve been up to.  
            Electronic calendars are available these days either installed on your computer or over the internet (Google has a nice calendar).  These electronic calendars are nice because you don’t have to choose the format.  You can view your tasks by day, week or month just by clicking a button.</p>
