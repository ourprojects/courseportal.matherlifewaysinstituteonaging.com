...
$clientScript = Yii::app() -> getClientScript();
$clientScript -> registerCssFile($this -> getStylesUrl('course.css'));
>>>>>>> branch 'master' of https://github.com/ourprojects/courseportal.matherlifewaysinstituteonaging.com.git
  ...
  <ul>
    ...
    <ul>
      <li> <a href="#lesson-1-slide-1" data-fancybox-group="lesson-1" class="teal lesson-1">{t}Introduction{/t}</a> <a href="#lesson-1-slide-2" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-3" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-4" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-5" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-6" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-7" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-8" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-9" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-10" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-11" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-12"
				...
				class="hide lesson-1"></a> <a href="#lesson-1-slide-24" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-25" data-fancybox-group="lesson-1" class="hide lesson-1"></a> </li>
      <li> <a href="#lesson-2-slide-1" data-fancybox-group="lesson-2" class="teal lesson-2">{t}Physical Activity{/t}</a> <a href="#lesson-2-slide-2" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-3" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-4" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-5" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-6" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-7" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-8" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-9" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-10" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a href="#lesson-2-slide-11" data-fancybox-group="lesson-2" class="hide lesson-2"></a> <a
				...
				data-fancybox-group="lesson-2" class="hide lesson-2"></a> </li>
      ...
      <li> <a href="#lesson-5-slide-1" data-fancybox-group="lesson-5" class="teal lesson-5">{t}Nutritional{/t}</a> <a href="#lesson-5-slide-2" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-3" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-4" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-5" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-6" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-7" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-8" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-9" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-10" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-11" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-12"
				...
				class="hide lesson-5"></a> <a href="#lesson-5-slide-24" data-fancybox-group="lesson-5" class="hide lesson-5"></a> <a href="#lesson-5-slide-25" data-fancybox-group="lesson-5" class="hide lesson-5"></a> </li>
	...
	<div id="lesson-2">
		...
		<div id="lesson-2-slide-6" class="course-slide">
			<div class="content">
				...
				<p>Blood pressure above or below the healthy level in middle-aged men has been associated with poor performance on cognitive tests 25 years later This association, however, was only found in men who did not treat their blood pressure, showing that if we do something to attend to our health problems we can help to prevent or postpone onset of cognitive decline.</p>
		...
		<div id="lesson-2-slide-9" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>In humans physical cardiovascular exercise is linked to increase in the size of the structure responsible for forming new memories (hippocampus) (Click to Reveal Circle)</li>
					<li>
						...
						<ul>
							...
							<li>
								These nerve growth factors help neurons and dendrites grow and thrive. Some have even referred to these growth factors as<strong> Miracle Grow for your brain cells</strong>.
							</li>
						</ul>
					</li>
				</ul>
		...
		<div id="lesson-2-slide-10" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>
					For example, in a recent study, researchers put 120 healthy older adults participants on a fitness plan for 1 full year. Half of them (60) were assigned to a moderate to high intensity <strong>aerobics class</strong> 3 times per week and the other half (60) were assigned to a <strong>stretching and toning class</strong> that also met 3 days a week.
				</p>
		...
		<div id="lesson-2-slide-14" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						Stairs instead of the elevator – can even take the stairs up a few flights and then switch to the elevator if going up a lot of stories.
						<ul>
					...
					<li>
						Wear a pedometer to help keep you conscious of the number of steps you are getting it – if it is 7pm and you realize you haven’t done much for the day you could do a few extra laps around your home or apartment just to get in that movement.
						<ul>
					...
					<li>
						Keep weights in clear view – under the coffee table, somewhere where you will see them regularly as a cue to use them. Lift weights during commercials or while on the phone
						<ul>
	...
	<div id="lesson3">
		...
		<div id="lesson-3-slide-6" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						The fight or flight response involves the activation of multiple systems in the body, generally following this sequence of events (From Left to Right):
						<ol>
		...
		<div id="lesson-3-slide-17" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						Stress and depression also exacerbate one another, creating a cycle whereby the stress response can trigger negative thoughts, destructive beliefs and pessimism – these thoughts trigger the stress response and so on.
						<ul>
		...
		<div id="lesson-3-slide-18" class="course-slide">
			<div class="content">
				...
				<p>
					The good news is, we now understand that there are techniques we can use to <u>actively engage the relaxation response</u>.
				</p>
		...
		<div id="lesson-3-slide-20" class="course-slide">
			<div class="content">
				...
				<p>
					<u>Walking Meditation</u>. Similar to sitting meditation, but walking is the focus of attention. Slowly and comfortably walk, focusing your attention on each step, on each movement of the body, the feel of the foot on the ground. When your mind wanders, gently bring it back to the movement of walking.
				</p>
				<p>
					<u>Mindfully Doing Anything:</u>  Mindfulness simply is the act of giving one thing your full attention and taking in every part of the experience.  All of the sights, sounds, smells, tactile sensations, tastes, even the emotional experiences that you may have, giving every part of the experience your full attention.  YOUR MIND WILL WANDER and that&rsquo;s OK.  Just gently bring your focus back to the present moment.  Being in the present protects us from emotional distress because worry lives in the future and rumination lives in the past (rumination is replaying events in your head that are typically negative, which leads to depression).  Very little of the present moment is unpleasant.  If it is unpleasant then feel that too.  Distress most often comes when we are trying to cover up or escape an emotion, learning to sit with an emotion will also relieve stress over time.  Mindfulness practice can also improve your memory, which we will discuss more in a future session.
				</p>
				<p>
					<u>Lovingkindness Meditation</u>. Sharon Salzberg is a meditation teacher who has written quite a about &ldquo;metta,&rdquo; or lovingkindness meditations. These meditations focus on practicing compassion and positive intention for ourselves and others. We&rsquo;ve given you more information about Lovingkindness Meditation in your workbook.
				</p>
		...
		<div id="lesson-3-slide-21" class="course-slide">
			<div class="content">
				...
				<p>Unfortunately, negative thoughts tend to be automatic, so you may not even be aware that your thoughts are contributing to stress and emotional distress. Once we are more aware of what we are thinking, we can look at whether the thinking is helpful or unhelpful.</p>
				...
				<ul>
					...
					<li>
						If you notice yourself thinking something especially unhelpful or hurtful about yourself, you might ask yourself:
						<ul>
							<li>Is this really true? Or is it just a habit?</li>
							<li>
								If someone I truly cared about said this about themselves, would I let them get away with it? What would I say to him or her?
								<ul>
		...
		<div id="lesson-3-slide-23" class="course-slide">
			<div class="content">
				...
				<p>
					<u>Chunking</u>.  This is an old psychological technique used to help improve memory when learning lists of things.  Cognitive psychologists discovered it as a natural tendency that people with strong memories have used naturally for some time. Now that you know about it, you can use it too.
				</p>
				...
				<blockquote>
					<p>
						<u>Break strings of numbers down into smaller chunks.</u>  2, 3 and 4-item clusters are easier to remember than larger ones.  It helps to also chunk in a way that you are well practiced at, such as remembering a group of seven numbers in either a group of 3 digits and 4 digits or 3-2-2, like the way you would remember a telephone number. 10-digit numbers can be grouped the same way, just think of the first three numbers as the area code.
					</p>
					<p>
						<u>Group words from a list based on some similar feature or category.</u>  Language is stored in the brain in what we call semantic networks, so words with similar features or in similar categories are linked together naturally in our brains.  You can capitalize on this natural association when trying to remember things.  Group similar items together, so that you only have to remember the category and remembering the category will cue you to think of the items within that category.  This works with shopping lists.  Organize your grocery list according to department (produce, deli, pharmacy, etc.) and aisle (breakfast food, baking, canned foods, etc.).
					</p>
				</blockquote>
				<p>
					<u>Outlines.</u>  Make outlines of oral or written information that you are trying to remember.  Outlines aren&rsquo;t just for preparing reports or laying out a long story you want to write.  You can use outlines to help you learn new things.  You can make use of outlines when:
				</p>
				<blockquote>
		...
		<div id="lesson-3-slide-24" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>
					<u>Group words from a list based on some similar feature or category.</u>  Language is stored in the brain in what we call semantic networks, so words within the same categories or that represent objects with similar features are linked together naturally in our brains. 
				</p>
		...
		<div id="lesson-3-slide-25" class="course-slide">
			<div class="content">
				...
				<p>Take a minute to try and memorize this list AS IS, TRYING TO REMEMBER THE ITEMS IN THE ORDER THEY ARE ON THE LIST.</p>
				<p>How was that? Easy? Hard?</p>
				<p>Now try organizing your grocery list according to department (produce, deli, pharmacy, etc.) and aisle (breakfast food, baking, canned foods, etc.).</p>
		...
		<div id="lesson-3-slide-27" class="course-slide">
			<div class="content">
				...
				<p>You can also use chunking to memorize text such as poems or verses or the key points of a newspaper or magazine article.  The whole point is to reduce the amount of information into a size that your memory can handle better.</p>
				<p>Can you think of any other applications for chunking?</p>
				<p>
					Chunking is helpful for some situations, but some chunking exercises may feel unnecessary.  Part of our goal here is to give you strategies to help your everyday memory, but another part of our goal is to <u>exercise your memory</u>, so even if you don&rsquo;t think that you will use a particular strategy very much in your everyday life, practicing the strategy is good brain exercise that research shows has a good chance of increasing your cognitive reserve.
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-3-slide-28" class="course-slide">
			<div class="content">
				...
				<p>Set goals similar to these and challenge yourself to increase time, frequency, or intensity over this online course curriculum. Ensure you log your goals in your activity log.</p>
		...
		<div id="lesson-3-slide-31" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>Be gentle and compassionate with yourself when your mind wanders – our brains are made to think so it is very natural to get distracted.</li>
					<li>Notice what comes up as you are breathing</li>
				</ul>
				<p>2. Brief breath meditation (5 minutes)</p>
				<ul>
					<li>Let’s start by settling in. Close your eyes if that is comfortable, or soften gaze and pick a spot to focus on. Take an upright position, with your neck and back straight but not rigid. Place your hands wherever they are comfortable. (pause 10 sec)</li>
					<li>Now, bring awareness to your body. Notice your feet on the floor. Notice the contact of your body in the chair. (pause 10 sec)</li>
					<li>Invite your body to begin to relax, to let go of any stress or tension that has been building today. (pause 10 sec)</li>
					<li>Now become aware that your body is breathing. (pause 10 sec)</li>
					<li>There is no need to change the breath. Just notice the breath wherever you feel it (long pause) (about half-way through) When you notice that you’ve become distracted or lost in thought, gently bring awareness back to your breathing (after 5 minutes can ring meditation bell or simply say) Open your eyes.</li>
				</ul>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
	...
	<div id="lesson-4">
		...
		<div id="lesson-4-slide-2" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}Check-in{/t}</h2>
				<hr />
				<p>Give people the opportunity to process what they experienced last week, providing a safe place for them to express any fears that they may have about change. Roll with resistance &amp; if people become negative, defensive or pessimistic, try to steer them back to the facts about dementia (people do have the power to affect some of their risk, dementia is costly, it may be embarrassing).</p>
				...
				<p>Working Memory is a short-term platform where information is held long enough for our brains to do something with it. It’s where new information is held so that it can be formed into a long-term memory. It’s where old information is brought to mind so that it can be manipulated or linked with new information, such as making associations or figuring the tip on a restaurant bill. It is the intersection between attention and memory. Sometimes it is considered part of the brain’s attention system. Other times it is considered “memory,” replacing what we have traditionally thought of as “short-term memory.” Some even consider it to be an “executive skill,” and the activity of working memory has been located in the frontal lobes. We can take charge of our working memory, directing our attention, holding things in mind, etc.</p>
		...
		<div id="lesson-4-slide-12" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}Diversify Your Intellectual Investments{/t}</h2>
				<hr />
				<p>Knowing about the anatomy of our brains can provide a road map for keeping track of our brain workouts, ensuring that we work all of the different parts of the brain.  This is like one of those posters at the gym that shows you how to work each muscle group. </p>
				<p>The Cortex is the outer covering of our brain (seen here), where most of the functions that we are familiar with, are housed. </p>
				<p>
					The Frontal cortex (in red) is the CEO of your brain.  It keeps everything <u>organized, makes plans, inhibits &ldquo;bad&rdquo; behaviors, and coordinates problem solving.</u> If you&rsquo;re thinking that you are doing something that is &ldquo;CEO-like,&rdquo; then you are likely working this part of your brain.  Logic puzzles and Sudoku are exercises for your frontal cortex.
				</p>
				<p>(Trainer Tip – Also often called the Prefrontal Cortex)</p>
				<p>
					The Temporal cortex (in blue) controls <u>auditory perception, language, storage of new, overt memories </u>(the hippocampus, which encodes new memories, lives deep inside this lobe), and some fear perception (the amygdala, which generates our fear response, lives deep inside this lobe – right in front of the hippocampus).  Memory games, the memory strategies you are learning in this class, and reading all work this part of the brain.
				</p>
				<p>
					The Parietal cortex (in yellow), is responsible for <u>understanding all of our tactile senses, directing our attention focus, and understanding where objects are in space</u>.  Learning a new route somewhere, learning to get around a new city on a vacation, and practicing intense focus either through meditation or a personal challenge or a brain game, work this part of the brain.
				</p>
				<p>
					The Occipital cortex (in green), located at the back of our brains are entirely committed to <u>decoding all of the visual information that comes through our eyes</u>.  You may have noticed that 3 of these 4 lobes have some role in visual perception.  Obviously that means that what we see is essential input to our brains.  Some scientists estimate that about 80% of the sensory information that our brains receive is visual.  This means that regular eye exams are an important part of keeping your brain fit.  The same goes for regular hearing exams and investing in high quality vision and hearing treatments.  When our brains don&rsquo;t get high-quality stimulation, the regions responsible for decoding this &ldquo;high definition&rdquo; input withers from disuse.   Visual puzzles, painting or drawing, and simply enjoying the scenery works this part of the brain.
				</p>
		...
		<div id="lesson-4-slide-13" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Research is suggesting that we can practice techniques to engage the prefrontal cortex in order to help us stay focused and complete tasks that require concentration.  Some techniques for improving focus include brain training games that require extended concentration.  Some training programs include discussions with a coach that seem to help a person uncover the strategies that they are using to stay focused such as self-talk, noticing attention lapses and re-engaging, and planned attention breaks for quick recovery.  Engaging the prefrontal cortex can be quite fatiguing because this is a very &ldquo;energy-hungry&rdquo; part of the brain.  Therefore, it seems that brief recovery periods may be important to counteract the fatigue.  Focused meditation has been shown to improve focus and strengthen the activity of the prefrontal cortex likely because it involves practice of some of these techniques. </p>
		...
		<div id="lesson-4-slide-14" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}Getting the most out of your intelligence now{/t}</h2>
				<hr />
				<p>On other hand, dialing down the prefrontal cortex can also be important for other types of intellectual achievements.  For example, scientists have come to learn that insights, or those aha moments where everything seems to come together in a flash, are triggered by a very specific region of the temporal lobes called the anterior superior temporal gyrus or ASTG (in green).  The problem is that this region has a very difficult time becoming activated when the prefrontal cortex is active (in red).</p>
				<p>We now have access to techniques that can quiet the prefrontal cortex to encourage creativity and insight. Improvisational actors promote their own creativity by doing warm-up exercises to put themselves into a &ldquo;child-like&rdquo; state before going on stage.  You see, the prefrontal cortex acts to inhibit and control other parts of the brain.  This helps us interact with one another in socially appropriate ways, but this inhibition or self-criticism can get in the way of novel ideas and creativity.  The prefrontal cortex is the last part of the brain to develop when a person grows up, not maturing fully until about age 25, so getting into a &ldquo;child-like&rdquo; state happens when we dial down the activity of this region. &nbsp;</p>
				<p>
					Some activities that are good for quieting the prefrontal cortex are are the same ones you've been practicing in the emotional module and ones that you will be learning more about in the spiritual module.  Relaxing the body, helps to dial down the prefrontal cortex because it allows your brain to move into a relaxed state, which has been captured on brain scans to be essential for having insights.  Basically, it is counterproductive to &ldquo;think harder&rdquo; when trying to be creative or have insights.  <u>Thinking about something else for a while, taking a break, stepping back and &ldquo;sleeping on it&rdquo; all allow for the brain to get into a state that promotes insight and that aha moment.  Quieting visual activity </u>has also been associated with triggering these aha moments, so closing your eyes when trying to solve a difficult problem may also help.
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-4-slide-15" class="course-slide">
			<div class="content">
				...
				<hr />
				<h4>Link it!</h4>
				<p>As the saying goes, we are only as strong as our weakest link.  This is true for memories as well, but if there is NO link from a new memory to an old memory, what good is that? Taking the time to chain new memories up to our brains – linking them, associating them – is a worthwhile endeavor.</p>
				<p>Here are some tips for getting the most out of your linking:</p>
				<p>
					<u>Attach meaning</u> to what you are trying to remember. 
				</p>
				<blockquote>
					<p>Here is how one Chicago resident remembered her room number when staying in room 194 in the west tower of a large hotel.  She was able to think of a way to attach meaning to the number &ldquo;194 west.&rdquo;  She thought, &ldquo;well, from Chicago I love the drive heading out of the city along I-94 westbound to get out to my mom's house.&rdquo;&nbsp; So, she equated the 1 with an &ldquo;I&rdquo; and the 94 with the highway number.  She also noted that she goes west out to her mom's house, so she connected the room number with this meaning.&nbsp;</p>
				</blockquote>
				<p>
					Try to associate the thing you want to remember with something <u>emotional</u>.  Scary, funny, and even provocative images work best because they pull in your emotional brain for some added encoding power.
				</p>
				<p>
					<u>Link details of the current memory together</u>. 
				</p>
				<blockquote>
					<p>If it&rsquo;s an event that you really want to remember, elaborate on it by linking in the date, the day of the week, where you are, who is with you, etc.</p>
					<p>If it&rsquo;s a list of things that you want to remember, pair up the items and associate them with one another in a dramatic or vivid way.  Put one on top of another, crash them together, or make them interact. </p>
				</blockquote>
				<p>
		...
		<div id="lesson-4-slide-16" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>First information has to be captured by our attention. That is why we spent so much time talking about improving attention with the first memory tip.</li>
					<li>Then it is held very briefly in short-term memory, which is really only a matter of a few seconds. If the information is not repeated to oneself, experienced again or linked back to something the person already knows, there is little chance that it will turn into a long-term memory.</li>
				</ol>
				<p>The concept of short-term memory has been re-conceptualized into what we now call “Working Memory.” Working memory just describes in more detail what our brains do with short-term memories.</p>
				<p>Working Memory has 3 parts:</p>
				<ol>
					<li>The Central Executive is the CEO of your Working Memory. It helps allocate resources to the two slave systems and coordinates their efforts. You can step in and direct your working memory yourself by consciously doing the job of the Central Executive.</li>
					<li>The Phonolgical (fo-no-log-i-cal) Loop – is the “auditory” slave system. If you hear some verbal information, say for instance a list of words that you are trying to remember or the numbers we worked on a couple of weeks ago, you may notice that you are hearing the words over and over again inside your head. This is the phonological loop.</li>
					<li>The Visuo-spatial (vis-u-o-spā-shal) Sketchpad – is the “visual” slave system. It’s your mind’s eye. If you were to look at something, say for instance you look across the room, and then you close your eyes and see traces of what you saw when your eyes are open, that is your visuo-spatial sketchpad.</li>
				</ol>
		...
		<div id="lesson-4-slide-17" class="course-slide">
			<div class="content">
				...
				<p>Here are some tips for getting the most out of your linking:</p>
				<ol>
					<li>Link back to something you know - When remembering people’s names it helps to associate the name with another person you know with the same or a similar name.</li>
					<li>
						Attach personal meaning to what you are trying to remember. This is similar to #2, but it has the added benefit of “extra importance” and often comes with some sort of emotion, which can give your memory a boost.
						<ul>
							<li>Here is how one Chicago resident remembered her room number when staying in room 194 in the west tower of a large hotel. She was able to think of a way to attach meaning to the number “194 west.” She thought, “well, from Chicago I love the drive heading out of the city along I-94 westbound to get out to my mom's house.”  So, she equated the 1 with an “I” and the 94 with the highway number. She also noted that she goes west out to her mom's house, so she connected the room number with this meaning.</li>
						</ul>
					</li>
					<li>
						Link details of the current memory together
						<ul>
							<li>If it’s an event that you really want to remember, elaborate on it by linking in the date, the day of the week, where you are, who is with you, etc.</li>
							<li>If it’s a list of things that you want to remember, pair up the items and associate them with one another in a dramatic or vivid way. Put one on top of another, crash them together, or make them interact.</li>
							<li>For names associate something about the name with a special feature about he person. (Often it is best to keep these associations to yourself, especially if you try to make this association funny or dramatic. It can make people self-conscious to know what you’ve noticed about them).</li>
						</ul>
					</li>
					<li>Make it Emotional – Try to associate the thing you want to remember with something emotional. Scary, funny, and even provocative images work best because they pull in your emotional brain for some added encoding power.</li>
				</ol>
	...
	<div id="lesson-5">
		...
		<div id="lesson-5-slide-2" class="course-slide">
			<div class="content">
				...
				<p>Ask: How did you do with your goals from last week? Ask: Those of you who met your goals, are there any tips or pointers you could share with the class about how you went about those goals? (give an example, was it easy to develop a habit of meeting your goal first thing in the morning or right before bed?)</p>
		...
		<div id="lesson-5-slide-11" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Explain: Spice up snacks with additional ingredients to make them more enticing. Simple snacks that make healthy eating yummier!</p>
				<p>Possible cooking demonstrations are as follows (Receipes are in the Participant Workbook):</p>
				<p>Trainer tip: you could pick and choose from the below suggestions, we have listed a variety of ideas so you could demonstrate as many as you would like with whatever ingredients you have access to. The key is that these are easy recipes with few ingredients that could help incorporate brain healthy foods.</p>
				<ul>
		...
		<div id="lesson-5-slide-12" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>Flavor your water with fruit or veggies (cucumber water, fresh mint, basil, lemons, strawberries, - any of those in combination (cucumber-basil, or strawberry mint.) etc.)</li>
		...
		<div id="lesson-5-slide-14" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>We have touched a bit on how memories are made when we talked the first week about Attention and last week about Working Memory.</p>
				<p>Let’s say you buy a new high definition TV because you really want to see the best possible images you can see on TV. You bring it home, plug it in, turn it on & the picture looks terrible!</p>
				<p>That’s when you realize that you can’t watch high definition TV if you don’t have a high definition signal coming into the TV.</p>
		...
		<div id="lesson-5-slide-15" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Research has provided evidence that spiritual practice has many positive effects on the brain itself. The majority of the research demonstrating direct effects of spiritual practice on the brain has focused on meditation. So, it seems wise to spend some time discussing these findings; we will also discuss several types of meditation practices later on.</p>
		...
		<div id="lesson-5-slide-16" class="course-slide">
			<div class="content">
				...
				<h4>Activity</h4>
				<p>During this exercise we will spend some time paying careful attention to an orange. You may be thinking, “what good is that? I’m around oranges all the time.” But how often do you fully experience the orange? This exercise is sort of like stopping to smell the roses. We are going to eat a bit of orange in today’s group, but before we dive right into eating the orange, we will spend some time taking in the orange through all of our senses.</p>
				<p>Allow 30-60 seconds for each step below.</p>
				<p>Holding: Hold the orange in the palm of your hand. Move it around your hands taking in the texture, the temperature the firmness, etc. Imagine this is the first time that you are experiencing an orange, and you have to gather data to report back to someone about what you experienced.</p>
				<p>Seeing: Take time to really see the orange. Give it your full attention. Notice all of the contours, she shape, color, etc. If your mind wanders during this step, which is common, just gently bring your awareness back to seeing the orange.</p>
				<p>Touching: Move your fingers around on the orange, taking in its texture.</p>
				<p>Smelling: Hold the orange to your nose and breathe slowly. With each inhalation, really take in the fragrance of the outside of the orange. At this point go ahead and pierce the skin of the orange with your thumbnail or a knife as though you were getting ready to peel it. Notice any spray of oil that may come from the skin or from the fruit inside. Notice any differences in the way the oil smells versus the outside of the orange or the juice inside. Soak it all in.</p>
				<p>Placing: Bring a segment of orange to your mouth to eat, but slowly experience every step of this process. Notice the movement of you arm as you bring the food to your mouth. Notice how your hand knows exactly where to go to meet your mouth. Place the food in your mouth, but don’t eat it right away. Spend a little time experiencing what the orange feels like in your mouth.</p>
				<p>Tasting: When you are ready, chew the orange segment in your mouth with intention and full awareness of what happens when you bight into the orange. Notice any wave of flavor or texture that comes from each bight. Without swallowing, engage fully in this moment of simply chewing and tasting.</p>
				<p>Swallowing: When you feel ready to swallow the orange, see if you can first detect the intention to swallow as it comes up, so that even this is experienced consciously before you actually swallow the raisin.</p>
				<p>Following: See if you are aware of any sensations of the orange leaving your mouth and moving into the stomach. Also become aware of the way your body feels after completing this exercise.</p>
				<p>Allow participants some time to “come back” to the room.</p>
				<p>Allow them a few moments to discuss their experience, prompting them to consider the impact of a skill like this on their memory.</p>
				<p>Roll with any resistance, as some people may find this task tedious and frustrating. Simply respond to resistance with validation (this is not an easy exercise for many people) and emphasizing that a mindful eating exercise like this one may not be everyone’s cup of tea, acknowledging that the experience was drawn out.</p>
		...
		<div id="lesson-5-slide-17" class="course-slide">
			<div class="content">
				...
				<p>We performed the orange activity very slowly, but that doesn’t mean that doing things mindfully atomically means you have to do them more slowly. You may choose to slow your activities down to get the most out of the experience, but that may not always be required.</p>
				<p>The more you practice paying close attention and “making memories” the better you become at this skill and therefore better able to use it in situations that really count – those situations where you get frustrated because you didn’t remember.</p>
				<p>A good way build up your “awareness muscle” is to practice awareness during routine tasks and activities. This provides you a lot of opportunity to exercise your memory and attention, and as a result you may even find that you may dread doing some of these activities less than you did before.</p>
				(Review List)
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
	...
	<div id="lesson-6">
		...
		<div id="lesson-6-slide-3" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>Preliminary evidence that mindfulness meditation practices may enhance cognitive functions such as working memory</li>
				</ul>
				<cite>(Hanson, 2009; Chiesa et al., 2011; Carter et al, 2005; Tang et al, 2007; Lutz, Brefczynski-Lewis et al. 2008; Lazar et al, 2005; Kaufman, et al., 2007)</cite>
				<p>In addition to the evidence supporting the benefits of meditation, there is also some evidence that other types of spiritual practice are beneficial. For example, religious practice and spirituality have been shown to be associated with a slower rate of cognitive decline in individuals with Alzheimer’s disease.</p>
				<p>A study involving Tibetan monks who were experienced, long-term meditators found that lovingkindness meditation increases the power of brainwaves that are involved in higher-level mental activity. Research has also shown that meditation can also improve attention, it can increase empathy, which is our ability to understand another person’s experience, and it can increase feelings of compassion for ourselves and others.</p>
		...
		<div id="lesson-6-slide-4" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>Increases gray matter and reduces cortical thinning due to aging in the PREFRONTAL CORTEX (complex cognitive activity including planning, goal-setting, decision-making, attention, short-term memory)</li>
					<li>Increases activation of LEFT FRONTAL REGIONS (positive mood)</li>
					<li>Increases gray matter in the INSULA (awareness of internal body states and gut feelings, helps with empathy)</li>
		...
		<div id="lesson-6-slide-5" class="course-slide">
			<div class="content">
				...
				<cite>(e.g., Po well et al., 2003; Davidson et al 2003; Walsh and Shapiro, 2006; Tang et al 2007; Seeman, Dubin, and Seeman, 2003)</cite>
				<p>Spirituality and religion are also good for the brain because they are good for the body. There are many studies suggesting that spirituality and religious activity are linked to longer lifespan and many positive health outcomes. Church attendance and prayer are associated with lower blood pressure and better immune function. You might remember from previous modules that high blood pressure can be bad for the brain.
		...
		<div id="lesson-6-slide-6" class="course-slide">
			<div class="content">
				...
				<blockquote>
					<p>Social support: Religious or spiritual communities provide an opportunity to connect with others, socialize, and access social support. We know that social support is a very important psychosocial predictor of health.</p>
					<p>Connection to a higher power: A recent study demonstrated a link between connection to a higher power and life satisfaction, distress, and functional ability among individuals with traumatic brain injury. (Waldron-Perrine et al., 2011)</p>
					<p>Reduced stress: You might remember that a few weeks back we talked about the link between stress and illness. Spiritual practices such as meditation and extended prayer can naturally reduce stress by quieting the sympathetic fight-or-flight response and activating the relaxation response. A study conducted in Italy in 2001 found that rosary prayer and yoga mantras lead to changes in cardiovascular rhythms likely related to parasympathetic relaxation. (Bertalli et al, 2001)</p>
					<p>Healthy lifestyle. Religion tends to encourage a healthy lifestyle and taking care of your body. Specifically, studies have found that healthy behaviors encouraged by religion protects against cardiovascular disease (Powell et al review, 2003).</p>
					<p>Gratitude, Hopefulness, and Optimism: People who notice the good stuff and express gratitude see benefits in their health, sleep, and relationships. They also tend to perform better. (Seligman, 2011). Optimism has been linked with good health outcomes including increased immune function and increased cancer survival rates (Karren, K., Hafen, B., Frandsen, K, and Smoth, L.)</p>
					<p>Attention training. As stated earlier, meditation has also been shown to improve attention. Meditation practices involve sustained concentration and learning to refocus when distracted. So you can think of meditation as attention-training for your brain. Also, sitting through a religious service can provide opportunities for attention training as a collective focus on the rituals is required, which is rather unique in our culture.</p>
					<p>Forgiveness and letting go of anger. All contemplative and spiritual traditions emphasize forgiveness. By letting go of resentments and anger, we are reducing that sympathetic nervous system stress response. According to research by Fred Luskin and colleagues at Stanford University, forgiveness can reduce anxiety and depression, improve sleep, boost our immune system, and lower blood pressure. Luskin also argues that forgiveness is a skill that can be learned and practiced. (Luskin, 2003).</p>
				</blockquote>
		...
		<div id="lesson-6-slide-8" class="course-slide">
			<div class="content">
				...
				<p>Studying spiritual texts, listening to talks by spiritual teachers or leaders, or engaging in spiritual dialogue are ways to exercise your spiritual brain. Contemplating or grappling with any of life’s big questions is a way to build critical thinking skills and grow the brain. You could, for example, participate in a bible study or a meetup group, listen to audio recordings of mindfulness talks, read spiritual texts, or take a class examining the world’s religions. Study and contemplate on your own or with trusted others.</p>
		...
		<div id="lesson-6-slide-9" class="course-slide">
			<div class="content">
				...
				<p>Certainly, forgiveness is beneficial to our brains and bodies, but often it’s easier said that done. As English poet Alexander Pope said “To err is human, to forgive, divine”. However, forgiveness can be viewed as a skill that can be learned and practiced.</p>
				<p>Some points to remember about the skill of forgiveness:</p>
				<ul>
					<li>Forgiveness is for you. Holding on to anger, blame, or hurt feelings takes work and can be incredibly draining.</li>
					<li>Forgiveness frees up emotional energy that can be channeled into something that is nourishing and invigorating</li>
					<li>Forgiveness takes strength. It is not about giving up or being a victim. Forgiveness sometimes takes tremendous strength. As Gandhi said, “The weak can never forgive.</li>
					<li>Forgiveness is the attribute of the strong.” Forgiveness isn’t condoning. It is not about excusing or allowing unacceptable behavior. You can forgive completely without reconciling or continuing the relationship</li>
					<li>Forgiveness is a process. Wounds are sometimes deep and take time to heal; having the intention to forgive is a wonderful start. Sometimes we think we have forgiven when something reminds us of the hurt and breaks open the old wound. Be patient and kind to yourself if this happens; do not judge; just renew your intention to let go. Forgiveness is easier with empathy. It’s much easier to forgive when we at least partially understand and empathize with the person who has wronged us.</li>
				</ul>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-6-slide-10" class="course-slide">
			<div class="content">
				...
				<p>Mindfulness Sitting Meditation: We’ve already practiced a sitting meditation during the emotional module. But to review, some basic steps for sitting meditation: Sit comfortably in a chair or on the floor, with your back, neck, and head straight but not stiff. Concentrate on a single object, such as the breath. Focus your attention on the sensations of the breath wherever you feel them in your body. Use the breath as an anchor. When your mind wanders or you become distracted, gently return focus to your breathing. Practice this just for 5 minutes at first, gradually increasing the time up to 30 to 60 minutes if you wish. Using a meditation timer can be very helpful in helping you stay focused on the meditation as opposed to the time. There are several meditation timers that you can download to your smartphone.</p>
				<p>Walking Meditation. Similar to sitting meditation, but walking is the focus of attention. Slowly and comfortably walk, focusing your attention on each step, on each movement of the body, the feel of the foot on the ground. When your mind wanders, gently bring it back to the movement of walking.</p>
				<p>Lovingkindness Meditation. Sharon Salzberg is a meditation teacher who has written quite a about “metta,” or lovingkindness meditations. These meditations focus on practicing compassion and positive intention for ourselves and others.</p>
		...
		<div id="lesson-6-slide-12" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>The final technique we’ll talk about today is gratitude journaling. We tend to think too much about what went wrong and spend to little time noticing or thinking about what went right. Of course, there are times when it is helpful to think about what went wrong, and what mistakes were made, so that we can learn from these experiences and potentially avoid them in the future. However, we tend to spend more time thinking about the negatives than is helpful. Our brains are actually wired to notice and pay attention to bad events while minimizing, ignoring, or overlooking the good things. This may be because those of our ancestors who were preparing for disaster were more likely to survive when disasters struck (such as the ice age, or a hungry saber-tooth tiger). To overcome this brain-bias towards the negative, we need to practice noticing, taking in, and appreciating the good things in life.</p>
				<p>Martin Seligman, a psychologist, former president of the American Psychological Association, and pioneer in the field of Positive Psychology, created a simple exercise to help people practice the skill of thinking about what went well. He called originally called this exercise Three Blessings. For this exercise, set aside a few minutes each night before bed to write down three things that went well and why they went well. These do not have to be big things, but they might be important things. Seligman found that people who did this each night for a week had less depression and increased happiness, and remained less depressed and more happy six months later.</p>
				<P>Trainer note: Go through example on slide, noting that the things can be small (“my husband brought home my favorite take-out food”) or large (I was given an award for volunteering) and they decided WHY it happened, maybe because of something you did, maybe because God was looking out my you, etc. Emphasize that it’s important to stick with the exercise for at least a week to try and get in the habit of noticing the big and small good things.</P>
		...
		<div id="lesson-6-slide-14" class="course-slide">
			<div class="content">
				...
				<p>This memory tip is less about forcing your brain to remember more and more about helping your brain out by outsourcing some of the work to external memory aids. (Although these memory aids can help with getting new long-term memories to stay in your brain as you will see below.)</p>
				<p>An external memory aid is anything that either holds a memory that can be referenced later, such as writing something down, or serves as a cue to help trigger a memory, such as leaving something by the front door that you want to take with you the next time you go out.</p>
				<p>Here are some tips for using external memory aids:</p>
				<p>Write things down. Often we forget this very simple, yet highly effective means of helping our memories. Writing things down can serve several purposes, and you are encouraged to do this often! Here are some advantages of writing things down.</p>
				<ul>
					<li>It keeps you organized. Making lists can keep you tasks organized. Writing out your thoughts when you are struggling with a complicated problem or decision can give you the opportunity to organize your thoughts by seeing it on paper. You can also write out details of a difficult conversation you may plan to have, which can allow you to decide what to say first.</li>
					<li>It can de-clutter your brain. This is a especially good technique for nights when you are having trouble sleeping because the same three thoughts keep running around in your head. It seems that this thought repetition may be a way of ensuring that these important tasks or ideas are not forgotten, so if you jot them down you can get them out of your head to be dealt with later.</li>
					<li>It helps you memorize things. Writing things down creates a record of information that you can study and memorize later. Short-term memory is very short-term (typically less than 30 seconds). You can improve your memorization skills by writing something down and then using all of the other skills you are learning in this class to commit that information to long-term memory over time. Who says you have to just memorize things right away to have a good memory?</li>
					<li>It helps you use more of your brain to store memories. Some people may think that it’s cheating to write things down, but actually seeing something in your own handwriting can help with encoding it. For one thing it moves the information into a new “modality” to where you are actually seeing it instead of just rehearsing the information in your mind, which tends to be auditory.</li>
				</ul>
				<p>The Special Spot. Putting important items in a special spot and being disciplined about keeping them there is a great external memory aid.</p>
				<ul>
					<li>Keys. If you don’t have a special spot where you keep you keys or your wallet or whatever it is that you take out of with you each time you leave your home by now, then make one today!</li>
					<li>Important Documents. Put the bills you have to pay each month in a special spot, maybe a place that is somewhat visible that will serve as a visual cue to help you remember to pay them. Other, less frequently accessed documents should also have a special spot but more out of the way of your everyday space.</li>
				</ul>
				<p>Use a Calendar. So many people complain about missing appointments, but when you ask them if they use a calendar, they often say no. They start worrying that they are getting dementia when what has most likely occurred is that their lifestyle or their routines have changed.</p>
				<p>If you do not already use a calendar to keep up with appointments, visits with friends, and daily tasks, now is the time to start! Here are some tips.</p>
				<blockquote>
					<p>Pick the right calendar for your lifestyle. There are lots of different types of calendars. The standard 1-month calendar that hangs on the wall is good for having your appointments out in the open so you can reference it in a glance. Date books that come in one week per page or even one day per page may be what you need if you are particularly busy or if you want to jot memory notes about what you’ve been up to. Electronic calendars are available these days either installed on your computer or over the internet (Google has a nice calendar). These electronic calendars are nice because you don’t have to choose the format. You can view your tasks by day, week or month just by clicking a button.</p>
					<p>Write it all down. Even if you think that you will probably remember a task or an appointment, put it on your calendar anyway. It’s better to have things on your calendar that you remembered anyway than it is to forget something or to miss an appointment or special event.</p>
					<p>Check it often! What good is writing something down in a calendar if you never look to see what you have to do? Make it a habit to look at your calendar everyday. First thing in the morning or before you go to bed the night before are good strategies.</p>
					<p>Alarms and Reminders. Many seniors are getting used to using cell phone or computerized calendars that will give you reminders and alerts. Even if you are not that tech savvy, there are devices you can buy for the home that have programmable alarms that can remind you to take medication, wake up, check your blood sugar, etc.</p>
				</blockquote>
				<p>Buy, Fill and Use a Pill Box! Using a pill box doesn’t make you old; it makes you responsible. It is a good idea for anyone, at any age, who takes medication on a regular basis to use a pill box (even, or should we say “especially,” 25-year-olds). There is a reason that birth control pills come in those packs that have the days of the week marked. So give up resisting getting a pill box because of what you think it will mean about your brain or your age. This is an important memory task to outsource, and it could help you preserve your memory, especially if you take medication for blood pressure or diabetes!</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Start Module &raquo;{/t}</a>
			</div>
	...
	<div id="lesson-7">
		...
		<div id="lesson-7-slide-5" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>
						{t}The sides of our brains (the<strong> temporal lobes</strong>) are activated in a conversation because they are responsible for processing the sensations from our ears, so any sound, and converting that into meaningful information <strong>(language</strong>). Our <strong>word bank</strong> is also stored here, so when we go searching for what we want to say, this part is activated. This part also <strong>forms new memories</strong>.{/t}
					</li>
					<li>
						{t}The <strong>occipital lobes</strong> at the back of the head are devoted to processing sensations that come through our eyes. So if you are communicating face-to-face with someone, this part of the brain is active in reading important social cues such as facial expression and gestures.{/t}
					</li>
					<li>
						{t}The front of the brain <strong>(frontal lobes</strong>) is responsible for what we call “<strong>executive functions</strong>” or things a CEO would do <strong>(plan, organize, direct attention, inhibit</strong>). This part of the brain is what makes humans unique, allowing us to interact in civil ways. It also helps us retrieve memories. This part of the brain is also involved in <strong>motor function</strong>, allowing us to gesture with our body, make facial expressions and even move the muscles required to talk. Therefore this part of the brain is also very active during a simple conversation.{/t}
					</li>
					<li>
						{t}The <strong>parietal lobes</strong> (top back) are involved in maintaining our <strong>attention</strong>.{/t}
					</li>
				</ol>
				<p>{t}</p>
				<p>
					These are brain skills involved in a simple conversation. Now think of all of the<strong> additional brain skills</strong> involved in <strong>planning outings</strong> with a friend (planning, spatial skills required to navigate to a meeting place – e.g. new restaurant) as well as<strong> maintaining a relationship</strong> (empathy, compassion, initiation, etc.). {/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-7-slide-6" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Finally, a chemical called <strong>oxytocin</strong> (sometimes called the love hormone) promotes bonding and is activated when we are around people we feel a connection with (spouse or partner, children, close friends, etc.).<strong> Oxytocin has been shown to play a role in memory improvement and brain plasticity</strong>. {/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
...
" target="_blank">Beautiful-Minds.com</a>
		...
		<div id="lesson-7-slide-15" class="course-slide">
			<div class="content">
				...
				<p>
					{t}If we really want our memories to live up to the expectations that we set for them, <strong>we have to invest some time in rehearsing what we want to remember.</strong>{/t}
				</p>
				...
				<p>This is easy to do in a conversation. Simply repeat what the other person said in the form of a question. It may seem awkward at first, but you may do it naturally already without realizing it. It is standard practice of conversation. “The Empire State Building is at the corner of 34th street and 5th Avenue, you say?”{/t}</p>
		...
		<div id="lesson-7-slide-17" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						{t} You will likely need to <strong>offer guidance in helping set goals that are not too difficult or too vague</strong> – It’s better to set a “ridiculously simple goal” that a person can achieve in order to feel success than to set a goal that they will not achieve. {/t}
					</li>
				</ul>
				...
				<ul>
					...
					<li>
						<strong>{t}Simple</strong> (ridiculously easy goals are an important place to start because small successes create momentum for bigger change){/t}
					</li>
					<li>
				...
				<ul>
					<li>
						{t}Some people <strong>may need to take some time to think over their reward</strong>, so encourage them to come up with a reward very soon if they do not finish that in class{/t}
					</li>
	...
	<div id="lesson-8">
		...
		<div id="lesson-8-slide-13" class="course-slide">
			<div class="content">
				...
				<p>
					{t}A slip doesn’t make you a bad person. <strong>Getting angry</strong> with yourself is counter productive because <strong>it activates the limbic brain &amp; fight or flight. Beating yourself up just makes you defensive. Slips are normal.</strong>{/t}
				</p>
				<p>
					<strong>{t}Will power relies on the executive brain</strong>. If the CEO calls in sick, goes on vacation or loses focus, we can give up on our goals. This is because the CEO of your brain is in charge of “keeping your eye on the prize” or fully embracing the long-term reward of your goal. Your limbic system or emotional or primitive brain wants things NOW.{/t}
				</p>
		...
		<div id="lesson-8-slide-15" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						{t}Compassion allows us to <strong>dial down the emotional brain</strong>, and helps <strong>divert resources back to the thinking brain</strong>.{/t}
					</li>
					<li>
						{t}Compassion allows us to <strong>tolerate &quot;sitting&quot; with the feelings that are causing us resistance</strong> so that we can:{/t}
						<ul>
					...
					<li>
						<strong>{t}If you judge your feelings, you can’t feel safe enough to sit compassionately with them, so they are never &quot;aired out&quot; –</strong> they never “see the light of day.” Instead they sit under the surface, controlling our behaviors, sabotaging our goals.{/t}
					</li>
				</ul>
			</div>
			<div class="buttons">
		...
		<div id="lesson-8-slide-16" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Now imagine two competing sides of yourself are arguing over this set-back.  One side is punitive and critical.  You may give that side a name like &ldquo;<strong>the bully</strong>&rdquo; or the &ldquo;<strong>drill sergeant</strong>.&rdquo;  Spend some time imagining this person sitting on your right side, voicing all of the things that you are telling yourself about why your slip was so terrible.(Pause){/t}
				</p>
				<p>
					{t}Now spend a moment imagining the opposite of this person on your left side who represents your primitive and impulsive side.  The one that wants instant gratification, and wants to run away form discipline.  You may give this side a name like &ldquo;<strong>the hippy</strong>&rdquo; or &ldquo;<strong>the wild child</strong>.&rdquo;  (Pause){/t}
				</p>
				<p>
					{t}Now that you can imagine these two sides pretty clearly, spend some time offering these two sides of yourself compassion. It can help to offer them compassion using the following meditation:  &quot;<strong>May you be well, may you be happy, may you be free from suffering.</strong>&quot; (Repeat this a few times){/t}
				</p>
  ...
  <div id="lesson-1">
    ...
    <div id="lesson-1-slide-8" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p> {t}One key way that we can lower our risk for dementia is through understanding and utilizing a theory that is central to this area of science, called the <strong>Theory of Cognitive Reserve</strong>. You can think of this as your brain’s 401(k) or retirement account.{/t} </p>
  ...
  <div id="lesson-2">
    ...
    <div id="lesson-2-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers">{t}Investing in Brain Health{/t}</h2>
        <hr />
        <p>{t}In the last module we talked about actively investing in our brain reserve (or Cognitive Reserve / Brain 401(k)) – Maximizing our contributions to our brain, which can help us build up a larger reserve in order to ward off dementia.{/t}</p>
        <p>{t}In the last module, about the autopsy study where people had resisted the clinical effects of Alzheimer’s disease growing in their brains, there were three main lifestyle behaviors that distinguished these people from people who had lost their independence. They had been more active during their lives in a few key ways.{/t}</p>
        <p>{t}We are going to present how physical activity seems to be a key component of brain health. In fact, it may be one of the best things you can do for your brain. {/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    ...
    <div id="lesson-2-slide-14" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li> Keep weights in clear view – under the coffee table, somewhere where you will see them regularly as a cue to use them. Lift weights during commercials or while on the phone
            <ul>
              <li>Pace while talking on the phone</li>
            </ul>
          </li>
  ...
  <div id="lesson3">
    ...
    <div id="lesson-3-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers">{t}Investing in Brain Health{/t}</h2>
        <hr />
        <p>The last couple of weeks we have talked about actively investing in our brain reserve (or Cognitive Reserve / Brain 401(k)) in order to prevent or delay the onset of dementia. Last week we talked about maximizing contributions to our cognitive reserve through physical activity.</p>
        <p>Current module:</p>
        <ul>
          <li>will focus a little more on minimizing losses by discussing the impact of emotions on our brains,</li>
          <li>but we will also discuss briefly how emotions can also help maximize contributions.</li>
    ...
    <div id="lesson-3-slide-14" class="course-slide">
      <div class="content">
        ...
        <table width="100%" border="3">
          <tr>
            <th width="50%"> <p>Chronic Stress Disturbs all of these Body Systems:</p>
            </th>
            <th> <p>Makes us more vulnerable to:</p>
            </th>
          </tr>
          <tr>
            <td width="50%"><ul>
    ...
    <div id="lesson-3-slide-21" class="course-slide">
      <div class="content">
        ...
        <p>When stressed or upset, try to:</p>
        <ul>
          <li> Pause and pay attention to what you are saying to yourself. If the thoughts are unhelpful, meaning they are making you feel more upset, stressed, anxious, angry, or sad, there are strategies to change or decrease thoughts or distance ourselves from them.
            <ul>
              <li>It’s important to know and remember that we are more than just our thoughts, and our thoughts are that - just thoughts!, not necessarily facts, not necessarily true.</li>
            </ul>
          </li>
    ...
    <div id="lesson-3-slide-24" class="course-slide">
      <div class="content">
        <h2 class="flowers">{t}Memory Strategy #3: Chunking - Making use of Semantic Networks{/t}</h2>
        <hr />
        <p> <u>Group words from a list based on some similar feature or category.</u>  Language is stored in the brain in what we call semantic networks, so words within the same categories or that represent objects with similar features are linked together naturally in our brains.  </p>
        <p>You can capitalize on this natural association when you are trying to remember things.  Say for instance if you are trying to memorize a list of words, group similar items together.  This way you only have to recall the category and then remembering the category will cue you to think of the items within that category. </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-3-slide-27" class="course-slide">
      <div class="content">
        ...
        <p>You can also use chunking to memorize text such as poems or verses or the key points of a newspaper or magazine article.  The whole point is to reduce the amount of information into a size that your memory can handle better.</p>
        <p>Can you think of any other applications for chunking?</p>
        <p> Chunking is helpful for some situations, but some chunking exercises may feel unnecessary.  Part of our goal here is to give you strategies to help your everyday memory, but another part of our goal is to <u>exercise your memory</u>, so even if you don&rsquo;t think that you will use a particular strategy very much in your everyday life, practicing the strategy is good brain exercise that research shows has a good chance of increasing your cognitive reserve. </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    <div id="lesson-3-slide-28" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li>Memorize 4 phone numbers using Chunking</li>
          <li> Memorize your grocery list using Chunking and go to the store without it
            <ul>
              <li>Or do a first pass by memory and a second pass with the list</li>
              <li>This may get you more physical activity</li>
            </ul>
    ...
    <div id="lesson-3-slide-29" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li> Meditation or relaxation practice
            <ul>
              <li>1-2 minutes</li>
              <li>1-2 times per day</li>
            </ul>
          ...
          <li>30 minute relaxed walk, 3 times a week</li>
          <li>Get a massage</li>
          <li> Pay attention to negative thoughts when you feel your mood sink or you get anxious
            <ul>
              <li>4 times throughout the week</li>
            </ul>
          </li>
  ...
  <div id="lesson-4">
    ...
    <div id="lesson-4-slide-2" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li>Link back to something you know</li>
          <li>Attach personal meaning</li>
          <li> Link details of the current memory together
            <ul>
              <li>Give meories context by noting date, place, etc.</li>
              <li>Make elements interact</li>
              <li>Link facial feature to name</li>
    ...
    <div id="lesson-4-slide-12" class="course-slide">
      <div class="content">
        ...
        <p>Knowing about the anatomy of our brains can provide a road map for keeping track of our brain workouts, ensuring that we work all of the different parts of the brain.  This is like one of those posters at the gym that shows you how to work each muscle group. </p>
        <p>The Cortex is the outer covering of our brain (seen here), where most of the functions that we are familiar with, are housed. </p>
        <p> The Frontal cortex (in red) is the CEO of your brain.  It keeps everything <u>organized, makes plans, inhibits &ldquo;bad&rdquo; behaviors, and coordinates problem solving.</u> If you&rsquo;re thinking that you are doing something that is &ldquo;CEO-like,&rdquo; then you are likely working this part of your brain.  Logic puzzles and Sudoku are exercises for your frontal cortex. </p>
        <p>(Trainer Tip – Also often called the Prefrontal Cortex)</p>
        <p> The Temporal cortex (in blue) controls <u>auditory perception, language, storage of new, overt memories </u>(the hippocampus, which encodes new memories, lives deep inside this lobe), and some fear perception (the amygdala, which generates our fear response, lives deep inside this lobe – right in front of the hippocampus).  Memory games, the memory strategies you are learning in this class, and reading all work this part of the brain. </p>
        <p> The Parietal cortex (in yellow), is responsible for <u>understanding all of our tactile senses, directing our attention focus, and understanding where objects are in space</u>.  Learning a new route somewhere, learning to get around a new city on a vacation, and practicing intense focus either through meditation or a personal challenge or a brain game, work this part of the brain. </p>
        <p> The Occipital cortex (in green), located at the back of our brains are entirely committed to <u>decoding all of the visual information that comes through our eyes</u>.  You may have noticed that 3 of these 4 lobes have some role in visual perception.  Obviously that means that what we see is essential input to our brains.  Some scientists estimate that about 80% of the sensory information that our brains receive is visual.  This means that regular eye exams are an important part of keeping your brain fit.  The same goes for regular hearing exams and investing in high quality vision and hearing treatments.  When our brains don&rsquo;t get high-quality stimulation, the regions responsible for decoding this &ldquo;high definition&rdquo; input withers from disuse.   Visual puzzles, painting or drawing, and simply enjoying the scenery works this part of the brain. </p>
        <p>There is more information about each of these regions in your workbook.</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-4-slide-14" class="course-slide">
      <div class="content">
        ...
        <p>On other hand, dialing down the prefrontal cortex can also be important for other types of intellectual achievements.  For example, scientists have come to learn that insights, or those aha moments where everything seems to come together in a flash, are triggered by a very specific region of the temporal lobes called the anterior superior temporal gyrus or ASTG (in green).  The problem is that this region has a very difficult time becoming activated when the prefrontal cortex is active (in red).</p>
        <p>We now have access to techniques that can quiet the prefrontal cortex to encourage creativity and insight. Improvisational actors promote their own creativity by doing warm-up exercises to put themselves into a &ldquo;child-like&rdquo; state before going on stage.  You see, the prefrontal cortex acts to inhibit and control other parts of the brain.  This helps us interact with one another in socially appropriate ways, but this inhibition or self-criticism can get in the way of novel ideas and creativity.  The prefrontal cortex is the last part of the brain to develop when a person grows up, not maturing fully until about age 25, so getting into a &ldquo;child-like&rdquo; state happens when we dial down the activity of this region. &nbsp;</p>
        <p> Some activities that are good for quieting the prefrontal cortex are are the same ones you've been practicing in the emotional module and ones that you will be learning more about in the spiritual module.  Relaxing the body, helps to dial down the prefrontal cortex because it allows your brain to move into a relaxed state, which has been captured on brain scans to be essential for having insights.  Basically, it is counterproductive to &ldquo;think harder&rdquo; when trying to be creative or have insights.  <u>Thinking about something else for a while, taking a break, stepping back and &ldquo;sleeping on it&rdquo; all allow for the brain to get into a state that promotes insight and that aha moment.  Quieting visual activity </u>has also been associated with triggering these aha moments, so closing your eyes when trying to solve a difficult problem may also help. </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    <div id="lesson-4-slide-15" class="course-slide">
      <div class="content">
        ...
        <p>As the saying goes, we are only as strong as our weakest link.  This is true for memories as well, but if there is NO link from a new memory to an old memory, what good is that? Taking the time to chain new memories up to our brains – linking them, associating them – is a worthwhile endeavor.</p>
        <p>Here are some tips for getting the most out of your linking:</p>
        <p> <u>Attach meaning</u> to what you are trying to remember.  </p>
        <blockquote>
          <p>Here is how one Chicago resident remembered her room number when staying in room 194 in the west tower of a large hotel.  She was able to think of a way to attach meaning to the number &ldquo;194 west.&rdquo;  She thought, &ldquo;well, from Chicago I love the drive heading out of the city along I-94 westbound to get out to my mom's house.&rdquo;&nbsp; So, she equated the 1 with an &ldquo;I&rdquo; and the 94 with the highway number.  She also noted that she goes west out to her mom's house, so she connected the room number with this meaning.&nbsp;</p>
        </blockquote>
        <p> Try to associate the thing you want to remember with something <u>emotional</u>.  Scary, funny, and even provocative images work best because they pull in your emotional brain for some added encoding power. </p>
        <p> <u>Link details of the current memory together</u>.  </p>
        <blockquote>
          <p>If it&rsquo;s an event that you really want to remember, elaborate on it by linking in the date, the day of the week, where you are, who is with you, etc.</p>
          <p>If it&rsquo;s a list of things that you want to remember, pair up the items and associate them with one another in a dramatic or vivid way.  Put one on top of another, crash them together, or make them interact. </p>
        </blockquote>
        <p> <u>Use all of your senses</u> when linking memories together.  Be aware of sights, sounds, smells, tastes, textures, temperatures, and emotions. </p>
        <p> When remembering <u>people&rsquo;s</u> <u>names</u>, either associate something the name with another person you know with the same or a similar name or associate something about the name with a special feature about he person. (Often it is best to keep these associations to yourself, especially if you try to make this association funny or dramatic.  It can make people self-conscious to know what you&rsquo;ve noticed about them). </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    <div id="lesson-4-slide-16" class="course-slide">
    ...
    <div id="lesson-4-slide-17" class="course-slide">
      <div class="content">
        ...
        <ol>
          <li>Link back to something you know - When remembering people’s names it helps to associate the name with another person you know with the same or a similar name.</li>
          <li> Attach personal meaning to what you are trying to remember. This is similar to #2, but it has the added benefit of “extra importance” and often comes with some sort of emotion, which can give your memory a boost.
            <ul>
              <li>Here is how one Chicago resident remembered her room number when staying in room 194 in the west tower of a large hotel. She was able to think of a way to attach meaning to the number “194 west.” She thought, “well, from Chicago I love the drive heading out of the city along I-94 westbound to get out to my mom's house.”  So, she equated the 1 with an “I” and the 94 with the highway number. She also noted that she goes west out to her mom's house, so she connected the room number with this meaning.</li>
            </ul>
          </li>
  ...
  <div id="lesson-6">
    ...
    <div id="lesson-6-slide-5" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li> Church attendance and prayer are associated with:
            <ul>
              <li>Lower blood pressure</li>
              <li>Better immune function</li>
            </ul>
          </li>
          <li> Spirituality and religious practice have been linked to:
            <ul>
              <li>Longer lifespan</li>
              <li>Positive health outcomes</li>
            </ul>
          </li>
          <li> Meditation shown to:
            <ul>
              <li>Strengthen the immune system</li>
              <li>Decrease stress-related cortisol</li>
              <li>Lower blood pressure</li>
  ...
  <div id="lesson-7">
    ...
    <div id="lesson-7-slide-5" class="course-slide">
      <div class="content">
        ...
        <p>{t}</p>
        <p> These are brain skills involved in a simple conversation. Now think of all of the<strong> additional brain skills</strong> involved in <strong>planning outings</strong> with a friend (planning, spatial skills required to navigate to a meeting place – e.g. new restaurant) as well as<strong> maintaining a relationship</strong> (empathy, compassion, initiation, etc.). {/t} </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    <div id="lesson-7-slide-6" class="course-slide">
      <div class="content">
        ...
        <p> {t}Finally, a chemical called <strong>oxytocin</strong> (sometimes called the love hormone) promotes bonding and is activated when we are around people we feel a connection with (spouse or partner, children, close friends, etc.).<strong> Oxytocin has been shown to play a role in memory improvement and brain plasticity</strong>. {/t} </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    <div id="lesson-7-slide-7" class="course-slide">
  ...
  <div id="lesson-8">
    ...
    <div id="lesson-8-slide-11" class="course-slide">
      <div class="content">
        <h2 class="flowers">{t}Keeping it Up!{/t}</h2>
        <hr />
        <p>{t}So we have spent a lot of time working with you to help you increase your investments in your Brain 401(k) over the past few weeks.  For some things, you have have likely developed enduring routines that will stand the test of time.  Sort of like an automatic withdrawal from your paycheck that goes into you 401(k) account.  It&rsquo;s so much of a part of your normal routine that you hardly notice that you&rsquo;re investing.  For example you may have been going to exercise classes regularly for so many years that you didn&rsquo;t really even notice that you were investing in your Brain 401(k).  It&rsquo;s not painful, it&rsquo;s routine.{/t}</p>
    ...
    <div id="lesson-8-slide-15" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li> {t}Compassion allows us to <strong>tolerate &quot;sitting&quot; with the feelings that are causing us resistance</strong> so that we can:{/t}
            <ul>
              <li>Experience them fully, allowing them to “have their day in court” or “be heard,” which often makes them go away, and{/t}</li>
              <li>{t}Provide the logical brain the opportunity to label the feelings, sort through the thoughts underlying the feelings and make new, more logical decisions as opposed to abandoning the goal and going back to old habits.{/t}</li>
            </ul>
