    ...
    <div id="lesson-5-slide-11" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li>Explain: it is ok to have some sweets and we don’t want to deprive ourselves of things we crave otherwise we may eat too much of it later.  By incorporating a variety of different textures into this trail mix we will help satisfy our cravings and enjoy our snacks.
            </p>
          </li>
        </ul>
      </div>
  ...
  <div id="lesson-6">
    ...
    <div id="lesson-6-slide-5" class="course-slide">
      <div class="content">
        ...
        <cite>(e.g.,  Po
        well et al., 2003; Davidson et al 2003; Walsh and  Shapiro, 2006; Tang et al 2007; Seeman,  Dubin,  and Seeman,  2003)</cite>
    ...
    <div id="lesson-6-slide-6" class="course-slide">
      <div class="content">
        ...
        <p>Transition:
          Now, let us discuss some brain-healthy spiritual practices. This is presenting a wide variety of types of religious and spiritual practice; notice what you are personally drawn to. </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-6-slide-8" class="course-slide">
      <div class="content">
        <h2 class="flowers">{t}Studying spiritual texts or engaging 
          in spiritual dialogue{/t}</h2>
        <hr />
    ...
    <div id="lesson-6-slide-9" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li>Forgiveness is the attribute of the strong.”
            Forgiveness isn’t condoning. It is not about excusing or allowing unacceptable behavior. You can forgive completely without reconciling or continuing the relationship</li>
          <li>Forgiveness is a process. Wounds are sometimes deep and take time to heal; having the intention to forgive is a wonderful start. Sometimes we think we have forgiven when something reminds us of the hurt and breaks open the old wound. Be patient and kind to yourself if this happens; do not judge; just renew your intention to let go.
            Forgiveness is easier with empathy. It’s much easier to forgive when we at least partially understand and empathize with the person who has wronged us.</li>
        </ul>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
