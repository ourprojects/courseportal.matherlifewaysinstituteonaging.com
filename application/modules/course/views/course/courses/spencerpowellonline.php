...
<div id="sidebar">
	<div class="box-sidebar one" style="background-color: #FFF;">
		...
		<p>
			<button type="button" style="width: 175px; display: block; margin: 0 auto;" onClick="location.href('http://www.vovici.com/home_index.aspx');">Pre-Course Survey</button>
		</p>
		<p>
			<button type="button" style="width: 175px; display: block; margin: 0 auto;" onClick="location.href('http://www.vovici.com/home_index.aspx');">Post-Course Survey</button>
		</p>
