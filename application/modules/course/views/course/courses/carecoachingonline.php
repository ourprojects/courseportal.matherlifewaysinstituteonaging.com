...
From the National Library of Medicine's MedlinePlus consumer health website.  Links to online brochures from the federal government and national health organizations on obtaining a second opinion, talking to your doctor, informed consent, being an active participant in your healthcare, and related communication topics. --> 
    ...
    <li> <a href="http://www.aarp.org/health/doctors-hospitals/info-09-2010/finding_your_way_how_to_talk_to_8212_and_understand_8212_your_doctor.html" target="_blank">{t}How To Talk To Your Doctor{/t}</a> 
      <!--
Emphasis on the importance of building a "successful partnership with your doctor." Suggestions for preparing for a productive office visit.  Questions to ask your doctor to assure that you have a clear understanding of your diagnosis, the treatment recommended, and other treatment options.  On the website of the American Association of Retired Persons. --> 
    ...
    <li> <a href="http://www.encouragingcoach.com/projects-selfcare-quiz.htm" target="_blank">{t}Self-Care Quiz{/t}</a> 
      <!-- 
How good are you at taking care of yourself?  Take this brief quiz to get some ideas! --> 
    </li>
    <li> <a href="http://www.meditationsociety.com/108meds.html" target="_blank">{t}Meditation Exercises{/t}</a> 
      <!-- 
The Meditation Society of America provides a free resource of over 100 meditation activities for you to try via the web.   --> 
    </li>
    <li> <a href="http://www.allaboutdepression.com/relax/" target="_blank">{t}Guided Imagery{/t}</a> 
      <!-- 
Guided imagery is an effective relaxation technique to reduce stress.  There are many benefits to being able to induce the "relaxation response" in your own body.  Some benefits include a reduction of generalized anxiety, prevention of cumulative stress, increased energy, improved concentration, reduction of some physical problems, and increased self-confidence. --> 
    ...
    <li> <a href="http://www.caregiverslibrary.org/home.aspx" target="_blank">{t}National Caregiver Library{/t}</a> 
      <!-- 
Provides state-by-state information and resources for caregivers.  --> 
    </li>
    <li> <a href="http://www.usa.gov/Citizen/Topics/Health/caregivers.shtml" target="_blank">{t}Caregiver Resources on USA.gov{/t}</a> 
      <!-- 
Find help providing care, government agencies, long-distance caregiving, and support for caregivers on this valuable website. --> 
    ...
    <li> <a href="http://www.aarp.org/home-family/caregiving/" target="_blank">{t}Caregiving Resources from AARP{/t}</a> 
      <!-- 
  ...
  <div id="lesson-1">
    <div id="lesson-1-slide-1" class="course-slide">
      <div class="content">
        ...
        <p style="font-style:italic;">{t}<span style="color:red; font-weight:bold;">Please note</span> -  participation will enhance what you get out of this course and will create a successful experience for you and others.{/t} </p>
    ...
    <div id="lesson-1-slide-6" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li><em>{t}I am going to accomplish something.{/t}</em></li>
          <li><em>{t}I am going to figure it out.{/t}</em></li>
          <li><em>{t}I am going to do my best thinking, because I want to get to what’s important.{/t}</em></li>
        </ul>
        <p>{t}Now, say this out loud:{/t}</p>
        <ul>
          <li><em>{t}I am going to accomplish something.{/t}</em></li>
          <li><em>{t}I am going to figure it out.{/t}</em></li>
          <li><em>{t}I am going to do my best thinking, because I want to get to what is important.{/t}</em></li>
        </ul>
    ...
    <div id="lesson-1-slide-7" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>{t}This activity invites you to explore and live several questions. Your responses should open up more self-awareness of what is important to you in your life.{/t}</p>
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivitySelfAwarenessSurvey.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" style="display: block; margin: 0 auto;" /> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-1-slide-11" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>{t}This activity focuses on assessing your awareness of ten principles of success and your rating of how you presently live according to them.{/t}</p>
        <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityPrinciplesofSuccess.xls'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/spreadsheet.png'); ?>" alt="image" class="normal" style="display: block; margin: 0 auto;" /> </a> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-1-slide-13" class="course-slide">
      <div class="content">
        ...
        <table style="width:100%;">
          <tr>
            <td width="50%"><p>{t}Goal Setting{/t}</p></td>
            <td><p>{t}Identifying Strategies{/t}</p></td>
          </tr>
          <tr>
            <td width="50%"><p>{t}Proactive{/t}</p></td>
            <td><p>{t}Reactive{/t}</p></td>
          </tr>
          <tr>
            <td width="50%"><p>{t}Finding what is possible{/t}</p></td>
            <td><p>{t}Finding what is wrong{/t}</p></td>
          </tr>
          <tr>
            <td width="50%"><p>{t}Developing{/t}</p></td>
            <td><p>{t}Fixing{/t}</p></td>
          </tr>
          <tr>
            <td width="50%"><p>{t}Identifying priorities{/t}</p></td>
            <td><p>{t}Addressing crises{/t}</p></td>
          </tr>
          <tr>
            <td width="50%"><p>{t}Dynamic{/t}</p></td>
            <td><p>{t}Static{/t}</p></td>
          </tr>
          <tr>
            <td width="50%"><p>{t}Working with the whole{/t}</p></td>
            <td><p>{t}Working with parts{/t}</p></td>
          </tr>
        </table>
        <br />
        <br />
    ...
    <div id="lesson-1-slide-14" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li><em>{t}I want more confidence dealing with my parents.{/t}</em></li>
          <li><em>{t}I want a more positive attitude about my caregiving responsibilities.{/t}</em></li>
          <li><em>{t}I want better health for myself.{/t}</em></li>
        </ul>
        <p>{t}Compare these to strategies which are usually stated in terms of VERBS:{/t}</p>
        <ul>
          <li><em>{t}I want to lose 30 pounds.{/t}</em></li>
          <li><em>{t}I want to get better at negotiating.{/t}</em></li>
          <li><em>{t}I want to get my mother to start considering her long-term care options.{/t}</em></li>
        </ul>
        <p>{t}For this exercise, look back at your responses to the two activities in this module. In the <strong>Self-Awareness Survey</strong>, you explored what is important to you in your life. In the <strong>Principles of Success activity</strong>, you rated yourself against these principles. Based on these results, develop three statements of goals for yourself.{/t}</p>
        <p>{t}Remember that goals should be stated in terms of nouns. Goals also answer the question, <em>“What do you want that’s really important to you?”</em>{/t}</p>
        ...
        <img src="<?php echo $this->getImagesUrl('care/forum_icon.png'); ?>" alt="{t}Forum Icon{/t}"> </div>
  ...
  <div id="lesson-2">
    ...
    <div id="lesson-2-slide-4" class="course-slide">
      <div class="content">
        <h2 class="flowers">{t}CARE Coaching: Communicating (continued){/t}</h2>
        <hr />
        <p> {t}We have developed a Caregiver Burden Assessment to help you identify aspects of your life that may or may not be impacted by caregiving at this time. Click on the icon to access the <b>Caregiver Burden Assessment</b> tool.{/t} </p>
    ...
    <div id="lesson-2-slide-5" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->getImagesUrl('CCO/Assets/ExerciseUnderstandingNeedsandPreferences.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-2-slide-6" class="course-slide">
      <div class="content">
        ...
        <img src="<?php echo $this->getImagesUrl('care/forum_icon.png'); ?>" alt="{t}Forum{/t}"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-2-slide-7" class="course-slide">
      <div class="content">
        ...
        <p> {t}<b>Place</b> - The place where these conversations take place needs to be a "safe space" as your parents would define that. It may not necessarily be in their home. Some of these topics are sensitive and so one parent may feel more comfortable taking the lead in the conversations.{/t} </p>
        <p> {t}<b>Outcome</b> - One conversation is not going to address all the important topics that need to be discussed. The initial conversations may be laying the groundwork for you to better understand your parents’ feelings. Not only do you want to get information, but you also want to share information.{/t} </p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    ...
    <div id="lesson-2-slide-8" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>{t}Some caregivers feel that practice sessions are valuable to "test out" the conversations in other situations. Here are some practice activities for you to try out.{/t}</p>
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityPracticetheTalk.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-2-slide-9" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li> {t}In the role of <i>PARENT</i> – you are in charge, make the rules, and set the agenda. Negotiating is unnecessary. You are a “teller of information.”{/t} </li>
          <li> {t}In the role of <i>PARTNER</i> – you have a common goal, mutual interests, and work towards collaborating on common goals. You are a “listener for information.”{/t} </li>
        </ul>
        ...
        <p> {t}<i>Self-Coaching Hint</i>: As reinforcement, you need to make sure your intentions are clear. You are not trying to subtly coerce them or manipulate them in some way. You intend to make every action and word worthy of trust. Practice holding that intention in your mind and heart, and it will make a difference in how you listen and influence what you say!{/t} </p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> {t}Complete Module{/t} </a> </div>
  ...
  <div id="lesson-3">
    ...
    <div id="lesson-3-slide-5" class="course-slide">
      <div class="content">
        ...
        <p> {t}The greatest risk of keeping health information on paper can easily be understood when considering the saga of Hurricane Katrina. The risks of keeping health information on paper were fully exposed when hundreds of thousands of evacuees sought care in new medical communities across the country. Evacuees lacked even the most basic personal health information, such as their medications and dosages. Most of their paper records were destroyed in the muck of hurricane-caused flooding, and many medical practices and hospitals were shut down for weeks, perhaps forever. Out of necessity, a program called{/t} <a href="http://www.katrinahealth.org" target="_blank">KatrinaHealth</a> {t}was created to rapidly develop electronic health records for those displaced by the hurricane. Since then, the American Association of Family Practitioners (AAFP) has collaborated with the city of New Orleans and Intel, among others, to provide digital PHRs to every New Orleans resident who wants one, and
          to transfer these to medical practices and hospitals in the displaced residents' current location for follow-up care.{/t} </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a> </div>
    </div>
    ...
    <div id="lesson-3-slide-6" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/PHRForm.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
    ...
    <div id="lesson-3-slide-7" class="course-slide">
      <div class="content">
        ...
        <p> {t}<i>My Family Health Portrait</i> is a web-based program developed from the U.S. Department of Health and Human Services, Family History Initiative. This initiative is designed to encourage families to learn more about their family health history. Because health providers have long understood that common illnesses can run in families (like high blood pressure, diabetes, and heart disease – to name a few), tracing illnesses experienced by your parents, grandparents, and other blood relatives may help your physician predict disorders to which you may be at risk and take preventive action.{/t} </p>
        <p> {t}<i>My Family Health Portrait</i> website helps users organize family history information, save it to their own computer, and print a hard copy to take to the physician’s visit. Additionally, users may grant permission for other family members to view information on their website.{/t} </p>
        <p> <a href="https://familyhistory.hhs.gov/fhh-web/home.action" target="_blank">{t}Click here to access My Family Health Portrait website.{/t}</a> </p>
        <p> {t}Read the section, “<i>Learn More About My Family Health Portrait</i>” to answer the following questions.{/t} </p>
        <ul>
    ...
    <div id="lesson-3-slide-11" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExerciseCARECoachingandSelectingPHRs.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
      </div>
      <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> {t}Complete Module{/t} </a> </div>
    </div>
  </div>
  ...
  <div id="lesson-4">
    ...
    <div id="lesson-4-slide-6" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExercisePowerPhraseSurvey.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
    ...
    <div id="lesson-4-slide-8" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li> <i>{t}“I have a pain in my…..that started about……”{/t}</i> </li>
          <li> <i>{t}“My symptoms are….”{/t}</i> </li>
        </ul>
        <p> {t}With these simple prompts, the doctor can begin the exam with the understanding of “<b>what brought you here today.</b>”{/t} </p>
        ...
        <p> <i>{t}“These are the medications I am currently taking…..”{/t}</i> </p>
        <p> <i>{t}“These are the vitamins and herbs I take….Which of these may interact with my medications?”{/t}</i> </p>
        <p> <i>{t}“What does this drug do?”{/t}</i> </p>
        ...
        <ul>
          <li> <i>{t}“I am aware that you are busy. However, I am feeling rushed and I need to be sure that my questions are answered. Please give me the time I need.”{/t}</i> </li>
          <li> <i>{t}“I’m not comfortable with how fast you are talking. I need you to slow down and help me understand.”{/t}</i> </li>
          <li> <i>{t}“I understand that you are busy. However, I want to make sure you understand my symptoms and that I learn everything you can teach me about my condition and care.”{/t}</i> </li>
        </ul>
        ...
        <p> {t}<i>Self-Coaching Hint</i>: Be assertive but not aggressive in communicating with your parent’s doctors. Most doctors and other health care professionals today want to ask questions and be asked about health care issues by their patients.{/t} </p>
        <p>{t}Click the icon to access the activity.{/t}</p>
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityPracticingPowerPhraseswithYourHealthProvide.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
    ...
    <div id="lesson-4-slide-9" class="course-slide">
      <div class="content">
        ...
        <p> {t}Click the icon below to access the following handouts: <i>People, Places, Things and More Things</i>{/t} </p>
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/Lesson4Handouts.zip'); ?>" target="_blank"> <img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
      </div>
      <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> {t}Complete Module{/t}</a> </div>
    </div>
  </div>
  <div id="lesson-5">
    ...
    <div id="lesson-5-slide-5" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>{t}How can I convince my older parents to move to a retirement community? Here are two scenarios for you to respond to.{/t}</p>
        <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityRelocatingScenarios.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    ...
    <div id="lesson-5-slide-6" class="course-slide">
      <div class="content">
        ...
        <p> <i>{t}Is your older parent experiencing significant weight loss?{/t}</i> </p>
        ...
        <p> <i>{t}Does your older parent experience mood changes, depression, or isolation?{/t}</i> </p>
        ...
        <p> <i>{t}Do you or your older parent have concerns about safety?{/t}</i> </p>
        ...
        <p> <i>{t}Do you or your older parent have concerns about security issues?{/t}</i> </p>
        ...
        <p> <i>{t}Does your older parent need help with daily tasks?{/t}</i> </p>
        ...
        <p> {t}One last question to consider is, "<i>Will moving be any easier next spring, next year, five or even ten years down the road</i>?" In just about every case, the answer is “no.”{/t} </p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    ...
    <div id="lesson-5-slide-9" class="course-slide">
      <div class="content">
        ...
        <p> {t}Requirements for applicants and payment options vary considerably for CCRCs. Within the current housing market, many CCRCs are offering payment plan options or assistance to older couples who may need to sell their current home prior to moving to the new community. Many CCRCs offer what is termed “life care contracting.” Life care communities provide the same continuum of care to a resident for life, but the biggest difference is this: <b>residents who become financially unable to pay their monthly care fees are subsidized by the community, with the same access to services, and with no interruption in care or change in priority status</b>. In other words, residents are guaranteed the same quality of care and access to care from day one through end-of-life, regardless of their personal financial situation. Additionally, most life care communities offer all health care services on the same campus. The idea is that, after qualifying through a health and financial application
          process, residents will never have to move again, except between levels of care as needed.{/t} </p>
        ...
        <a href="<?php echo $this->createDownloadUrl('carecoachingonline/GilbertGuideILTookit.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
    ...
    <div id="lesson-5-slide-10" class="course-slide">
      <div class="content">
        ...
        <p> <i>{t}Affordable Senior Housing Options{/t}</i> </p>
    ...
    <div id="lesson-5-slide-11" class="course-slide">
      <div class="content">
        ...
        <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExerciseVisitingaSeniorLivingCommunity.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" /> </a> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
    ...
    <div id="lesson-5-slide-13" class="course-slide">
      <div class="content">
        ...
        <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityCARECoachingthroughLongDistanceCaregiving.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
    ...
    <div id="lesson-5-slide-14" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li>{t}What is the basic information I should have at hand as a long distance caregiver?{/t}
            <ul>
          ...
          <li>{t}What can I really expect to do from a distance? I don’t feel comfortable just stepping into a situation.{/t}
            <ul>
          ...
          <li>{t}How can I feel less frustrated and angry with the caregiving situation?{/t}
            <ul>
    ...
    <div id="lesson-5-slide-15" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li>{t}What is a geriatric care manager and how can one help?{/t}
            <ul>
          ...
          <li>{t}How can I get my mother some relief in caring for my father?{/t}
            <ul>
          ...
          <li>{t}What if my mom says, “Promise me you’ll never put me in a nursing home”?{/t}
            <ul>
          ...
          <li>{t}What are some other resources for long distance caregivers?{/t}
            <ul>
    ...
    <div id="lesson-6">
      ...
      <div id="lesson-6-slide-5" class="course-slide">
        <div class="content">
          ...
          <p><a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityUsingYourPowersofObservation.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
      </div>
      ...
      <div id="lesson-6-slide-6" class="course-slide">
        <div class="content">
          ...
          <table>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Exposed cords from lamps, extensions, and telephones{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Cords covered by carpets and rugs{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Overloaded extension cords{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Rugs, runners, and mats{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Accessibility to the telephone{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Smoke detectors{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Electrical outlets/switches{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td width="40%" align="left"><p>{t}Light bulbs{/t}</p></td>
              <td><ul>
      ...
      <div id="lesson-6-slide-7" class="course-slide">
        <div class="content">
          ...
          <table>
            ...
            <tr>
              <td><p>{t}Emergency escape plan{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td><p>{t}Kitchen range/oven{/t}</p></td>
              <td><ul>
            ...
            <tr>
              <td><p>{t}High cabinets/shelves{/t}</p></td>
              <td><ul>
          ...
          <p> {t}<a href="http://www.homemods.org/resources/doable-home/index.shtml" target="_blank"><b>The Do Able Renewable Home</b> </a>. This booklet is designed to help overcome problems experienced in the home as one grows older. Content was developed in collaboration with gerontologists to make the home more livable.{/t} </p>
          <p> {t}<b>Lighting the Way: A Key to Independence</b>. This resource provides a number of recommendations to help older adults see better. From home lighting to doing small tasks, many suggestions can easily be implemented with simple modifications.{/t} </p>
          <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/LightingInTheHome.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a>
          <p> {t}<b>Home Safety Checklist</b>. This is a simple checklist that you can use when visiting your older parents to assess safety issues in their home environment.{/t} </p>
          <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/HomeSafetyChecklist.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> <br />
            <br />
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
      </div>
      ...
      <div id="lesson-6-slide-9" class="course-slide">
        <div class="content">
          ...
          <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExerciseAssessingtheSituation.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a> </p>
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
      </div>
      ...
      <div id="lesson-6-slide-11" class="course-slide">
        <div class="content">
          ...
          <p> <i>{t}What are the warning signs when someone should begin to limit driving or stop altogether?{/t}</i> </p>
          <ul>
      ...
      <div id="lesson-6-slide-12" class="course-slide">
        <div class="content">
          ...
          <p> <b>{t}Driver Self-Assessment{/t}</b> </p>
          ...
          <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/DriverSelfAssessment.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="" /> </a>
      ...
      <div id="lesson-6-slide-14" class="course-slide">
        <div class="content">
          ...
          <p class="subtopic">{t}Resources{/t}</p>
          <p> <b>{t}Warning Signs for Older Drivers{/t}</b><br />
          ...
          <p> <a href="<?php echo $this->createDownloadUrl('carecoachingonline/WarningSignsOlderDrivers.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="" /> </a> </p>
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
      </div>
    ...
    <div id="lesson-7-slide-3" class="course-slide">
      <div class="content">
        ...
        <p><a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExerciseIdentifyingSolutionstoSupportChoiceandPreferences.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>"> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
    ...
    <div id="lesson-7-slide-7" class="course-slide">
      <div class="content">
        ...
        <p><a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityWaystoManageYourOwnStress.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" /> </a> </p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a> </div>
    </div>
