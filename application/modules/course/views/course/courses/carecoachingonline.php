	...
	<div id="lesson-3">
		...
		<div id="lesson-3-slide-6" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/PHRForm.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" width="48" height="48" class="normal" /> </a>
				</p>
	...
	<div id="lesson-4">
		...
		<div id="lesson-4-slide-6" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExercisePowerPhraseSurvey.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" width="48" height="48" class="normal" /> </a>
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a>
		...
		<div id="lesson-4-slide-8" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityPracticingPowerPhraseswithYourHealthProvide.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" width="48" height="48" class="normal" /> </a>
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a>
		...
		<div id="lesson-4-slide-9" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/Lesson4Handouts.zip'); ?>" target="_blank"> <img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" width="48" height="48" class="normal" />
					</a>
				</p>
			</div>
			<div class="buttons">
	...
	<div id="lesson-5">
		...
		<div id="lesson-5-slide-8" class="course-slide">
			<div class="content">
				...
				<h5>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/GilbertGuideALToolkit.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a>{t}Download Gilbert Guide – Assisted Living Evaluation and Moving Kit{/t}
				</h5>
		...
		<div id="lesson-5-slide-9" class="course-slide">
			<div class="content">
				...
				<h5>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/RetirementRedefinedArticle.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a>{t}Retirement Redefined{/t}
				</h5>
				<p>
				...
				<h5>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/GilbertGuideILTookit.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a>{t}Download Gilbert Guide – Independent Living &amp; CCRC Evaluation Kit{/t}
				</h5>
				<br /> <br />
			</div>
			<div class="buttons">
		...
		<div id="lesson-5-slide-11" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/ExerciseVisitingaSeniorLivingCommunity.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" /> </a> {t}Click on the icon to access the activity: Visiting a Senior Living Community{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a>
		...
		<div id="lesson-5-slide-13" class="course-slide">
			<div class="content">
				...
				<p>{t}Read the following scenario and then respond to the CARE coaching questions. We provide some initial “openers” for CARE coaching questions for you to more fully develop your own questions.{/t}</p>
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityCARECoachingthroughLongDistanceCaregiving.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" alt="image" class="normal" /> </a>{t}CARE Coaching through Long Distance Caregiving{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a>
		...
		<div id="lesson-7-slide-2" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Some general <b>Do's</b> and <b>Dont's</b>:{/t}
				</p>
				<p>
					<b>{t}Do:{/t}</b>
				</p>
		...
		<div id="lesson-7-slide-7" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('carecoachingonline/ActivityWaystoManageYourOwnStress.pdf'); ?>" target="_blank"><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('care/pdf-icon.png'); ?>" /> </a> <b>{t}Click the icon to access the Activity{/t}</b>
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a>
