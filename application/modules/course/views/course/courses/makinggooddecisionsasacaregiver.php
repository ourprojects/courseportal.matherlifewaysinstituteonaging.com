...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('makinggooddecisionsasacaregiver/166312138.png'); ?>" id="certificate" alt="Image">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('makinggooddecisionsasacaregiver/80608570.png'); ?>" alt="Facilitator" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('makinggooddecisionsasacaregiver/Agenda_makinggooddecisionsasacaregiver.pdf'); ?>" target="_blank" class="button">Agenda</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Welcome to the course, “Making Good Decisions as a Caregiver.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other. In particular, long distance caregiving is a growing phenomenon as adult children may need to relocate because of career changes, new job opportunities, or other reasons.</p>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>It is often helpful for the long distance caregiver to have checklists to identify core areas that older parents now or in the future may need some assistance. Think about your own caregiving situation and review the following list.</p>

				<p>Check off areas of care needs that are important now for you as a caregiver. Go through the list again and check off those areas of care needs that may be important for you in the future as a caregiver. This will give you some important discussion points to bring up with your parents and/or your siblings. We have attached this form at the bottom of the page for downloading and printing.</p>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<hr />
				<p> Try to use all of your senses to observe changes related to your parent or the home environment during your visits.</p>
				...
				<ul>
					...
					<li> Is the refrigerator empty of food or is food spoiling? (Hint: There may be containers in the refrigerator, but check if there is food actually in those containers or if they are sitting empty.)</li>
					<li>Are there safety issues or potential risks in the home such as loose throw rugs on the floors, nonfunctioning fire detectors, or burnt pots on the stove?</li>
				</ul>
		...
		<div id="lesson-1-slide-8" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>When you visit their home, be observant for changes in the environment or potential safety hazards. Find out if you parents have “advanced directives” that outline their health care treatment preferences.</li>
				</ul>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				...
				<ol start="2">
					<li>What can I really expect to do from a distance? I don’t feel comfortable just stepping into a situation.</li>
				</ol>
				<ul>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						Obtain a free <a href="www.netofcare.org/crd/resource_form.asp" target="_blank">Caregiver Resource Directory</a> that provides resources, facts, and advice about caring for a family member as well as for yourself.
					</li>
					<li>
						<a href="www.benefitscheckup.org" target="_blank">Benefits Check UP</a> is a free online service provided by the National Council on Aging which allows people to find programs that can help them meet health care costs.
					</li>
					<li>
						<a href="www.archrespite.org" target="_blank">ARCH National Respite Network and Resource Center</a> provides resources and information including a respite locator program and information clearinghouse.
					</li>
					<li>
						<a href="www.eldercare.gov" target="_blank">Eldercare Locator</a> is a nationwide service helping identify local resources for older adults. 
					</li>
					<li>
						<a href="www.nfcacares.org" target="_blank">National Family Caregivers Association</a> supports family caregivers and offers education, information, and referrals.
					</li>
				</ul>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				...
				<p>Long distance caregiving can have a great impact on one’s job. Because of fear of losing one’s job or impact on job security, many working caregivers do not inform their employers of their caregiving obligations. On the other side of the coin, employers are seeing a growing number of employees with family caregiving obligations particularly related to older parents. In fact, it may not surprise you that your supervisor could also be going through this experience now or in the near future.</p>

				<p>Many organizations have programs in place to assist employees to better meet their obligations as caregivers to older adults. You may want to discuss some of these benefits with your human resources department to see what may be available to you.</p>

				<p>Some examples of family caregiving options include:</p>

				<ul>
					<li>Employee assistance programs – Human Resources may provide information to you from your EAP provider regarding programs and counseling services available to employees and their families.</li>
					<li>Flex time – employees with family caregiving responsibilities may be able to work flexible hours or days of the week to meet both work and home obligations more effectively.</li>
					<li>Job sharing with another employee – employees with family caregiving obligations may be able to partner and share a work schedule to cover each other’s responsibilities.</li>
					<li>Telecommuting or working from home – an occasion day to work at home may alleviate some of the pressures balancing work and home life.</li>
					<li>Case management services – community services in your area may include case management or care management assistance in the home. This may include home care services, respite care, meals-on-wheels, or other referral services.</li>
					<li>Family and Medical Leave Act (FMLA) – available to employees in certain companies that allow up to 12 weeks of unpaid leave to eligible employees in order to care for certain family members for medical reasons.</li>
				</ul>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<p>The American Psychological Association offers several strategies to help those in the “sandwich generation” manage their stress. In another course, we address the power of journaling as a self-coaching exercise to help create positive self-talk.</p>

				<p>In managing stress, journaling can also be a very effective tool to help identify what situations or events trigger stressful feelings, how you deal (or don’t deal) with stress, and how you may manage stress.</p>
		...
		<div id="lesson-1-slide-16" class="course-slide">
			<div class="content">
				...
				<p>Family conflict regarding caregiving of older parents is quite common. Dealing with care of older parents can rekindle early rivalries or jealousies among siblings. Family dynamics can be very complex, but there are some common underlying causes of conflict. In some families, siblings may perceive imbalance of care and responsibilities among family members. For example, siblings who live nearest to parents or those who are single females may be “expected” by their siblings to be primary caregivers regardless of other responsibilities. In some families, conflicts about money can be a significant source of conflict. One sibling may feel he or she deserves a greater portion of an inheritance, while the long distance sibling may feel that too much was spent on parent’s care by a brother or sister.</p>

				<p>Central to most sibling conflicts is a breakdown of communication. Many caregivers relate to this common scenario:</p>

				<blockquote>Cara is a long distance caregiver. Unfortunately her new job meant she has not been able to visit her aging mother for the past three years. She never had a very close relationship with her mother, and so their conversations always tended to be on a superficial level. She calls her mother about every two weeks. Over the phone, Cara’s mother tells her she is fine. On the other hand, Cara’s sister, Joyce, who is the primary caregiver, calls Cara and tells her that caring for their mother has become very challenging. Their mother has wandered from home on numerous occasions and has difficulty finding her way back home. She also leaves pots on the stove and forgets to turn off the burners. Joyce wants to talk about potentially moving their mother to an assisted living community, but Cara does not want any part of such a decision, as she does not see any problem as her mother “sounds fine” on the phone.</blockquote>
		...
		<div id="lesson-1-slide-17" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>The following are some recommendations to work on sibling communications. Realize that this may take time, but if all parties commit to making improvements, the effect benefits the older parents – and isn’t that the goal?</p>

				<p>Suggestion #1:</p>

				<p>Hold regular family meetings. You may need to explore different ways to make these happen, particularly if some of the siblings are long distance.</p>

				<p>Suggestion #2:</p>

				<p>Divide caregiving responsbilities up according to abilities and availability. Long distance siblings may be able to take care of financial responsibilities or come in to provide respite for siblings who typically provide more direct caregiving.</p>

				<p>Suggestion #3:</p>

				<p>Don’t be afraid to communicate your concerns, observations, or feelings to your siblings. The more open your communication, the better the understanding by your siblings of the entire caregiving situation.</p>

				<p>Suggestion #4:</p>

				<p>Express appreciation to siblings for help they provide. You may soon find that they are offering more assistance as they receive recognitions for their contributions.</p>

				<p>Suggestion #5:</p>

				<p>During family meetings, focus on caregiving issues rather than bringing up old family conflicts or issues. Try to “feed forward” rather than “feedback.”</p>

				<p>Suggestion #6:</p>

				<p>Consider keeping a care notebook to record and document tasks, reminders, and responsibilities. Encourage siblings to add to the notebook their observations and reports.</p>
		...
		<div id="lesson-1-slide-18" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>A good method to evaluate an older parent’s environment and connections is to use an “ecomap.” Important perspective may be learned by considering the older parent in the context of the various systems that are part of his or her experiences. Systems may include individuals (such as spouse or adult child), groups (such as physicians or therapists), and organizations (such as hospitals) that interact with the older adult. Considering the older adult’s interactions with these systems may reveal areas where help may be needed.</p>

				<p>Open the exercise below, “Developing an Ecomap” and follow the directions. Once systems are identified that interact with your older parent, respond to the questions that follow.</p>
		...
		<div id="lesson-1-slide-19" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>It is important that your older parent retains as much decision making abilities as possible. Your primary objective is to help your parent fulfill his or her needs and choices, not to take over your parent’s life.</p>

				<p>In some cases, your older parent may reject your assistance. There may be several reasons why older adults do not accept help from others:</p>
		...
		<div id="lesson-1-slide-20" class="course-slide">
			<div class="content">
				...
				<p>Throughout this course, you have had several opportunities to gain more understanding regarding your older parents’ needs and preferences. Every caregiving situation is unique. Understanding this will help you make good decisions as a caregiver.</p>

				<p>Many factors come into play when considering the best possible solutions about your parents and their future. These factors may include: your parents’ health and functional abilities, mobility, values and beliefs, and family and community support systems.</p>

				<p>In this exercise, we provide several questions for you to use as a framework to “interview” your parents regarding their choices and preferences for their future.</p>
		...
		<div id="lesson-1-slide-21" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>With many grown children seeking new career opportunities or needing to relocate due to their job away from their parents and the home in which they were raised, long distance caregiving has grown as an issue in our society with the number of long distance caregivers doubling over the next 15 years.</li>
					<li>Use all of your senses to observe changes related to your parent or the home environment during your visits.</li>
					<li>If you are a long distance caregiver, have basic information at your fingertips regarding your older parents including: contact information from their neighbors (and they have your information); local resources and services for older adults; current list of their medications; and copies of “advanced directives.”</li>
					<li>Geriatric care managers (licensed nurses or social workers who specialize in geriatric care) may be helpful to assist in evaluating and assessing older adults’ needs and in the coordination of care through community resources.</li>
					<li>Many organizations have programs in place to assist employees to better meet their obligations as caregivers to older adults. You may want to discuss some of these benefits with your human resources department to see what may be available to you.</li>
				</ol>
