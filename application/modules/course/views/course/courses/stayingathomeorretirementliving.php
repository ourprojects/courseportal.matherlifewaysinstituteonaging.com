...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('stayingathomeorretirementliving/166312138.png'); ?>" id="certificate" alt="{t}Image{/t}">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('stayingathomeorretirementliving/80608570.png'); ?>" alt="{t}Facilitator{/t}" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Agenda_stayingathomeorretirementliving.pdf'); ?>" target="_blank" class="button">{t}Agenda{/t}</a>
				</p>
			</td>
		</tr>
		<tr>
			...
			<td>
				<p>
					<a href="#lesson-1-slide-1" data-fancybox-group="lesson-1" class="teal lesson-1 button"> {t}Start{/t} </a> <a href="#lesson-1-slide-2" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-3" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-4" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-5" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-6" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-7" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-8" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-9" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-10" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-11" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a
						...
						data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-24" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-25" data-fancybox-group="lesson-1" class="hide lesson-1"></a> <a href="#lesson-1-slide-26" data-fancybox-group="lesson-1" class="hide lesson-1"></a>
				</p>
			</td>
		</tr>
	</table>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<blockquote style="font-size: 24px;">{t}To be self-determined is to endorse one's actions at the highest level of reflection.{/t}</blockquote>
				<blockquote style="font-size: 24px;">{t}When self-determined people experience a sense of freedom to do what is interesting, personally important, and vitalizing.{/t}</blockquote>

				<cite> {t}Edward Deci &amp; Richard Ryan{/t} </cite>
			</div>
			<div class="buttons">
		...
		<div id="lesson-1-slide-2" class="course-slide">
			<div class="content">
				...
				<p>{t}Welcome to the course, “Staying at Home or Retirement Living? Helping Parents Plan for the Future.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other. {/t}</p>
		...
		<div id="lesson-1-slide-4" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Probably the one area that is most challenging to discuss with older parents deals with their ability to continue to live independently in their own home or apartment. {/t}</p>
				...
				<ul>
					...
					<li>{t}What gives you joy in your lives?{/t}</li>
				</ul>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<h4>{t}Video – Learn about Senior Living{/t}</h4>
				<iframe style="width: 640px; height: 360px; display: block; margin: 15px auto; frameborder: 0;" src="//www.youtube.com/embed/4nHlzHS4PVg?list=UUwxxN3aMVzEs5AET6Hg3Ebw" allowfullscreen></iframe>
		...
		<div id="lesson-1-slide-6" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}The fourth component of CARE Coaching is that of encouraging. The decision to move to a retirement community is often a difficult one for older adults and families alike. Changes in health or other factors typically drive this decision, but being proactive and understanding how to make educated choices is key. {/t}</p>
				...
				<p>{t}Older persons may learn effective “cues” to help them remember important events or when to pay bills. It may be as simple as keeping a calendar or written lists of when the past visits occurred with their doctors. We should encourage those “cues” that are effective in promoting independence. {/t}</p>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Every caregiving situation is unique. Many factors come into play when considering the best possible solutions about your parents and their future. These factors may include: your parents’ health and functional abilities, mobility, values and beliefs, and family and community support systems. {/t}</p>
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Exercise_Identifying_Solutions_to_Support_Choice_and_Prefe.doc'); ?>" target="_blank" class="button">Download Activity</a>
				</p>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<p>{t}Engaging your parents in the process of choosing what furniture, household items, and personal treasures to take to their new home is important. Encouraging them to “personalize” their new home will make the transition easier. {/t}</p>

				<p>
					{t}There are services available (senior move managers) across the country that focus specifically on helping older adults “downsize” from large family homes to smaller spaces. They can do everything from coordinating the entire move, packing and unpacking the home, and arranging for sales, consignment, or donation of items that would not be part of the move. Learn more about senior move managers at the professional association’s <a href="http://nasmm.org" target="_blank">website</a> (www.nasmm.org). {/t}
				</p>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Activity_Relocating_Scenarios.docx'); ?>" target="_blank" class="button">Download Activity</a>
				</p>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<p>{t}Is your older parent experiencing significant weight loss?{/t}</p>

				<p>{t}Cooking for one can often be a chore especially for an older adult. When you eat alone, you eat less. Well-balanced meals can often be inconvenient to prepare.{/t}</p>

				<p>{t}Does your older parent experience mood changes, depression, or isolation?{/t}</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<p>{t}One last question to consider is, “Will moving be any easier next spring, next year, five or even ten years down the road?” In just about every case, the answer is “no.”{/t}</p>
		...
		<div id="lesson-1-slide-18" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Assisted living communities provide care for seniors who need some help with activities of daily living yet wish to remain as independent as possible. A middle ground between independent living and nursing homes, assisted living communities aim to foster as much autonomy as the resident is capable of.  Most communities offer 24-hour supervision and an array of support services, with more privacy, space, and dignity than many nursing homes at lower costs.{/t}</p>

				<p>{t}There are approximately 33,000 assisted living communities operating in the U.S. today. The number of residents living in a facility can range from several to 300, with the most common size being between 25 and 120 residents.{/t}</p>

				<p>{t}Assisted living staff helps residents with daily personal care including bathing, dressing, eating, grooming, and getting around. Medical care is limited, but families may contract for some medical needs such as medication administration or home health care. Assisted living communities focus on what is termed a “social model” of care (e.g., promoting social engagement and supporting individual care needs).{/t}</p>

				<p>{t}To understand more about assisted living – levels of care, caring for loved ones with dementia, how to pay for one, and how to evaluate one – click on the following link to download an “Assisted Living Evaluation and Moving Kit.”{/t}</p>

				<p>{t}Download Gilbert Guide – Assisted Living Evaluation and Moving Kit{/t}</p>

				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Gilbert_Guide_AL_Toolkit.pdf'); ?>" target="_blank" class="button">Download AL Guide</a>
				</p>
		...
		<div id="lesson-1-slide-19" class="course-slide">
			<div class="content">
				...
				<h4>{t}Video – Learn about Assisted Living{/t}</h4>

				<iframe style="width: 480px; height: 360px; display: block; frameborder: 0; margin: 15px auto;" src="//www.youtube.com/embed/_9DdN7kXw5w?rel=0" allowfullscreen></iframe>
		...
		<div id="lesson-1-slide-21" class="course-slide">
			<div class="content">
				...
				<p>{t}A “Continuing Care Retirement Community” (also referred to as a CCRC) are different from other types of housing for older adults as they provide customized living quarters, personal care services, and health care all at one location. A benefit to older couples is the fact that if one partner’s health begins to fail, he or she may receive required care within that same community or campus. Most CCRCs provide all three levels of service described on the previous page:{/t}</p>
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Retirement_Redefined_Article.pdf'); ?>" target="_blank" class="button">Download Article</a>
				</p>
		...
		<div id="lesson-1-slide-22" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Requirements for applicants and payment options vary considerably for CCRCs. Within the current housing market, many CCRCs are offering payment plan options or assistance to older couples who may need to sell their current home prior to moving to the new community.{/t}</p>

				<p>{t}Many CCRCs offer what is termed “life care contracting.” Life care communities provide the same continuum of care to a resident for life, but the biggest difference is this: residents who become financially unable to pay their monthly care fees are subsidized by the community, with the same access to services, and with no interruption in care or change in priority status. In other words, residents are guaranteed the same quality of care and access to care from day one through end-of-life, regardless of their personal financial situation.{/t}</p>

				<p>{t}Additionally, most life care communities offer all health care services on the same campus. The idea is that, after qualifying through a health and financial application process, residents will never have to move again, except between levels of care as needed.{/t}</p>
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Gilbert_Guide_IL_Tookit.pdf'); ?>" target="_blank" class="button">Download Guide</a>
				</p>
		...
		<div id="lesson-1-slide-23" class="course-slide">
			<div class="content">
				...
				<iframe style="width: 420px; height: 315px; frameborder: 0; display: block; margin: 15px auto;" src="//www.youtube.com/embed/4ZuGvIfuk6M?rel=0" allowfullscreen></iframe>
		...
		<div id="lesson-1-slide-24" class="course-slide">
			<div class="content">
				...
				<iframe style="width: 420px; height: 315px; frameborder: 0; display: block; margin: 15px auto;" src="//www.youtube.com/embed/cUrdKp8MGEw?rel=0" allowfullscreen></iframe>
		...
		<div id="lesson-1-slide-25" class="course-slide">
			<div class="content">
				...
				<p>{t}We have developed the following checklist that you may print and take with you on your visit. We recommend visiting a CCRC so that you may get an idea of the different levels of services and care that are available to residents.{/t}</p>

				<h5>{t}Visiting a Senior Living Community{/t}</h5>

				<p>
					<a href="<?php echo $this->createDownloadUrl('stayingathomeorretirementliving/Exercise_Visiting_a_Senior_Living_Community.docx'); ?>" target="_blank" class="button">Download Exercise</a>
				</p>
		...
		<div id="lesson-1-slide-26" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>{t}The fourth component of CARE Coaching is that of Encouraging. Encouraging our older parents can take many forms. Primarily, we want to encourage them to be as independent as possible for as long as possible.{/t}</li>
					<li>{t} We all want to feel that we have choices in our daily lives. In some cases, it may be tempting to want to quickly find a solution to a problem older parents are experiencing. Imposing a solution on older parents may actually make a situation more of a problem.{/t}</li>
					<li>{t} When the decision to move is made by your parents, encouraging their transition is important. That may include; (1) offering a short stay at a retirement community before making final decisions; (2) encouraging parents to personalize their new home; or (3) utilizing the services of senior move managers who can help with important decisions and coordination of moves.{/t}</li>
					<li>{t} Some indicators when it may be time to consider a move for older parents include: (1) significant weight loss; (2) changes in mood or growing isolation; (3) safety concerns; and (4) growing need for help with daily tasks.{/t}</li>
					<li>{t}There are several options in considering a move by older parents ranging from staying at home to various retirement living options. The aging population and growing consumer expectations for choice and quality in care have sparked increased options and interest in retirement living options. The best way to understand senior living communities is to actually visit one in your area. Many welcome adult children to visit and learn about programs and amenities.{/t}</li>
				</ol>
