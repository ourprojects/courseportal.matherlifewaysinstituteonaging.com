...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('improvingcommunicationwithhealthcareproviders/166312138.png'); ?>" id="certificate" alt="{t}Image{/t}">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('improvingcommunicationwithhealthcareproviders/80608570.png'); ?>" alt="{t}Facilitator{/t}" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('improvingcommunicationwithhealthcareproviders/Agenda_improvingcommunicationwithhealthcareproviders.pdf'); ?>" target="_blank" class="button">{t}Agenda{/t}</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Welcome to the course, “Improving Communication with Health Care Providers.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other.{/t}</p>
		...
		<div id="lesson-1-slide-2" class="course-slide">
			<div class="content">
				...
				<p>{t}CARE Coaching considers “real life” situations that family caregivers must often deal with (such as having conversations with aging parents about their needs and preferences for their future care, managing health information, communicating with health care providers, maneuvering the health care system, and addressing home safety issues, to name a few).{/t}</p>

				<p>{t}Activities in the course help stimulate “new thinking” by family caregivers providing them with tools to strengthen their knowledge, skills, and self-awareness about their role and responsibilities. As a result, family caregivers can focus on what is most important to be effective in caring for their loved ones.{/t}</p>
		...
		<div id="lesson-1-slide-3" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Talk to anyone today about the state of health care and you will probably get an earful of complaints, “horror” stories, and head shaking. Complaints run the gamut from problems with insurance companies and Medicare, physicians who don’t spend enough time with patients, to quick hospital discharges.{/t}</p>

				<p>{t}Here are common issues voiced by older adult patients:{/t}</p>

				<ul>
					<li>{t}They cannot get an accurate diagnosis, don't understand they need treatment, and need someone to help them find physicians, or get tests, that can help them.{/t}</li>
					...
					<li>{t} They have received physician or hospital bills that they cannot sort out or decipher.  They believe they have been billed for services they did not receive.  They have read that up to 80% of hospital bills are incorrect, and they want someone to help them negotiate with whoever has billed them.{/t}</li>
				</ul>
		...
		<div id="lesson-1-slide-4" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Some of our parents may fondly remember the days when physicians took time with their patients or even came to the home for a visit! We may not be able to “fix” all the problems with the health care system, but what we can do is focus on two things:{/t}</p>
				...
				<p>{t}Particularly for many older adults, the experience of the patient-physician relationship is really what’s missing in much of today’s health care experience. We can use CARE Coaching techniques to help build that relationship.{/t}</p>
				...
				<p>{t}This course will also reinforce your important role as “advocate.” So let’s begin with that all important “patient-physician” relationship.{/t}</p>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<p>{t}This brings us to the third component of CARE Coaching, that of relating. The most important factor in the patient-physician relationship is communicating or relating. It is fairly obvious that if a patient cannot communicate well with his or her physician, that’s a problem. How do you know that your older parents’ physician is relating? Here are some questions to ask your parents:{/t}</p>

				<ul>
					<li>{t}Is your physician listening to what you are saying?{/t}</li>

					<li>{t}Does your physician show understanding about your concerns by responding meaningfully to them?{/t}</li>
					<li>{t}When your physician explains medical issues to you, are they made to be understandable?{/t}</li>
					<li>{t}Is your physician patient with you and willing to draw out questions you may have?{/t}</li>
				</ul>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t} Occasionally, it may feel intimidating to speak to physicians for one reason or another. At times, the actions of the physician may make it appear that he or she has little time to spend with us. At other times, we may feel inadequate in our knowledge and use of medical terms, feeling like we speak a different language than physicians.{/t}</p>

				<p>{t}Older adults may especially loath to question physicians because they were raised in a generation where physicians were considered to be above reproach. Many of today’s generation of health care professionals encourage questions and want their patients to play a role in their health care.{/t}</p>
				...
				<p>{t}Another important consideration for you to understand as the caregiver relates to patient privacy requirements and rights. If you are not the medical guardian (or power of attorney) for your parents, they must give consent for you to get information about their health care.{/t}</p>

				<p>{t}On the other hand, if you are the medical guardian of someone and they are either too young, too old or too sick to speak about their medical history themselves, it is perfectly reasonable for you to take that role with health care professionals. Remember to be especially diplomatic with older adults who may take offense at being “spoken for.” Try to work out who will be the chief medical historian and speaker before you enter the physician’s office.{/t}</p>

				<p>{t}The next exercise will coach you through learning to use “PowerPhrases” – short, specific expressions that get results by saying what you mean and meaning what you say. By planning some specific phrases to use in advance of a physician’s appointment, older adults find that they can impact the outcome of the interaction.{/t}</p>
		...
		<div id="lesson-1-slide-8" class="course-slide">
			<div class="content">
				...
				<p>{t}A “PowerPhrase” is a short, specific expression that gets results by saying what it means and meaning what it says (without being cruel!). By planning specific phrases to use prior to an appointment, the results can be much more favorable to the patient.{/t}</p>

				<p>{t}Let’s do an exercise to see your current “PowerPhrase” skill level. Click on the following link to take a quick survey.{/t}</p>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Now that you have assessed your PowerPhrase skill level, we will now focus on PowerPhrases related to your health care provider to ensure a positive visit. By planning specific phrases to use in advance of the appointment, the patient can impact the outcome of the visit. You may find these helpful not only for your older parents, but also for your own use when visiting your physician.{/t}</p>

				<p>{t}Here is another typical scenario. You are visiting your mother one Sunday afternoon. You notice that she appears to be limping and favoring one side when she walks. You say, “Mom, I noticed you are limping. Are you having some difficulty walking?” {/t}</p>

				<p>{t}She says, “Yes, my left shin is very painful. It’s been like this for about a week.” You ask to see her shin and you notice that there is redness and swelling. She tells you that she will be seeing her physician this Thursday. You offer to accompany her, and she agrees.{/t}</p>

				<p>{t}On Thursday, you take her to her appointment and accompany her to the exam room. Dr. Palmer enters and asks your mom how she is feeling. Your mom replies, “Fine, thank you.” Dr. Palmer reviews the laboratory results and says, “Your iron level is a bit low. I’ll give you a B12 injection and you’ll feel as good as new!” “Thank you, physician,” replies your mom. With that the physician exits to see his next patient.{/t}</p>
		...
		<div id="lesson-1-slide-10" class="course-slide">
			<div class="content">
				...
				<p>{t}Think of PowerPhrases as the means to tell the physician exactly what he or she needs to know. You or your older parent should not leave the visit until all your questions are answered.{/t}</p>

				<p>{t}Here are some starter PowerPhrases to be used in response to the physician’s opening question “How are you doing?”:{/t}</p>

				<ul>
					<li>{t}“I have a pain in my... that started about..."{/t}</li>
					<li>{t}“My symptoms are….”{/t}</li>
				</ul>

				<p>{t}With these simple prompts, the physician can begin the exam with the understanding of “what brought you here today.”{/t}</p>

				<p>{t} It is important that your older parent brings a list of pertinent information to readily provide the physician with details that may be important. The Physician visit is also an opportunity to learn more about potential issues that may arise, say from drug interactions. Some PowerPhrases include:{/t}</p>

				<ul>
					<li>{t}“These are the medications I am currently taking…..”{/t}</li>
					<li>{t}“These are the vitamins and herbs I take….Which of these may interact with my medications?”{/t}
					
					
					<li>{t}“What does this drug do?”{/t}</li>
					</li>
				</ul>


				<p>{t}At times, you or your older parent may feel rushed. It is essential that you or your older parent feels comfortable saying so to the physician. This one may take practice!{/t}</p>

				<p>{t} Some PowerPhrases are:{/t}</p>

				<ul>
					<li>{t}“I am aware that you are busy. However, I am feeling rushed and I need to be sure that my questions are answered. Please give me the time I need.”{/t}</li>
					<li>{t}“I’m not comfortable with how fast you are talking. I need you to slow down and help me understand.”{/t}
					
					
					<li>{t}“I understand that you are busy. However, I want to make sure you understand my symptoms and that I learn everything you can teach me about my condition and care.”{/t}</li>
					</li>
				</ul>

				<p>{t}For this activity, you will prepare for the physician visit and practice PowerPhrases. You may want to practice with your older parent or you may role play with your spouse, relative, or friend.{/t}</p>
				...
				<p>{t}Self-Coaching Hint: Be assertive but not aggressive in communicating with your parent’s physicians. Most physicians and other health care professionals today want to ask questions and be asked about health care issues by their patients.{/t}</p>
		...
		<div id="lesson-1-slide-11" class="course-slide">
			<div class="content">
				...
				<p>{t}This information is not meant to be comprehensive, but provides you a starting point to better understand the complexities that are today’s health care system.{/t}</p>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>{t}The goal for any patient in the health care system should be to optimize one’s chances of achieving a good outcome when health care is needed. Taking charge of one’s health care is key.{/t}</li>
					<li>{t}The third component of CARE Coaching is Relating. The most important factor in the patient-physician relationship is communicating or relating.{/t}</li>
					<li>{t}In planning for your discussions with your older parents and their physicians, as their caregiver you have an obligation to understand your parents’ medical care as well as patient privacy requirements and rights. If you are not the medical guardian (or power of attorney) for your parents, they must give consent for you to get information about their health care. Try to work out who will be the chief medical historian and speaker before you enter the physician’s office.{/t}</li>
					<li>{t}A “PowerPhrase” is a short, specific expression that gets results by saying what it means and meaning what it says. By planning specific phrases to use prior to an appointment, the results can be much more favorable to the patient since the physician can begin the exam with the understanding of “what brought you here today.”{/t}</li>
					<li>{t}Be assertive but not aggressive in communicating with your parent’s physicians. Most physicians and other health care professionals today want to ask questions and be asked about health care issues by their patients.{/t}</li>
				</ol>
