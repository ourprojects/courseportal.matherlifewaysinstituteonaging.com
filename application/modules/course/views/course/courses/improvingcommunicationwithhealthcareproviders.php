...
<div id="sidebar">
    ...
    <div class="box-sidebar one">
        ...
        <img src="<?php echo $this->getImagesUrl('improvingcommunicationwithhealthcareproviders/166312138.png'); ?>"
...
<div id="lesson-1-slide-2" class="course-slide">
    <div class="content">
        ...
        <p>CARE Coaching considers “real life” situations that family caregivers must often deal with (such as having
            ...
            home safety issues, to name a few).</p>

        <p>Activities in the course help stimulate “new thinking” by family caregivers providing them with tools to
            strengthen their knowledge, skills, and self-awareness about their role and responsibilities. As a result,
            family caregivers can focus on what is most important to be effective in caring for their loved ones.</p>
        ...
        <p>This course will emphasize the CARE Coaching component of relating.</p>
...
<div id="lesson-1-slide-3" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>Talk to anyone today about the state of health care and you will probably get an earful of complaints,
            “horror” stories, and head shaking. Complaints run the gamut from problems with insurance companies and
            Medicare, physicians who don’t spend enough time with patients, to quick hospital discharges.</p>

        <p>Here are common issues voiced by older adult patients:</p>

        <ul>
            <li>They cannot get an accurate diagnosis, don't understand they need treatment, and need someone to help
                them find physicians, or get tests, that can help them.
            </li>
            <li>They are seeing too many specialists who are not coordinating their care.  They need someone who will
                take a look at their reams of medical records to help them sort out their treatment.
            </li>
            <li>They are having trouble with their insurer, who isn’t paying as promised, or who is denying them care.
            </li>
            <li> They have received physician or hospital bills that they cannot sort out or decipher.  They believe
                they have been billed for services they did not receive.  They have read that up to 80% of hospital
                bills are incorrect, and they want someone to help them negotiate with whoever has billed them.
            </li>
        </ul>
...
<div id="lesson-1-slide-4" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>Some of our parents may fondly remember the days when physicians took time with their patients or even came
            to the home for a visit! We may not be able to “fix” all the problems with the health care system, but what
            we can do is focus on two things:</p>

        <ul>
            <li>Learning to communicate effectively with health care providers – particularly with physicians – to
                manage relationships with providers, and
            </li>
            <li>Becoming empowered with knowledge to better understanding health care and roles of providers.</li>
        </ul>

        <p>Particularly for many older adults, the experience of the patient-physician relationship is really what’s
            missing in much of today’s health care experience. We can use CARE Coaching techniques to help build that
            relationship.</p>

        <p>The goal for any patient in the health care system should be to optimize chances of achieving a good outcome
            when health care is needed. Taking charge of one’s health care is key. For older parents who may not be used
            to or feel comfortable “taking charge of their health care,” this may be a difficult concept for them. We’ll
            look at some CARE Coaching techniques to help your parents feel comfortable being in charge.</p>

        <p>This course will also reinforce your important role as “advocate.” So let’s begin with that all important
            “patient-physician” relationship.</p>
...
<div id="lesson-1-slide-5" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>Over the years, the patient-physician relationship has been defined, though rules of ethics and rules of law,
            as a fiduciary one, as a relationship founded in trust. When a patient seeks out a physician’s help, and the
            physician agrees to give that help, a special covenant is made. The patient agrees to take the physician
            into confidence, to reveal intimate information related to one’s health. The physician, in turn, agrees to
            honor that trust, and to become the patient’s advocate in all health-related matters.</p>

        <p>As a caregiver, you are probably stepping into a situation where your older parents already are seeing one or
            more physicians for various ailments. Stepping into those relationships can often make you feel like the
        ...
        <p>This brings us to the third component of CARE Coaching, that of relating. The most important factor in the
            ...
            physician is relating? Here are some questions to ask your parents:</p>
...
<div id="lesson-1-slide-6" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>Have you ever left a physician's appoinment feeling that your questions weren't answered? Or not sure what
...
<div id="lesson-1-slide-7" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p> Occasionally, it may feel intimidating to speak to physicians for one reason or another. At times, the
            actions of the physician may make it appear that he or she has little time to spend with us. At other times,
            we may feel inadequate in our knowledge and use of medical terms, feeling like we speak a different language
            than physicians.</p>

        <p>Older adults may especially loath to question physicians because they were raised in a generation where
            physicians were considered to be above reproach. Many of today’s generation of health care professionals
            encourage questions and want their patients to play a role in their health care.</p>

        <p>In planning for your discussions with your older parents and their physicians, remember that as their
            caregiver you have an obligation to understand your parents’ medical care.</p>

        <p>Another important consideration for you to understand as the caregiver relates to patient privacy
            requirements and rights. If you are not the medical guardian (or power of attorney) for your parents, they
            must give consent for you to get information about their health care.</p>

        <p>On the other hand, if you are the medical guardian of someone and they are either too young, too old or too
            sick to speak about their medical history themselves, it is perfectly reasonable for you to take that role
            with health care professionals. Remember to be especially diplomatic with older adults who may take offense
            at being “spoken for.” Try to work out who will be the chief medical historian and speaker before you enter
            the physician’s office.</p>

        <p>The next exercise will coach you through learning to use “PowerPhrases” – short, specific expressions that
...
<div id="lesson-1-slide-8" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>How familiar does this sound? George has been waiting in the exam room for his physician to come in for over
            50 minutes. He has counted the floor and ceiling tiles at least six times and needs to use the bathroom out
            in the hall, but is unwilling to get up with just the examining gown to cover him.</p>

        <p>When George’s physician entered, he seemed rush and distracted. He glanced at George’s file and talked
            rapidly throughout the brief exam. George has several questions that he wanted to discuss that were very
            personal. Because the physician seemed so rushed, George was not comfortable asking his questions.</p>

        <p>The physician told George that his blood pressure was high and he was going to give him a prescription for
            ...
            his pharmacist the questions.</p>

        <p>Given the pressures of managed care, it is common for physicians to space appointments 15 minutes apart. The
            need for expediency can result in communication breakdowns that may result in inadequate care or serious
            consequences.</p>

        <p>A “PowerPhrase” is a short, specific expression that gets results by saying what it means and meaning what it
            says (without being cruel!). By planning specific phrases to use prior to an appointment, the results can be
            much more favorable to the patient.</p>

        <p>Let’s do an exercise to see your current “PowerPhrase” skill level. Click on the following link to take a
            quick survey.</p>
...
<div id="lesson-1-slide-9" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>Now that you have assessed your PowerPhrase skill level, we will now focus on PowerPhrases related to your
            ...
            older parents, but also for your own use when visiting your physician.</p>

        <p>Here is another typical scenario. You are visiting your mother one Sunday afternoon. You notice that she
            appears to be limping and favoring one side when she walks. You say, “Mom, I noticed you are limping. Are
            you having some difficulty walking?” </p>

        <p>She says, “Yes, my left shin is very painful. It’s been like this for about a week.” You ask to see her shin
            and you notice that there is redness and swelling. She tells you that she will be seeing her physician this
            Thursday. You offer to accompany her, and she agrees.</p>

        <p>On Thursday, you take her to her appointment and accompany her to the exam room. Dr. Palmer enters and asks
            your mom how she is feeling. Your mom replies, “Fine, thank you.” Dr. Palmer reviews the laboratory results
            and says, “Your iron level is a bit low. I’ll give you a B12 injection and you’ll feel as good as new!”
            “Thank you, physician,” replies your mom. With that the physician exits to see his next patient.</p>

        <p>What just happened here? Unfortunately for many older adults, this is a typical office visit. Without some
...
<div id="lesson-1-slide-10" class="course-slide">
    <div class="content">
        ...
        <p>Think of PowerPhrases as the means to tell the physician exactly what he or she needs to know. You or your
            older parent should not leave the visit until all your questions are answered.</p>

        <p>Here are some starter PowerPhrases to be used in response to the physician’s opening question “How are you
            doing?”:</p>
        ...
        <p>With these simple prompts, the physician can begin the exam with the understanding of “what brought you here
            today.”</p>

        <p> It is important that your older parent brings a list of pertinent information to readily provide the
            physician with details that may be important. The Physician visit is also an opportunity to learn more about
            potential issues that may arise, say from drug interactions. Some PowerPhrases include:</p>
        ...
        <p>At times, you or your older parent may feel rushed. It is essential that you or your older parent feels
            comfortable saying so to the physician. This one may take practice!</p>

        <p> Some PowerPhrases are:</p>

        <ul>
            <li>“I am aware that you are busy. However, I am feeling rushed and I need to be sure that my questions are
                answered. Please give me the time I need.”
            </li>
            <li>“I’m not comfortable with how fast you are talking. I need you to slow down and help me understand.”


            <li>“I understand that you are busy. However, I want to make sure you understand my symptoms and that I
                learn everything you can teach me about my condition and care.”
            </li>
            </li>
        </ul>

        <p>For this activity, you will prepare for the physician visit and practice PowerPhrases. You may want to
            practice with your older parent or you may role play with your spouse, relative, or friend.</p>
        ...
        <p>Self-Coaching Hint: Be assertive but not aggressive in communicating with your parent’s physicians. Most
            physicians and other health care professionals today want to ask questions and be asked about health care
            issues by their patients.</p>
...
<div id="lesson-1-slide-11" class="course-slide">
    <div class="content">
        ...
        <p>Learning what you need to know about the health care system can seem a daunting task. We break down some of
            the core components that are key for you to understand as caregivers for older parents.</p>

        <p>This information is not meant to be comprehensive, but provides you a starting point to better understand the
            complexities that are today’s health care system.</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo $this->createDownloadUrl('improvingcommunicationwithhealthcareproviders/Places.docx'); ?>"
                       target="_blank" class="button">Download Handout</a>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <a href="<?php echo $this->createDownloadUrl('improvingcommunicationwithhealthcareproviders/Things_and_More_Things.docx'); ?>"
...
<div id="lesson-1-slide-12" class="course-slide">
    <div class="content">
        ...
        <ol>
            <li>The goal for any patient in the health care system should be to optimize one’s chances of achieving a
                good outcome when health care is needed. Taking charge of one’s health care is key.
            </li>
            <li>The third component of CARE Coaching is Relating. The most important factor in the patient-physician
                relationship is communicating or relating.
            </li>
            <li>In planning for your discussions with your older parents and their physicians, as their caregiver you
                ...
                medical historian and speaker before you enter the physician’s office.
            </li>
            <li>A “PowerPhrase” is a short, specific expression that gets results by saying what it means and meaning
                what it says. By planning specific phrases to use prior to an appointment, the results can be much more
                favorable to the patient since the physician can begin the exam with the understanding of “what brought
                you here today.”
            </li>
            <li>Be assertive but not aggressive in communicating with your parent’s physicians. Most physicians and
