...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('becomingamoreconfidentcaregiver/166312138.png'); ?>" id="certificate" alt="Image">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('becomingamoreconfidentcaregiver/80608570.png'); ?>" alt="Facilitator" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('becomingamoreconfidentcaregiver/Agenda_becomingamoreconfidentcaregiver.pdf'); ?>" target="_blank" class="button">Agenda</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Welcome to the course, “Becoming a More Confident Caregiver.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other.</p>
		...
		<div id="lesson-1-slide-3" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>Nearly 15 million family caregivers care for someone with Alzheimer’s disease or other forms of dementia.</li>
					...
					<li>The number of male caregivers is steadily growing. Male caregivers are more likely to help with tasks related to the home of the older adult (such as home repairs or financial issues) while female caregivers perform more physical care tasks (such as bathing or dressing).</li>
					<li>A significant portion of family caregiver’s time focuses on errands (such as shopping, transportation, picking up medications), researching and making care arrangements, transportation to physician appointments, and managing financial matters.</li>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>“If only my mother listened to me and moved in with us years ago, she wouldn’t have fallen, broken her hip, and wound up in that terrible nursing home!”</li>
					<li>“I just can’t take on more responsibility for my dad’s care. I already work 50 to 60 hours a week and have family responsibilities. But if I don’t, who will?”</li>
		...
		<div id="lesson-1-slide-8" class="course-slide">
			<div class="content">
				...
				<p>Let’s first assess where you currently are related to your readiness and awareness for self-coaching, and then we will move into some self-coaching exercises that you may continue as often as you feel it would be helpful to you.</p>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>This activity invites you to explore and live several questions. Your responses should open up more self-awareness of what is important to you in your life. Please note that you may print or save any activities from this course for future reference.</p>
		...
		<div id="lesson-1-slide-11" class="course-slide">
			<div class="content">
				...
				<p>You are aware of the need for change and are prepared to accept that you cannot blame others or circumstances of a situation.</p>

				<p>In other words, you are willing to be open to choices and you are willing to make those choices. It would be most like stepping outside of your situation and viewing it as impartially as possible.</p>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				...
				<p>You accept that through self-coaching, you are going to persist until you identify a solution and set of actions that you will then commit to implementing. </p>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<p>We’ve all been in the situation where something just nags at us. Things always seem worse when we pay too much attention to them. If I feel anxious, overwhelmed, or depressed and focus on those feelings, I become it. By letting go, I turn away from it. I don’t feed those problems any longer.</p>

				<p>It is sort of like flipping to another television channel. You may not be able to stop a thought from “percolating” in your mind, but you can say “no!” to thoughts that result in anxiety or depression. We always have choices. In this case, we have the choice not be become a victim of negative thoughts or insecurities.</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<p>The focus of self-coaching is to identify your goal, commit to your actions, and then move on to do something else. Sometimes your best thinking goes on when you do move onto something else and then come back to your goal. </p>
		...
		<div id="lesson-1-slide-16" class="course-slide">
			<div class="content">
				...
				<p>View the video, self-coaching 101 by Brooke Castillo from The Life Coach School. This video is a new way for you to experience a self-coaching session in the comfort of your own home. This video shows an example of self-coaching in action.</p>
		...
		<div id="lesson-1-slide-17" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>This activity focuses on assessing your awareness of ten principles of success and your rating of how you presently live according to them. Complete a 10 item assessment and then review results based on your responses.</p>
		...
		<div id="lesson-1-slide-19" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol>
					<li>Begin with getting yourself a notebook or journal for your entries. Although there are inexpensive wire bound notebooks that work just fine, I like to get a little nicer journal with a page marker for my journaling. It makes it more special!</li>
				</ol>
		...
		<div id="lesson-1-slide-20" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol start="2">
					<li>Make daily entries about your accomplishments – no matter how big or small. They may be accomplishments in relation to either work or your personal life.</li>
				</ol>
		...
		<div id="lesson-1-slide-23" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol start="5">
					<li>Create a personal “bragging” statement. Be authentic and positive in your statement. Print out the statement and keep it visible so that you can refer to it often.</li>
				</ol>
		...
		<div id="lesson-1-slide-25" class="course-slide">
			<div class="content">
				...
				<p>How do we identify the goal? The goal answers the question, “What do you want that’s really important to you?”</p>
		...
		<div id="lesson-1-slide-26" class="course-slide">
			<div class="content">
				...
				<p>For this exercise, look back at your responses to the two activities in this module. In the Self-Awareness Survey, you explored what is important to you in your life. In the Principles of Success activity, you rated yourself against these principles. Based on these results, develop three statements of goals for yourself. </p>

				<p>Remember that goals should be stated in terms of nouns. Goals also answer the question, “What do you want that’s really important to you?”</p>
		...
		<div id="lesson-1-slide-27" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>You are not alone as a caregiver of an older adult! More than one in six working caregivers care for one or more older adults.</li>

					<li>A “role reversal” with aging parents is common, although it is not uncommon for that to be challenging to now be the “coach” for your aging parents. So remember to be a successful coach, use the skills of appreciating, listening, appreciating, and supporting.</li>

					<li> Focus on shifting from negative “self talk” to positive “self talk” to get to what’s important to you as a caregiver.</li>

					<li>Use the five steps involved in creating an effective self-coaching experience to help you move your thinking forward as an effective caregiver and focus on the goal.</li>

					<li> Try journaling to facilitate positive “self talk” and boost your self-confidence as an effective caregiver.</li>
				</ol>
