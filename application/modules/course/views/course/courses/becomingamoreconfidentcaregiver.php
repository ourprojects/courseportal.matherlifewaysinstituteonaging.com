...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('becomingamoreconfidentcaregiver/166312138.png'); ?>" id="certificate" alt="{t}Image{/t}">
	</div>
	<div class="box-sidebar one">
		...
		<p>
			<a href="#lesson-2-slide-1" data-fancybox-group="lesson-2" class="teal lesson-1 button">Contact Facilitator</a>
		</p>
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('becomingamoreconfidentcaregiver/Agenda_becomingamoreconfidentcaregiver.pdf'); ?>" target="_blank" class="button">{t}Agenda{/t}</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Welcome to the course, “Becoming a More Confident Caregiver.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other.{/t}</p>
		...
		<div id="lesson-1-slide-3" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>{t}Nearly 44 million family caregivers provided support or care to someone ages 50 years or older.{/t}</li>
					<li>{t}Nearly 15 million family caregivers care for someone with Alzheimer’s disease or other forms of dementia.{/t}</li>
					...
					<li>{t}The number of male caregivers is steadily growing. Male caregivers are more likely to help with tasks related to the home of the older adult (such as home repairs or financial issues) while female caregivers perform more physical care tasks (such as bathing or dressing).{/t}</li>
					<li>{t}A significant portion of family caregiver’s time focuses on errands (such as shopping, transportation, picking up medications), researching and making care arrangements, transportation to physician appointments, and managing financial matters.{/t}</li>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>{t}“If only my mother listened to me and moved in with us years ago, she wouldn’t have fallen, broken her hip, and wound up in that terrible nursing home!”{/t}</li>
					<li>{t}“I just can’t take on more responsibility for my dad’s care. I already work 50 to 60 hours a week and have family responsibilities. But if I don’t, who will?”{/t}</li>
		...
		<div id="lesson-1-slide-8" class="course-slide">
			<div class="content">
				...
				<p>{t}Let’s first assess where you currently are related to your readiness and awareness for self-coaching, and then we will move into some self-coaching exercises that you may continue as often as you feel it would be helpful to you.{/t}</p>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}This activity invites you to explore and live several questions. Your responses should open up more self-awareness of what is important to you in your life. Please note that you may print or save any activities from this course for future reference.{/t}</p>

				<p>
					<a href="<?php echo $this->createDownloadUrl('becomingamoreconfidentcaregiver/Activity_Self_Awareness_Survey.doc'); ?>" target="_blank" class="button">Download Activity</a>
				</p>
		...
		<div id="lesson-1-slide-11" class="course-slide">
			<div class="content">
				...
				<p>{t}You are aware of the need for change and are prepared to accept that you cannot blame others or circumstances of a situation.{/t}</p>

				<p>{t}In other words, you are willing to be open to choices and you are willing to make those choices. It would be most like stepping outside of your situation and viewing it as impartially as possible.{/t}</p>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				...
				<p>{t}You accept that through self-coaching, you are going to persist until you identify a solution and set of actions that you will then commit to implementing. {/t}</p>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<p>{t}We’ve all been in the situation where something just nags at us. Things always seem worse when we pay too much attention to them. If I feel anxious, overwhelmed, or depressed and focus on those feelings, I become it. By letting go, I turn away from it. I don’t feed those problems any longer.{/t}</p>

				<p>{t}It is sort of like flipping to another television channel. You may not be able to stop a thought from “percolating” in your mind, but you can say “no!” to thoughts that result in anxiety or depression. We always have choices. In this case, we have the choice not be become a victim of negative thoughts or insecurities.{/t}</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<p>{t}The focus of self-coaching is to identify your goal, commit to your actions, and then move on to do something else. Sometimes your best thinking goes on when you do move onto something else and then come back to your goal. {/t}</p>
		...
		<div id="lesson-1-slide-16" class="course-slide">
			<div class="content">
				...
				<p>{t}View the video, self-coaching 101 by Brooke Castillo from The Life Coach School. This video is a new way for you to experience a self-coaching session in the comfort of your own home. This video shows an example of self-coaching in action.{/t}</p>

				<iframe style="display: block; width: 640px; height: 360px; framebroder: 0; margin: 15px auto;" src="//www.youtube.com/embed/0_otisZVT8A?rel=0" allowfullscreen></iframe>
		...
		<div id="lesson-1-slide-17" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}This activity focuses on assessing your awareness of ten principles of success and your rating of how you presently live according to them. Complete a 10 item assessment and then review results based on your responses.{/t}</p>

				<p>
					<a href="<?php echo $this->createDownloadUrl('becomingamoreconfidentcaregiver/Activity_Principles_of_Success.xls'); ?>" target="_blank" class="button">Download Activity</a>
				</p>
		...
		<div id="lesson-1-slide-19" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol>
					<li>{t}Begin with getting yourself a notebook or journal for your entries. Although there are inexpensive wire bound notebooks that work just fine, I like to get a little nicer journal with a page marker for my journaling. It makes it more special!{/t}</li>
				</ol>
		...
		<div id="lesson-1-slide-20" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol start="2">
					<li>{t}Make daily entries about your accomplishments – no matter how big or small. They may be accomplishments in relation to either work or your personal life.{/t}</li>
				</ol>
		...
		<div id="lesson-1-slide-21" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>{t}What makes me unique?{/t}</li>
					<li>{t}In what areas of my life do I appear most satisfied or content?{/t}</li>
					<li>{t}In which areas do I appear to be struggling or unfulfilled?{/t}</li>
					<li>{t}What are my strengths? (look back at your “Principles of Success” ratings for ideas){/t}</li>
					<li>{t}How have these strengths helped me in the past?{/t}</li>
					<li>{t}How do these strengths now help me?{/t}</li>
				</ol>
		...
		<div id="lesson-1-slide-22" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>{t}What can you truly brag about?{/t}</li>
					<li>{t}What do your successes say about you?{/t}</li>
		...
		<div id="lesson-1-slide-23" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol start="5">
					<li>{t}Create a personal “bragging” statement. Be authentic and positive in your statement. Print out the statement and keep it visible so that you can refer to it often.{/t}</li>
				</ol>
		...
		<div id="lesson-1-slide-24" class="course-slide">
			<div class="content">
				...
				<hr />
				<ol start="6">
					<li>{t}Recite it out loud daily, saying, “This is me….This is what makes me special.”{/t}</li>
				</ol>
		...
		<div id="lesson-1-slide-25" class="course-slide">
			<div class="content">
				...
				<p>{t}How do we identify the goal? The goal answers the question, “What do you want that’s really important to you?”{/t}</p>
				...
				<table>
					...
					<tr>
						<td>
							<ul>
								<li>{t}Proactive{/t}</li>
								<li>{t}Finding what is possible{/t}</li>
								<li>{t}Developing{/t}</li>
								<li>{t}Identifying priorities{/t}</li>
								<li>{t}Dynamic{/t}</li>
								<li>{t}Working with the whole{/t}</li>
							</ul>
						</td>
						<td>
							<ul>
								<li>{t}Reactive{/t}</li>
								<li>{t}Finding what is wrong{/t}</li>
								<li>{t}Fixing{/t}</li>
								<li>{t}Addressing crises{/t}</li>
								<li>{t}Static{/t}</li>
		...
		<div id="lesson-1-slide-26" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('becomingamoreconfidentcaregiver/Exercise_Setting_your_Goals.docx'); ?>" target="_blank" class="button">Download Activity</a>
				</p>
		...
		<div id="lesson-1-slide-27" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>{t}You are not alone as a caregiver of an older adult! More than one in six working caregivers care for one or more older adults.{/t}</li>

					<li>{t}A “role reversal” with aging parents is common, although it is not uncommon for that to be challenging to now be the “coach” for your aging parents. So remember to be a successful coach, use the skills of appreciating, listening, appreciating, and supporting.{/t}</li>

					<li>{t} Focus on shifting from negative “self talk” to positive “self talk” to get to what’s important to you as a caregiver.{/t}</li>

					<li>{t}Use the five steps involved in creating an effective self-coaching experience to help you move your thinking forward as an effective caregiver and focus on the goal.{/t}</li>

					<li>{t} Try journaling to facilitate positive “self talk” and boost your self-confidence as an effective caregiver.{/t}</li>
				</ol>
