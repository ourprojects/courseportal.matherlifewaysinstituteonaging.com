...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('managinghealthinformationwithapersonalhealthrecord/166312138.png'); ?>" id="certificate" alt="{t}Image{/t}">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('managinghealthinformationwithapersonalhealthrecord/80608570.png'); ?>" alt="{t}Facilitator{/t}" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('managinghealthinformationwithapersonalhealthrecord/Agenda_managinghealthinformationwithapersonalhealthrecord.pdf'); ?>" target="_blank" class="button">{t}Agenda{/t}</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Welcome to the course, “Managing Health Information with a Personal Health Record.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other. {/t}</p>
		...
		<div id="lesson-1-slide-3" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Personal Health Records (PHR) have become easy-to-use tools to help manage health information in a single place. Having a PHR can help provide more complete information to health care providers or other family members.{/t}</p>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Click <a href="http://vimeo.com/5001493" target="_blank"> here</a> to view a brief video on some personal experiences with PHRs.{/t}
				</p>
		...
		<div id="lesson-1-slide-6" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}As a caregiver to older parents, you may be a point where you may need to help make health care decisions for your loved ones. Even though they are your parents, you don’t automatically have a right to see or use their medical information even if you need it to communicate to a health professional, insurance company, or you need the information to help them complete a PHR. {/t}</p>

				<p>{t}By law, only the patient has the right to view their own health information. The patient needs to submit a written authorization to their health professional, hospital, and/or insurer to obtain access to their own health information. {/t}</p>

				<p>{t}As a family caregiver, caregiver authorization needs to be complete and comprehensive before any information would be released to you as the caregiver. {/t}</p>

				<p>{t}What you need to go to obtain authorization to access protected health information for an older parent:{/t}</p>
				...
				<p>{t}In the ideal scenario, you and your parents have discussed this before there is a situation where one or more parents becomes incapacitated and is unable to provide authorization.{/t}</p>
		...
		<div id="lesson-1-slide-10" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Visit the <a href="https://familyhistory.hhs.gov/fhh-web/home.action" target="_blank">My Family Health Portrait</a> website.{/t}
				</p>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<p>{t}The final PHR tool we will review is one of the latest Internet-based programs designed for Smartphones. ProfileMD is a freeware PHR that allows immediate access to medical health history and information via your smart phone. {/t}</p>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<p>{t}In some situations where you as a family caregiver may feel you just don’t have enough time at this point to put together a PHR for your older parents. You may also find that your parents are just not ready to share a more comprehensive profile of their entire health history at this point in their lives.{/t}</p>

				<p>{t}You may then suggest completing an emergency contact information list as a first step. You may suggest to them that they keep a copy in their home in a location convenient to both of them and also provide you a copy for your reference. {/t}</p>

				<p>{t}You may download an example of an Emergency Contact Information Sheet below.{/t}</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>{t}Personal Health Records (PHR) are easy-to-use tools to help manage health information in a single place. {/t}</li>
					<li>{t}A PHR for your older parents has several benefits including:{/t}</li>
					...
					<li>{t}Releasing of one’s personal health information is protected by law, and so health care providers cannot share protected health information of someone else (even close relatives) without their written permission.{/t}</li>
					<li>{t}PHRs may be kept as hard copy or electronically. In considering a format, look at accessibility, convenience, and ease of updating.{/t}</li>
					<li>{t}There are several software versions of PHRs as well as Internet versions. Security is a very important consideration when reviewing Internet versions where information may be stored outside of your computer.{/t}</li>
				</ol>
