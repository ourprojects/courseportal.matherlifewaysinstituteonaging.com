...
<div id="lesson-1-slide-4" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>{t}Regardless if your parents remain in their own home, move to a senior living community, or move in with
            you, home safety is an important topic for discussion. The overall goal of assessing home safety needs and
            making modifications as necessary is to give older adults a sense of independence in their
            environment.{/t}</p>

        <p>{t}Accidents in the home are a major source of injury for older adults and can cause disability and sometimes
            ...
            lifting, and bending) are more difficult. Reaction time or judgment may slow.{/t}</p>

        <p>{t}As a result, an older person cannot respond as quickly as a younger person in all situations. These normal
            aging changes may make an older person more prone to accidents. Simple precautions and adjustments may
            ensure a safe home. {/t}</p>
...
<div id="lesson-1-slide-5" class="course-slide">
    <div class="content">
        ...
        <p>{t}You may be a situation where your older parents are living alone and you live quite a distance away, maybe
        ...
        <p>{t}You want to try to be as subtle as possible. Don’t look like you are checking up on them. Use what you
            notice as openings for conversations. Do it privately (not a great opener for the family Thanksgiving table
            conversation!).{/t}</p>

        <p>{t}“Mom, I noticed you were having a bit of trouble reading that label. What if we change the light bulbs in
            here?”{/t}</p>

        <p>{t}Offer to do little things around the house. Don’t always wait for a “yes” or “no” response, as they may be
            too proud to ask for help. Just let them know that you’d like to use some of the time to be helpful and
            supportive. If they are resistant, invite them to do a chore together.{/t}</p>
...
<div id="lesson-1-slide-6" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>{t}During your next visit, use your powers of observation to note changes in the following areas. You may
            want to make mental notes and then jot down some of your observations privately. We have included some
            general questions to get you started. In this activity, you will add some of your own specific questions
            that you may want to assess during your visit.{/t}</p>
        ...
        <p>{t}The U.S. Consumer Product Safety Commission estimates that over 1.5 million adults ages 65 and older are
            ...
            recommendations to consider. Following the general recommendations are links to downloadable
            resources.{/t}</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <ul>
                        <li>
                            {t}Overloaded extension cords may cause fires. A standard 18 gauge extension cord can carry
                            1250 watts.{/t}
                        </li>
                        <li>
...
<div id="lesson-1-slide-7" class="course-slide">
    <div class="content">
        ...
        <p>{t}<a href="http://www.homemods.org/resources/doable-home/index.shtml" target="_blank">The Do Able Renewable
                Home</a> - This booklet is designed to help overcome problems experienced in the home as one grows
            older. Content was developed in collaboration with gerontologists to make the home more livable.{/t}</p>

        <p>{t}Lighting the Way: A Key to Independence - This resource provides a number of recommendations to help older
            adults see better. From home lighting to doing small tasks, many suggestions can easily be implemented with
            simple modifications.{/t}</p>
        ...
        <p>{t}Home Safety Checklist - This is a simple checklist that you can use when visiting your older parents to
            assess safety issues in their home environment.{/t}</p>
...
<div id="lesson-1-slide-8" class="course-slide">
    <div class="content">
        ...
        <hr/>
        <p>{t}More than 3.6 million older adults live with their children (up 67% from 2000) according to U.S. Census
            ...
            proceeds to living in a senior living residence may be delaying their decision or realizing they will not
            get enough money from the house sale to make the move.{/t}</p>

        <p>{t}The children may also be facing financial difficulties of their own. “Merging” finances and obligations
            may benefit everyone in these types of arrangements. One son commented that he “gets to see a different side
            of his mother and father. They are not just parents, they’re people, and once you recognize that, you work
            with it and it’s fun.” {/t}</p>

        <p>{t}Interestingly, an entire new housing opportunity is developing with this “return” to multiple generations
        ...
        <p>{t}“Giving each other space” is a valuable recommendation for those considering these living arrangements,
            particularly if the older parents are independent.{/t}</p>
...
<div id="lesson-1-slide-9" class="course-slide">
    <div class="content">
        ...
        <ul>
            <li>
                {t}Hold regular family conferences to discuss issues or problems that may come up. Often, it is much
                easier to discuss awkward subjects when everyone is together and in the mood to talk.{/t}
            </li>
            <li>
                {t}If your parents have health problems, set up an emergency contact system and make sure everyone knows
                what it is. This could be a buzzer or alarm in the bedroom or shower. Preprogram their telephones with
                your cell phone or pager number.{/t}
            </li>
            <li>
                {t}Consider safety issues for children and seniors living in the same house. Make sure that medications
                with non-childproof bottle tops are not easily within reach, and make sure toys are left on the floor or
                stairs.{/t}
            </li>
            <li>
                {t}Caregiving can take a lot of time and energy, so make sure you still put aside some quality time for
                yourself, and for your spouse and children. If you begin to feel overwhelmed by your family
                responsibilities, arrange for outside help or respite, or find a caregivers support group in your
                area.{/t}
            </li>
        </ul>
...
<div id="lesson-1-slide-10" class="course-slide">
    <div class="content">
        ...
        <p>{t}This exercise provides an opportunity for you and your family to consider key questions to explore
            potential for having older parents move in with you. You may not be thinking about this at the present time,
            but you may have other family members or friends considering various options and so this may be helpful to
            them as well.{/t}</p>

        <p>{t}These questions can serve as a guide for discussions with your family. As you read through each section,
            we include some CARE Coaching questions to bring out your best thinking about what would be important to
            you.{/t}</p>
...
<div id="lesson-1-slide-11" class="course-slide">
    <div class="content">
        ...
        <p>{t}According to driving statistics, older adults have more fatal car accidents than any other age group.
            Additionally, older adults are more at risk for death after being involved in a car accident because of
            their age and health condition.{/t}</p>

        <p>{t}By 2030, it is estimated that 25% of the driving population will be age 65 years and older. Currently,
            about 14% of all people killed in traffic accidents are older adults, and that percent is expected to
            increase to 25%.{/t}</p>

        <p>{t}In addition to being a danger to themselves, many of these accidents result in injury or death of
            others.{/t}</p>

        <p>{t}How does increased age impact driving ability? Several physical and cognitive changes that are part of
            normal aging or that are related to chronic illnesses may affect driving ability in older adults. Not all
            older adults experience these changes, but the following are some of the reasons older adults are more prone
            to car accidents:{/t}</p>
...
<div id="lesson-1-slide-12" class="course-slide">
    <div class="content">
        ...
        <p>{t}Why is driving so important to older adults? Driving for most people – and particularly for older adults –
            means independence. I can go where I want, when I want, without having to rely on others. Some older adults
            may not want to inconvenience their family or friends.{/t}</p>

        <p>{t}How can I help someone else limit or stop driving? In most cases, drivers monitor themselves and gradually
            ...
            drivers unable to evaluate their driving properly. {/t}</p>

        <p>{t}Let’s look at some of the warning signs and steps you may take to address this issue with older family
            members or friends.{/t}</p>
...
<div id="lesson-1-slide-13" class="course-slide">
    <div class="content">
        ...
        <ol>
            ...
            <li>
                {t}Frequent traffic tickets or "warnings" by traffic or law enforcement officers in the last year or
                two{/t}
            </li>
        </ol>

        <p>{t}If you notice one or more of these warning signs with your older parents, you may want to have their
            driving assessed by a professional or have them attend a driver refresher class.{/t}</p>

        <p>{t}You may also want to consult with their physician if you notice unusual concentration or memory problems,
            or other physical symptoms that may be affecting ability to drive.{/t}</p>
...
<div id="lesson-1-slide-14" class="course-slide">
    <div class="content">
        ...
        <p>{t}Remember what it was like when you got your first driver’s license? That sense of pride and freedom stays
            ...
            recuperating from surgery.{/t}</p>

        <p>
            {t}We are a mobile culture. In many areas, public transportation is scarce or unsafe for older adults. We
            want our older parents to be safe, but the last thing we want is for them to feel isolated, trapped, and
            alone in their own home.{/t}
        </p>

        <p>
            {t}Bringing up the discussion on driving is very challenging. The best way to think about this is to keep
            ...
            steps, you can better draw out the issues and support your parents in their transition.{/t}
        </p>
...
<div id="lesson-1-slide-15" class="course-slide">
    <div class="content">
        ...
        <p>{t}Remember that most children wait too long for the driving discussion – either until their parents driving
            has deteriorated or until a major accident occurs. Consider yourself more of a coach in the discussion.
            Begin by letting them know how much you value their independence, judgment, and their concern for safety for
            ...
            that would be like for them and how they would like that process to go.{/t}</p>
        ...
        <ul>
            ...
            <li>
                {t}As we continue this discussion, can we include a plan so that you can continue to be as independent
                as possible?{/t}
            </li>
        </ul>
        ...
        <p>{t}Driver Self-Assessment<br/> Here is a self-assessment for older adults from ElderSafety.org to help them
            identify what should be noticed regarding aging changes that may impact their ability to drive safely.{/t}
        </p>
        ...
        <p>{t}<a href="http://www.usatoday.com/life/graphics/elderly_drivers_popup/flash.htm" target="_blank>">How Age
                Affects the Ability to Drive</a><br/>This interactive guide from USA Today provides visual descriptions
            of changes that occur during normal aging that may impact one’s ability in driving.{/t}</p>
...
<div id="lesson-1-slide-16" class="course-slide">
    <div class="content">
        ...
        <p>{t}Physical and cognitive changes with aging variy considerably from very sudden and dramatic to very subtle
            and barely noticeable. Preparing and being willing to compensate for these changes will promote their safety
            and the safety of others. In many communities, finding a group of older adults who are tackling driving
            issues together may be a positive way to address some of those initial changes through sharing. Watch the
            following video to see how one church group addressed their issues through an AARP Driving Safety
            course.{/t}</p>

        <h4>
            {t}Video – Senior Driving Safety{/t}
        </h4>

        <iframe style="width: 640px; height: 480px; display: block; margin: 15px auto; frameborder: 0;"
                src="//www.youtube.com/embed/YLW-GEJBMik?rel=0" allowfullscreen></iframe>
        ...
        <ul>
            <li>
                {t}Begin with reviewing what you discussed last time and goals that you and your parents came up with on
                how to promote their independence while keeping them safe driving.{/t}
            </li>
            <li>
                {t}Taking a look at what we talked about last time, what are you wanting?{/t}
            </li>
            <li>
                {t}One of the things I found out is that there are some driving refresher courses that you may take that
                will often give you a nice discount on your care insurance. What would you think about that? Could we
                check one out together?{/t}
            </li>
        </ul>
...
<div id="lesson-1-slide-17" class="course-slide">
    <div class="content">
        ...
        <p>
            {t}It is probably not uncommon that you see some older drivers on the road who may be going much slower than
        ...
        <p>
            {t}A Driving Rehabilitation Specialist (DRS) can provide a more in depth analysis of your parent’s driving
            ...
            your area to help older adults learn alternate driving techniques to make driving safer.{/t}
        </p>

        <p>
            {t}Watch the following video of a DRS working with an older adult client.{/t}
        </p>
        ...
        <ul>
            <li>
                {t}I’ve noticed you seem more tense behind the wheel. What situations really get to you when you’re
                driving?{/t}
            </li>
            <li>
                {t} I’m concerned that something medical or your medications may be affecting your driving. Can we make
                an appointment to see your doctor to help correct things that may be interfering with your driving?{/t}
            </li>
            <li>
                {t}What would you think about working out a plan with a professional to help make sure that you can keep
                driving safely?{/t}
            </li>
        </ul>
        ...
        <p>{t}Warning Signs for Older Drivers<br/>
...
<div id="lesson-1-slide-18" class="course-slide">
    <div class="content">
        ...
        <p>
            {t}Retiring from driving is one of the most difficult moments in your older parent’s life. In the ideal
            world, there has been time to prepare for this transition and your parents are part (if not taking the lead)
            on this decision. No matter how much preparation went into planning, giving up driving is a major loss
            needing time to grieve and adjust. There are a number of families with older parents who are no longer
            driving, but just keeping the car in the garage as a “symbol” of independence for that older parent is not
            that uncommon.{/t}
        </p>

        <p>
            {t}Rather than saying, “time to take away the keys,” the goal should be that your parents are in the
            position to say, “It’s time to retire from driving.”{/t}
        </p>
        ...
        <ul>
            <li>
                {t}It seems that driving is becoming more of a struggle for you. What do you think?{/t}
            </li>
            <li>
                {t}We’ve tried several things along the way (review what those were). It seems like those things are not
                keeping you as safe anymore. Considering this, what stands out for you?{/t}
            </li>
            <li>
                {t}Your safety and freedom are what’s most important to both of us. If we can map out alternate plans to
        ...
        <p>{t}Finding a Certified Driving Rehabilitation Specialist<br/>
            Click on <a href="http://www.driver-ed.org/i4a/pages/index.cfm?pageid=1" target="_blank">this link</a> to
            search for a certified Driving Rehabilitation Specialist in your area.{/t}</p>
...
<div id="lesson-1-slide-19" class="course-slide">
    <div class="content">
        ...
        <p>
            {t}Post-driving, it is very important to help your older parents remain independent so they do not become
            isolated and depressed, trapped in their own home. They may need some help from you to create a plan to
            promote their freedom. The plan should respond to the following questions:{/t}
        </p>

        <ol>
            <li>
                {t}Where do your parents need to go on a weekly basis? (like the grocery store, hairdresser, church
                services, etc.){/t}
            </li>
            <li>
                {t}Where do your parents need to go other than weekly? (like the doctor’s office, banking, other
                appointments){/t}
            </li>
            <li>
                {t}Where do your parents enjoy going for socializing? for entertainment?{/t}
            </li>
            <li>
                {t}Who are their resources for alternatives to transportation? (neighbors/friends attending the same
                event; transportation for older adults offered through their community or church){/t}
            </li>
            <li>
                {t}Which of these alternatives are realistic and reliable?{/t}
            </li>
            <li>
                {t}What public transportation options are available and acceptable?{/t}
            </li>
            <li>
                {t}Where are the gaps?{/t}
            </li>
        </ol>

        <h5>{t}Resources{/t}</h5>

        <p><a href="https://www.aaafoundation.org/sites/default/files/stp.pdf" target="_blank">{t}Supplemental
                Transportation Programs (STPs)</a><br/>
            The purpose of STPs is to provide alternative transportation to older adults who have limitations to their
            driving or are no longer driving. They are designed to be more flexible than other forms of transportation.
            Some include “door-to-door” service to assure the older adult arrives safely to their destination and back.
            All drivers are screened and trained.{/t}</p>

        <p><a href="http://itnamerica.org" target="_blank">{t}Independent Transportation Network (ITN)</a><br/>
            A newer program that is in limited numbers of areas is the ITN which combines creative transportation
            alternatives for older adults, but coordinates volunteers, community services and agency connections to make
            it work. Find an affiliate program on their website. {/t}</p>
...
<div id="lesson-1-slide-20" class="course-slide">
    <div class="content">
        ...
        <p>
            {t}Exercise for older adults is an important contributor to safety and independence. Many studies have
            ...
            about how physical activity has enhanced their lives and experts giving their advice.{/t}
        </p>

        <h4>
            {t}Video – Older Adults and Exercise{/t}
        </h4>
