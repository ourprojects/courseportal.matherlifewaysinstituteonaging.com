...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('promotinghomesafetyforolderparents/166312138.png'); ?>" id="certificate" alt="Image">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('promotinghomesafetyforolderparents/80608570.png'); ?>" alt="Facilitator" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('promotinghomesafetyforolderparents/Agenda_promotinghomesafetyforolderparents.pdf'); ?>" target="_blank" class="button">Agenda</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Welcome to the course, “Promoting Safety for Older Parents.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other.</p>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<p>“Mom, I noticed you were having a bit of trouble reading that label. What if we change the light bulbs in here?”</p>

				<p>Offer to do little things around the house. Don’t always wait for a “yes” or “no” response, as they may be too proud to ask for help. Just let them know that you’d like to use some of the time to be helpful and supportive. If they are resistant, invite them to do a chore together.</p>
				...
				<table>
					...
					<tr>
						...
						<td>
							<ul>
								<li>
									<p>Arrange furniture so that outlets are available for lamps and appliances without use of numerous extension cords.</p>
								</li>
					...
					<tr>
						<td>Cords covered by carpets and rugs</td>
						<td>
							<ul>
					...
					<tr>
						<td>Overloaded extension cords</td>
						<td>
							<ul>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="http://www.homemods.org/resources/doable-home/index.shtml" target="_blank">The Do Able Renewable Home</a> - This booklet is designed to help overcome problems experienced in the home as one grows older. Content was developed in collaboration with gerontologists to make the home more livable.
				</p>

				<p>Lighting the Way: A Key to Independence - This resource provides a number of recommendations to help older adults see better. From home lighting to doing small tasks, many suggestions can easily be implemented with simple modifications.</p>
				...
				<p>Home Safety Checklist - This is a simple checklist that you can use when visiting your older parents to assess safety issues in their home environment.</p>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<p>Why is driving so important to older adults? Driving for most people – and particularly for older adults – means independence. I can go where I want, when I want, without having to rely on others. Some older adults may not want to inconvenience their family or friends.</p>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				...
				<p>If you notice one or more of these warning signs with your older parents, you may want to have their driving assessed by a professional or have them attend a driver refresher class.</p>

				<p>You may also want to consult with their physician if you notice unusual concentration or memory problems, or other physical symptoms that may be affecting ability to drive.</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<p>
					Driver Self-Assessment<br /> Here is a self-assessment for older adults from ElderSafety.org to help them identify what should be noticed regarding aging changes that may impact their ability to drive safely.
				</p>
				...
				<p>
					<a href="http://www.usatoday.com/life/graphics/elderly_drivers_popup/flash.htm" target="_blank>">How Age Affects the Ability to Drive</a><br />This interactive guide from USA Today provides visual descriptions of changes that occur during normal aging that may impact one’s ability in driving.
				</p>
		...
		<div id="lesson-1-slide-16" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="http://apps.dmv.ca.gov/about/senior/senior_self_ess.html" target="_blank">Drivers Self-Assessment</a><br /> This self-assessment at seniordrivers.org provides a quick self-assessment for older drivers to review their driving knowledge and skills.
				</p>
        ...
        //www.youtube.com/embed/6GpNJ-zh1rc?rel=0" allowfullscreen></iframe>
				...
				<ul>
					<li>I’ve noticed you seem more tense behind the wheel. What situations really get to you when you’re driving?</li>
					<li> I’m concerned that something medical or your medications may be affecting your driving. Can we make an appointment to see your doctor to help correct things that may be interfering with your driving?</li>
				...
				<p>
					Warning Signs for Older Drivers<br /> This checklist is for families to track potential warning signs for older drivers so that patterns may be identified early on.
				</p>
		...
		<div id="lesson-1-slide-18" class="course-slide">
			<div class="content">
				...
				<p>
					Finding a Certified Driving Rehabilitation Specialist<br /> Click on <a href="http://www.driver-ed.org/i4a/pages/index.cfm?pageid=1" target="_blank">this link</a> to search for a certified Driving Rehabilitation Specialist in your area.
				</p>
		...
		<div id="lesson-1-slide-23" class="course-slide">
			<div class="content">
				...
				<ol>
					...
					<li>If your knee or elbow or ankle is swollen, painful and warm to the touch DON'T exercise, see a doctor.</li>
		...
		<div id="lesson-1-slide-24" class="course-slide">
			<div class="content">
				...
				<p><Exercise & Physical Activity: Your Everyday Guide from the National Institute on Aging</p>
				...
				<ol>
					<li>
						<a href="http://www.youtube.com/watch?v=ukJnjYM9LeA" target="_blank">Video – Chair Stand Strengthening</a>
					</li>
					<li>
						<a href="http://www.youtube.com/watch?v=ueHKUenfLtY" target="_blank">Video – Seated Chair Leg Stretch</a>
					</li>
					<li>
		...
		<div id="lesson-1-slide-25" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>Accidents in the home are a major source of injury for older adults and can cause disability and sometimes death. For older adults, the vast majority of falls occurs going between the bedroom and bathroom.</li>

					<li>During your next visit with your older parents, use your powers of observation to note changes around their home or in their appearance. This should not be an inspection for purposes of judgment or criticism. Rather, think of this as a part wellness check, part well-being check, and part safety check.</li>

					<li>According to driving statistics, older adults have more fatal car accidents than any other age group. Additionally, older adults are more at risk for death after being involved in a car accident because of their age and health condition. </li>

					<li>Bringing up the discussion on driving is very challenging. The best way to think about this is to keep the perspective that there is a continuum of possibilities on the “continue driving” to “quit driving” scale. By using CARE Coaching methods and breaking the driving conversation with your older parents into steps, you can better draw out the issues and support your parents in their transition.</li>

					<li>Exercise for older adults is an important contributor to safety and independence. Many studies have demonstrated the positive benefits of exercise for older adults regardless of age. As we get older exercise is incredibly important to our overall health.</li>
				</ol>
