	...
	<div class="box-sidebar one">
		...
		<table style="margin: 0px; padding: 0px;">
			<tr>
				...
				<td>
					<img style="width: 32px; height: 32px;" src="<?php echo $this->getImagesUrl('empower/Brazil-Flag-64.png'); ?>" alt="{t}Country Flag{/t}">
				</td>
				<td>
					<img style="width: 32px; height: 32px;" src="<?php echo $this->getImagesUrl('empower/United-States-Flag-64.png'); ?>" alt="{t}Country Flag{/t}">
				</td>
				<td>
					<img style="width: 32px; height: 32px;" src="<?php echo $this->getImagesUrl('empower/Mexico-Flag-64.png'); ?>" alt="{t}Country Flag{/t}">
				</td>
			</tr>
		</table>
...
<div class="column-wide">
	...
	<table>
		<tr>
			<td>
				<a href="#lesson-6-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('empower/United-States-Flag-64.png'); ?>" alt="{t}USA{/t}" /> </a>
			</td>
			<td>
				<a href="#lesson-7-slide-1" data-fancybox-group="lesson-7" class="teal lesson-7"><img src="<?php echo $this->getImagesUrl('empower/China-Flag-64.png'); ?>" alt="{t}China{/t}" /> </a>
			</td>

			<td>
				<a href="#lesson-8-slide-1" data-fancybox-group="lesson-8" class="teal lesson-8"><img src="<?php echo $this->getImagesUrl('empower/Brazil-Flag-64.png'); ?>" alt="{t}Brazil{/t}" /> </a>
			</td>

			<td>
				<a href="#lesson-9-slide-1" data-fancybox-group="lesson-9" class="teal lesson-9"><img src="<?php echo $this->getImagesUrl('empower/United-Kingdom-flag-64.png'); ?>" alt="{t}England{/t}" /> </a>
			</td>
			<td>
				<a href="#lesson-10-slide-1" data-fancybox-group="lesson-10" class="teal lesson-10"><img src="<?php echo $this->getImagesUrl('empower/Benelux-flag-64.png'); ?>" alt="{t}Benelux{/t}" /> </a>
			</td>
		</tr>
	</table>
