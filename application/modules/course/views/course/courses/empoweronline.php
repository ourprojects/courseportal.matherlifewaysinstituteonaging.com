	...
	<div class="box-white" id="resources">
		...
		<table>
			<tr>
				...
				<td>
					<a href="#lesson-7-slide-1" data-fancybox-group="lesson-7" class="teal lesson-7"><img src="<?php echo $this->getImagesUrl('flags/China-Flag-64.png'); ?>" alt="{t}China{/t}" /> </a>
				</td>
				<td>
					<a href="#lesson-8-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/Hong-Kong-Flag-64.png'); ?>" alt="{t}Hong Kong{/t}" /> </a>
				</td>
			</tr>
			<tr>
				<td>
					<a href="#lesson-9-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/Brazil-Flag-64.png'); ?>" alt="{t}Brazil{/t}" /> </a>
				</td>
				<td>
					<a href="#lesson-10-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/Mexico-Flag-64.png'); ?>" alt="{t}Mexico{/t}" /> </a>
				</td>
				<td>
					<a href="#lesson-11-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/Taiwan-Flag-64.png'); ?>" alt="{t}Taiwan{/t}" /> </a>
				</td>
			</tr>
			<tr>
				<td>
					<a href="#lesson-12-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/Argentina-Flag-64.png'); ?>" alt="{t}Argentina{/t}" /> </a>
				</td>
				<td>
					<a href="#lesson-13-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/United-Kingdom-flag-64.png'); ?>" alt="{t}England{/t}" /> </a>
				</td>
				<td>
					<a href="#lesson-14-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/Luxembourg-Flag-64.png'); ?>" alt="{t}Luxembourg{/t}" /> </a>
				</td>
			</tr>
		</table>
	</div>
		...
		<div id="lesson-1-slide-3" class="course-slide">
			<div class="content">
				...
				<div id="question1" class="question">
					<p>
						<b>{t}Caregivers providing on-going care, typically are under a lot stress, which may lead to mental and/or physical health problems.{/t}</b>
						<select>
      ...
      -->
			...
			<div class="content">
				...
				<ul>
					<li style="margin-bottom: 10px;">
						{t}<b>Take responsibility</b> - We realize we are responsible for our personal well-being and for getting our needs met. This includes maintaining activities and relationships that are meaningful to us.{/t}
					</li>
					<li style="margin-bottom: 10px;">
						{t}<b>Communicate effectively with others</b> - These include family members, friends, health care professionals, and the care receiver. Do not expect others to know what you need. Recognize it is your responsibility to tell others about your needs and concerns. Communicate in ways that are positive and avoid being demanding, manipulative, or guilt provoking when you make requests.{/t}
					</li>
					<li style="margin-bottom: 10px;">
						{t}<b>Set goals and work toward them</b> - Be realistic in the goals that you set and take steps toward reaching those goals. Seek solutions to the problems that you experience. Changes do not need to be major to make a significant difference. In summary, self-care means that you seek ways to take better care of yourself. As a caregiver, you do not just survive. You thrive!{/t}
					</li>
				</ul>
			...
			<div class="content">
				...
				<table>
					...
					<tr style="text-align: left;">
						...
						<td style="text-align: left;">Do you ever say to yourself "I should be able to... ," "I can never... ," or similar statements?</td>
					</tr>
					<tr style="text-align: left;">
						<td>
					...
					<tr style="text-align: left;">
						...
						<td style="text-align: left;">Do you ever get frustrated because of something you can't change or someone who won't change?</td>
					</tr>
					<tr style="text-align: left;">
						<td>
					...
					<tr>
						...
						<td style="text-align: left;">Do you feel that your family or others just don't understand what you are going through as a caregiver?</td>
				
				</table>
				<p style="text-align: center;">
					{t}A &quot;<em>Yes</em>&quot; answer to any of these questions indicates an area of self-care you might want to work on.{/t}
				</p>
				<h5>{t}Trying To Do It All{/t}</h5>
				<p>
					{t}One problem that caregivers frequently experience is trying to do it all and doing it all alone. <strong>Is it possible to do it all?</strong> It really depends on you. What is critical is how you define what it means to do it all and, whether or not your definition includes taking care of yourself.{/t}
				</p>
				<p>
					{t}To Maxine, the answer to the question &quot;<em>is it possible to do it all</em>:&quot; was no. She says, &quot;<em>Mother's needs are endless and no matter what I do, I can never make her happy.&quot;</em> Yet, at the same time, Maxine was trying to do it all. Her mother's care dominated Maxine's life.{/t}
				</p>
				<p>
					{t}Another caregiver, Maria, answered <em>yes</em> to the question, <em>is it possible to do it all</em>? She explained that "<em>all that needed to be done for my mother was done.</em>"{/t}
				</p>
				<p>
					{t}A major difference between Maxine and Maria was the rules by which they operated. Maxine operated by the rule, <em>I must do everything for my mother</em>. The rule had become &quot;<em>I must help Mama at all costs</em>.&quot; As a result, her relationships with other family members suffered and Maxine found herself becoming increasingly resentful. Maxine's feelings of wanting to do everything is legitimate, but the actions associated with her feelings usually are impossible to carry out.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-1-slide-8" class="course-slide">
			<div class="content">
				...
				<p>
					<i>{t}To some degree I recognized that caregiving was like a job and my goal was to find the best way to get the job done. A friend also told me that doing any job well-including the job of caregiving requires four things:{/t}</i>
				</p>
				<ol>
					<li>
				...
				<p>
					{t}As a caregiver, you are more likely to <i>be there</i> for your family member who needs your care and to be a more loving and patient caregiver when you meet some of your own needs. It is important to <i>fill your own cup</i> and not allow it to <i>run dry</i>.{/t}
				</p>
				<p>
					{t}It is not being selfish to focus on your own needs when you are a caregiver for a family member. It is important to remember that you must care for yourself before you can care for another.<i></i>{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-1-slide-11" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Action plans are one of your most important self-care tools. It is to be something you want to do. The intent of making an action plan is to help you to feel better and to take better care of yourself. Remember, an action plan is a <i>want to do</i>. Here are the five steps for making an action plan:{/t}
				</p>
				<ul>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<ol>
					...
					<li>
						<b>{t}How much will you do?</b> - Examples: <i>Will you read one chapter or will you read for a half hour? Will you walk two blocks or for 20 minutes?</i>{/t}
					</li>
					<li>
						<b>{t}When will you do this?</b> Examples: <i>Will you read the first thing in the morning when you awaken, before you go to bed, when the care receiver is sleeping, o ...? If your plan is to walk, when during the day will you do it?</i>{/t}
					</li>
					<li>
						<b>{t}How often will you do this activity?</b> Example: <i>Three times a week on Monday, Wednesday, and Friday.</i>{/t}
					</li>
				</ol>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Most of the time if you follow these steps, you will find a solution that solves the problem. It is important to avoid making the mistake of jumping from step start to finish and thinking <i>nothing can be done.</i>{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<p>
					<i>{t}When my husband was well, he would take me out Friday nights to a movie or a play at least twice a month. Because of his medical condition, he is no longer able to do so. Now a friend and I go to a movie or a play at least once a month. I consider this is a treat that my husband is still giving to me.{/t}</i>
				</p>
	...
	<div id="lesson-2">
		...
		<div id="lesson-2-slide-2" class="course-slide">
			<div class="content">
				...
				<p>
					{t}There has been so much written about stress it has become a household word. Studies show that a certain amount of stress is helpful. It can challenge us to change and motivate us to do things we might not do otherwise. However, when the amount of stress overwhelms our ability to cope with it, we feel <i>'distress'</i> or <i>'burnout.'</i>{/t}
				</p>
				<p>
					{t}Distress is <i>'suffering of mind or body; severe physical or mental strain.'</i> As a caregiver, you no doubt have increased stress in your life, whether you are caring for a mother with early Parkinson's disease, who is still able to care for her personal needs, or a spouse who does not recognize you because of advanced Alzheimer's disease.{/t}
				</p>
				<p class="forum">{t}Please think about the last time you were under distress. Post your response to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('empower/forum_icon.png'); ?>" alt="{t}Forum Icon{/t}" />
				<p>
					{t}Each caregiving situation is unique. What is stressful for you may not be stressful for someone else. In his book <a href="http://www.amazon.com/The-Survivor-Personality-Stronger-Difficulties/dp/0399522301" target="_blank">The Survivor Personality</a>, AI Siebert says, <i>"there is no stress until you feel a strain."</i>{/t}
				</p>
		...
		<div id="lesson-2-slide-5" class="course-slide">
			<div class="content">
				...
				<img src="<?php echo $this->getImagesUrl('empower/forum_icon.png'); ?>" alt="{t}Forum Icon{/t}" />
				<p>
					{t}According to the <a href="http://www.cdc.gov/Features/HandlingStress/" target="_blank">CDC</a>, common reactions to a stressful event include:{/t}
				</p>
				<ul>
		...
		<div id="lesson-2-slide-6" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Whatever causes stress in your life, too much of it can lower your resistance to disease and lead to <i>"burnout."</i> Current research shows that there is a close connection between stress and health. Unrelieved stress is one of many factors that cause illness.{/t}
				</p>
		...
		<div id="lesson-2-slide-8" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Consider your <i>"yes"</i> answers carefully. The sources of stress you have identified are indicators for change. Use the awareness you have gained in the first two steps to make helpful changes.{/t}
				</p>
		...
		<div id="lesson-2-slide-12" class="course-slide">
			<div class="content">
				...
				<p>
					{t}When Rosa and Dean decided to look for <i>"what remained"</i> in their situation, they hoped that they still had quality in their life together. They looked at what they still had, rather than focusing on what had been lost, and they made changes that were still possible.{/t}
				</p>
				<p>
					{t}They found an unexpected <i>'gift'</i> as they made changes and adapted to the illness. Rosa said, <i>'I never would have asked for the stroke to happen, but it was because of it that Dean and I learned what love was all about. I am a different person than I was. I am more understanding, patient, caring, and sensitive to the pain of others.'</i> {/t}
				</p>
				<p>
					{t}Many caregivers, as they learn more about themselves, experience personal growth. That is the <i>'gift'</i> that can often be found in difficult times.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-2-slide-16" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>
					{t}Karen felt angry and discouraged when her mother did not eat the tasty, nutritious meals she prepared for her. She didn't accept the fact that her mother's lack of appetite was caused by the illness. Karen constantly told herself, <i>"No matter what I cook, it is never good enough for mother."</i>{/t}
				</p>
				...
				<p>
					{t}Karen chose the affirmation , <i>"I am preparing nutritious food. That is enough."</i> In fact, the statements, <i>"I am doing my best. It is good enough," became her frequent affirmation and counteracted her negative thoughts of "not doing good enough."</i>{/t}
				</p>
        ...
        -->
				...
				<p class="forum">{t}Search the Internet and find other ways to be responsible for your self-care. Post your findings to the Forum. Then consider, how do you fare, are you caring for yourself as well as you are caring for another? And post your response to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('empower/forum_icon.png'); ?>" alt="{t}Forum Icon{/t}">
		...
		<div id="lesson-2-slide-19" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Take care of yourself daily Use <i>"tried and true"</i> stress reduction tools that work for you. In addition, learn and incorporate new stress-reducing techniques into your life. There are many worthwhile techniques available. We offer some quick and easy ones that you can fit into your busy life.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-2-slide-23" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						{t}<b>Ask yourself questions</b> like; <i>"what am I to learn from this?; what good can come from this?; am I a better person now?</i>. These types of questions can help you open up to possibilities for finding meaning.{/t}
					</li>
					<li>
						{t}<b>Reflect</b> .. Periods of quiet reflection, especially after a difficult time, are important and offer opportunities to learn from the experience.{/t}
					</li>
					<li>
						{t}<b>Talk with a trusted person</b>. Whether this person is a counselor, religious advisor, or friend, sharing can help clarify your thoughts and feelings. As you tell your story; it often takes on meaning.{/t}
					</li>
					<li>
					...
					<li>
						{t}<b>Seek spiritual renewal</b>. This is especially important when you are facing difficult times. Many caregivers report that faith and prayer help them find comfort, purpose, and meaning. It may be that even when you feel anger because of suffering and sorrow, your need for meaning is greatest.{/t}
					</li>
				</ul>
			</div>
			<div class="buttons">
		...
		<div id="lesson-2-slide-26" class="course-slide">
			<div class="content">
				...
				<h4>{t}Activity{/t}</h4>
				<p class="forum">{t}Search the Internet to help you think of at least five other simple pleasures and then post your findings to the Forum. Then, make and post a 1-5 minute video to You Tube of your simple pleasures. Post the link to your You Tube posting on the Forum for your facilitator to review.{/t}</p>
	...
	<div id="lesson-3">
		<div id="lesson-3-slide-1" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Many caregivers say one of their biggest challenges involves uttering the word <em>"No"</em>. The feeling is that saying no is somehow not permissible. If you feel this way, ask yourself:{/t}
				</p>
				<ol>
					<li>
					...
					<li>
						{t}<em>Or does true courage and nobility lie in taking care of yourself so you can be a caring helper longer?</em>{/t}
					</li>
				</ol>
		...
		<div id="lesson-3-slide-2" class="course-slide">
			<div class="content">
				...
				<p>{t}If you have never set limits, it can take time to feel good about doing so and to communicate your limits in positive ways. At first people may not take you seriously and you might back down a few times. But with time and practice, you can do it. You might be surprised at your family's reaction. Many caregivers discovered that their relatives were pleased and relieved when they began setting limits. It seems family members worried less knowing that caregivers were taking care of themselves. Because only you know what your limits are, setting your limits is up to you. Setting limits is a form of self-respect and honesty. It's realizing that you can't do everything and that's okay. It also shows consideration for family and friends. It helps take the guesswork out of planning and problem solving when you tell others what you are able and unable to do.{/t}</p>
		...
		<div id="lesson-3-slide-3" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Look carefully at limits you cannot exceed. These are your non-negotiable limits. What is the most you can give to others? This has to be clear, <i>"I am able to help two days a week. That is all I can do."</i>{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
    ...
    -->
		...
		<div id="lesson-3-slide-6" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						{t}<i>"I would like to do that, but for now I can only handle these three things."</i> (You are being factual and specific, and suggesting the limits are not permanent ones.){/t}
					</li>
					<li>
						{t}<i>"I appreciate your suggestions. Right now I can not fit them into my day."</i> (This is a good response to unsolicited advice.){/t}
					</li>
					<li>
						{t}<i>"I need some time to think about it. I will let you know tomorrow."</i> (This gives you time if you feel like making excuses or if flattery or <i>"guilt trips"</i> undermine your resolve.){/t}
					</li>
				</ul>
      ...
      <input type="button" onClick="MM_popupMsg('You probably answered \&quot;no\&quot; to the salt questions. just as we expect to ask for salt in order to receive it, we also need to ask for the help we need in caregiving. As you ask for help, remember to use the tone of voice you use when asking for salt. It\'s probably pleasant and matter-of-fact, without blaming and hinting.')" value="Submit">
		...
		<div id="lesson-3-slide-7" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<b>Consider the person's special abilities and interests</b> - Before approaching someone with a request, consider their likes, dislikes, areas of interest, experience, abilities, and knowledge. For instance, if someone likes cooking but dislikes driving, your chances improve if you ask for help with cooking. Your chances for success also improve if you ask the person to help you with tasks he feels comfortable with and knows how to do. Tasks unrelated to caregiving are easier for some people.{/t}
				</p>
				<p>
					{t}<i>Note: When one family member has a medical or nursing background, it is natural to expect that he is the best one to help with caregiving. Take care that other relatives are not automatically excused from responsibility because there is a health professional in the family.</i>{/t}
				</p>
				<p>
					{t}<b>Resist asking the same person repeatedly</b> - Ask yourself if you are requesting help from a certain person because he or she has difficulty saying no. It is important to capitalize on your stronger speaking skills rather than on someone else's inability to set limits.{/t}
				</p>
				<p>
					{t}<b>Consider the person's special needs</b> - Personal, private time is hard to come by. As a caregiver, no one knows this better than you. Other obligations in people's lives may limit the time and energy they have to give. Consider these matters before asking for help and talk them over.{/t}
				</p>
				<ul>
		...
		<div id="lesson-3-slide-8" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<b>Use your please-pass-the-salt style to make requests</b> - This is the tone you want to use when you ask someone for help. Practice making a request: <i>"I would like to go to church on Sunday. Would you mind staying with Grandma?"</i> in the same tone you would use to ask for the salt.{/t}
				</p>
				<p>
					{t}<b>Use <i>"I"</i> statements to make clear, specific requests
					</b> - A statement like <i>"I need more help"</i> is vague. A specific request sounds like, <i>"I would like to go to church this Sunday. Would you stay with Grandma from 9:00a.m. to noon?"</i>{/t}
				</p>
				<p>
					{t}<b>Avoid weakening your request</b> - If you say <i>"Could you think about staying with Grandma?"</i> you weaken your request. Saying, <i>"It is only a thought, but I would like to go to church,"</i> sounds like your request is not very important to you. Notice the strength of the statement, <i>Would you stay with Grandma from 9:00a.m. to noon?"</i>{/t}
				</p>
				<p>
		...
		<div id="lesson-3-slide-9" class="course-slide">
			<div class="content">
				...
				<p>
					{t}If your request is turned down, try not to take it personally and give yourself credit for asking. Most likely the person is turning down the task, not you. Or he may worry about doing the task the way you want it done. Consider asking, <i>"Do you have any concerns about what I have asked?"</i> Then express appreciation for the person's willingness to hear your request. <i>"Thank you for taking the time to listen."</i> Try not to let a refusal prevent you from asking for help again. The person who refused today may be glad to help another time.{/t}
				</p>
				...
				<p>
					{t}Timing is important. If you ignore a problem or delay addressing it, you give someone the message that he is doing fine. Then when you do speak up, the person wonders why you did not say something earlier. Delays in addressing the problem may also allow it to grow worse and your feelings about it to build. This often leads to blaming <i>"you"</i> statements like, <i>"Why don't you ever ... ?" "You always ... ,1 ' or "You never ... "</i>{/t}
				</p>
		...
		<div id="lesson-3-slide-10" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<b>Offer face-saving comments</b> - Your intent is to protect the person's pride and feelings by offering valid, impersonal reasons for what has happened. Ask yourself the aikido question when a criticism must be given, <i>"What does this person need from me to feel better or to save face? Protection from embarrassment? A chance to improve without having to apologize?"</i> Some examples of face-savers are:{/t}
				</p>
				<ul>
				...
				<p>
					{t}<b>End on a positive note</b> - You can end on an upbeat note by mentioning positive, helpful contributions the person has made and expressing your belief that things will work out. For example, Gerald said to an in-home worker:{/t}
				</p>
				...
				<p>
					{t}One thing I have become more sensitive to when talking to Dad is to say <i>"you"</i> instead of <i>"we."</i> It sounds more respectful to say <i>"How are you today?"</i> instead of <i>"How are we today?"</i> With a little forethought, this can be an easy change to make. And it is a change I will appreciate very much.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-3-slide-11" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Remember, you do not have to listen to a barrage of unfair and hurtful criticism. Regardless of the criticism or its source, how you react to it affects how you will feel about yourself later. It is gratifying to look back on a challenging situation and say to yourself, <i>"I handled that very well."</i>{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-3-slide-12" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<b>Betty</b>: Just forget I said anything. You are obviously too busy with your own lives to care about your own parents and me.{/t}
				</p>
				...
				<ul>
					<li>
						{t}<b>Use I messages in a non-threatening manner</b> - Be aware of your body language. For example, do not tower over people when you talk to them. Place yourself at or below eye level when you say, I get upset when I get advice instead of help taking care of Mother.{/t}
					</li>
					<li>
						{t}<b>Avoid you messages</b> - Blaming, accusing, and mind-reading are huge pitfalls. They usually lead to strong feelings of remorse later.{/t}
					</li>
					<li>
						{t}<b>Speak in a normal tone of voice</b> - Talking fast with a raised voice implies anger, regardless of what you actually say. Maintaining a moderate tone, volume, and rate of speaking suggests you are in control of your anger. Getting angry is only human and saying so is not a bad thing as long as you follow the tools for how to best express yourself.{/t}
					</li>
				</ul>
			</div>
			<div class="buttons">
		...
		<div id="lesson-3-slide-13" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<b>Catherine</b>: If I believed that my brother and sister did not care about me or the folks, I would feel the same way you do.{/t}
				</p>
				<p>
					{t}<b>Allen</b>: I do not know exactly what you need from us. Give us an example of what we can do from such long distances.{/t}
				</p>
				<p>
					{t}<b>Betty</b>: I figure I spend about $200 a month on the folks. I would really like some help in covering my out-of-pocket expenses.{/t}
				</p>
				<p>
					{t}<b>Catherine</b>: I can see we have a problem. What would you like me to do to help? I do not have much money.{/t}
				</p>
				<p>
					{t}<b>Betty</b>: If you could come out once a year and keep an eye on the folks so I could take a vacation, it would be a big help.{/t}
				</p>
		...
		<div id="lesson-3-slide-15" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Although telephone conversations can reveal clues about potential problems, they also can lead you astray. Miscommunication can occur because you do not have <i>"the messages"</i> that body language and facial expression provide. If you want to understand what the person means or feels, you might have to check with the person to make certain you both understand each other. For instance:{/t}
				</p>
				<p>
					{t}<i>"From the sound of your voice, I have the feeling you are worried. Is there something that is worrying you?"</i>{/t}
				</p>
				<p>
		...
		<div id="lesson-3-slide-17" class="course-slide">
			<div class="content">
				...
				<p>
					{t}If you want a second opinion but you hesitate to ask for it, tell your doctor: <i>"my and I have discussed the importance of getting a second opinion."</i> (Remember, there is a better chance of getting a second opinion if you ask for it than if you don't ask.){/t}
				</p>
				<ul>
	...
	<div id="lesson-4">
		<div id="lesson-4-slide-1" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<i>“Healthy aging is a broad concept that is more than just physical health status or absence of disease. It encompasses all of the intellectual, emotional, social, and spiritual facts of our being. While healthy aging is driven by internal dimensions such as our beliefs, attitudes, and intentions about our health, it also depends on external supports including our social networks, community services, public policies, and the built and natural environment. These dimensions are interrelated, affecting behavior and lifestyle choices.”</i>{/t}
				</p>
		...
		<div id="lesson-4-slide-2" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Dr. Erdman Palmore developed a <i>“Facts on Aging”</i> quiz to measure perceptions (and misperceptions) about aging. Dr. Palmore’s quiz is a good way to look at our concepts of aging. Let’s look at some of these items and see how you score them:{/t}
				</p>
				<p style="text-align: center;">
					<a href="#" target="_blank">Facts on Aging Quiz</a> and <a href="http://cas.umkc.edu/agingstudies/PDFs/Answers%20to%20Quiz.pdf" target="_blank">Answer Key</a>
				</p>
    ...
    -->
		...
		<div id="lesson-4-slide-3" class="course-slide">
			<div class="content">
				...
				<p>
					{t}How about a few more realities of aging. A survey of key trends in aging conducted by <a href="http://matherlifewaysinstituteonaging.com" target="_blank">Mather LifeWays Institute on Aging</a> documented the following facts about older adults:{/t}
				</p>
				<ul>
				...
				<p>
					{t}First of all, how do we define healthy aging? <a href="http://www.ncoa.org" target="_blank">The National Council on the Aging</a> gives this definition:{/t}
				</p>
				<p>
					<i>{t}“Healthy aging is a broad concept that is more than just physical health status or absence of disease. It encompasses all of the intellectual, emotional, social, and spiritual facts of our being. While healthy aging is driven by internal dimensions such as our beliefs, attitudes, and intentions about our health, it also depends on external supports including our social networks, community services, public policies, and the built and natural environment. These dimensions are interrelated, affecting behavior and lifestyle choices.”{/t}</i>
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-4-slide-6" class="course-slide">
			<div class="content">
				...
				<p>
					{t}The <a href="http://www.macfound.org" target="_blank">MacArthur</a> research showed that <i>“happy activities”</i> are essential to successful aging. The two most important areas they identified that contribute to successful aging are:{/t}
				</p>
				<ul>
				...
				<p class="forum">
					On the Forum, post any <i>"happy activities"</i> that you are currently involved in. If you do not have any, post some that you would like to have.
				</p>
				<img src="<?php echo $this->getImagesUrl('empower/forum_icon.png'); ?>" alt="{t}image{/t}">
			</div>
			<div class="buttons">
		...
		<div id="lesson-4-slide-10" class="course-slide">
			<div class="content">
				...
				<p>
					{t}<b>Arthritis</b> encompasses more than 100 diseases and conditions that affect joints, surrounding tissues, and other connective tissues. It is the leading cause of disability among older adults. Approximately 43% of all men and 54% of all women over the age of 65 have some level of arthritis.{/t}
				</p>
				<p>
					{t}<b>Hypertension</b> is also prevalent among older adults and can lead to activity limitations. 52% of all men and 54% of all women over the age of 65 suffer from hypertension.{/t}
				</p>
				<p>
					{t}<b>Heart Disease and Stroke</b>. Although older women are more likely to have hypertension than older men, the prevalence of heart disease and stroke is higher among older men. 37% of men and 26% of older women have heart disease, while 10% of older men and 8% of older women have suffered a stroke.{/t}
				</p>
				<p>
					{t}<b>Diabetes</b> also affects the health of older adults and limits their ability to perform normal activities. 19% of men and 17% of women over the age of 65 suffer from diabetes.{/t}
				</p>
				<p>
					{t}<b>Cancer</b>. Older men are at a greater risk of cancer than older women, 24% of older men and 19% of older women having some form of cancer. For men, the most commonly diagnosed cancers included prostate, lung, colon, and rectum. Among women, cancers of the breast, colon, and rectum were the most common.{/t}
				</p>
				<p>
					{t}<b>Osteoporosis</b>, another common chronic ailment among older adults, reduces bone density and raises the risk for potential disabling fractures. Although women are four times more likely than men to experience bone loss, recent research suggests that the prevalence of osteoporosis among men has been significantly under-diagnosed and under-reported.{/t}
				</p>
				<p>
		...
		<div id="lesson-4-slide-11" class="course-slide">
			<div class="content">
				...
				<p>{t}Emotional, behavioral, and mental change may include depression, memory lapses, inability to concentrate, or disorientation. It is important to remember that memory lapses are not automatically a sign of dementia or Alzheimer’s Disease! These changes may be caused by a number of factors including:{/t}</p>
				<ul>
		...
		<div id="lesson-4-slide-12" class="course-slide">
			<div class="content">
				...
				<p>
					{t}As many as 50% of older adults have trouble remembering things, a situation called benign forgetfulness. Some loss of short-term memory is common with older adults, yet they often can easily remember life events and experiences from the past. It is also common that older adults tell and retell information. This is not so much a situation that the older adult does not remember telling the story, but it is a way to “lock in” the story into their short-term memory <i>"bank."</i>{/t}
				</p>
		...
		<div id="lesson-4-slide-16" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						{t}Participating in <i>“mental aerobics”</i> (art, puzzles, sensory stimulation techniques) to strengthen, improve, and maintain mental and memory capabilities{/t}
					</li>
				</ul>
		...
		<div id="lesson-4-slide-18" class="course-slide">
			<div class="content">
				...
				<p>
					{t}In his book, <a href="http://www.amazon.com/Creative-Age-Gene-D-Cohen/dp/0380800713" target="_blank">The Creative Age: Awakening Human Potential in the Second Half of Life (2000), Gene D. Cohen, MD, PhD,</a> provided striking evidence that the human potential for creativity continues well into old age.{/t}
				</p>
		...
		<div id="lesson-4-slide-19" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>
						{t}Do you wish to build on what you have already done, or do you wish to take your work to a higher level?{/t}
						<ul>
	...
	<div id="lesson-5">
		...
		<div id="lesson-5-slide-2" class="course-slide">
			<div class="content">
				...
				<ul class="bulletlist">
					...
					<li>
						{t}If your loved one is 65 or over, he or she qualifies for Medicare. This insurance can be supplemented with a <i>"<a href="http://www.medicare.gov/find-a-plan/questions/medigap-home.aspx?AspxAutoDetectCookieSupport=1" target="_blank">Medigap</a>"
						</i> policy available through a private insurer. Many states also have prescription assistance/reimbursement programs for low-income senior citizens.{/t}
					</li>
					...
					<li>
						{t}If your loved one cannot get insurance and his or her income is low, he or she may qualify for Medicaid, a government <i>"safety net"</i> program that pays for medical costs that exceed a person's ability to pay.{/t}
					</li>
				</ul>
			</div>
			<div class="buttons">
		...
		<div id="lesson-5-slide-7" class="course-slide">
			<div class="content">
				...
				<p>{t}There is extra financial help for people with limited income and resources. If someone qualifies for extra help, Medicare will pay for almost all prescription drug costs. One can apply or get more information about the extra help by visiting the Social Security web page.{/t}</p>
				<h5>Medicare Prescription Drug Plan Finder</h5>
				<p>
					{t}Medicare has a valuable <a href="https://www.medicare.gov/find-a-plan/questions/home.aspx?AspxAutoDetectCookieSupport=1" target="_blank">interactive tool</a> that allows you to narrow your search for a Medicare prescription drug plan based on your personal preferences such as cost, drugs covered and participating pharmacies.{/t}
				</p>
		...
		<div id="lesson-5-slide-8" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Hospice care is given in <i>“periods of care.”</i> For example, initial hospice care usually begins with two 90-day periods (6 months total). After than period, if the hospice medical director determines the person still would benefit from hospice, they would be “recertified” for additional 60-day periods. Recertification continues every 60-days. If the hospice medical director deems the person is doing well and does not need hospice, the care would revert back to the original Medicare coverage. If later, the person again needs hospice, the medical director can recertify the person to return to hospice care.{/t}
				</p>
				<p>
					{t}The following is a resource from Medicare regarding explanation of the <a href="http://www.medicare.gov/pubs/pdf/02154.pdf" target="_blank">Medicare Hospice Benefit.</a>{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-5-slide-9" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						{t}Medicaid <i>&quot;spend-down&quot;</i> -- This is similar to a deductible or a co-payment that a patient must pay every month. Once the patient meets his &quot;spend-down&quot; amount, the patient is eligible for Medicaid for the remainder of the month.{/t}
					</li>
				</ul>
				...
				<ul>
					...
					<li>
						{t}<b>Non-financial</b> -- A patient must be a U.S. citizen and a state resident. A patient also must have a Social Security number.{/t}
					</li>
					<li>
						{t}<b>Financial</b> -- A patient's total gross income, personal assets, and property will be evaluated and must meet a certain standard. This amount varies from state to state.{/t}
					</li>
					<li>
						{t}<b>Procedural</b> -- A patient must complete and sign an application and have a personal interview with a Medicaid official.{/t}
					</li>
				</ul>
		...
		<div id="lesson-5-slide-10" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						{t}<b>Transportation</b> -- This may include ambulance services when other means of transportation are detrimental to the patient's health or may include transportation to and from the hospital at time of admission or discharge when required by the patient's condition. Transportation also may cover trips to and from a hospital, outpatient clinic, doctor's office, or other facility when the doctor certifies the need for this service.{/t}
					</li>
					<li>
						{t}<b>Ambulatory Centers</b> -- Ambulatory health care centers are private corporations or public agencies that are not part of a hospital. They provide preventive, diagnostic, therapeutic, and rehabilitative services under the direction of a physician. Ambulatory services covered by Medicaid include dental, pharmaceutical, diagnostic, and vision care.{/t}
					</li>
					<li>
						{t}<b>Hospital Services</b> -- These services include inpatient hospital care up to 60 days for an illness. Private hospital rooms are covered only when the illness requires the patient to be isolated for his or her own health or the health of others. Outpatient preventive, therapeutic, and rehabilitative services also are covered. So are professional, laboratory and radiology services.{/t}
					</li>
					<li>
						{t}<b>Medical Supplies and Medications</b> -- These include general medical supplies (when prescribed by a physician), as well as medications prescribed by a physician, dentist, or podiatrist. Durable medical equipment (such as hospital beds, wheelchairs, side rails, oxygen administration apparatus, and special safety aids, etc.) also is covered.{/t}
					</li>
					<li>
						{t}<b>Home Health Care</b> -- These services include those provided by a visiting nurse, home health aide, or physical therapist.{/t}
					</li>
					<li>
						{t}<b>Skilled Nursing Facilities</b> -- Skilled nursing facilities and intermediate care facilities (providing short-term care for a patient whose condition is stable or reversible) are covered through Medicaid with a doctor's authorization.{/t}
					</li>
				</ul>
