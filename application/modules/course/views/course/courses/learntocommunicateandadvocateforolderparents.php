...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('learntocommunicateandadvocateforolderparents/166312138.png'); ?>" id="certificate" alt="Image">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('learntocommunicateandadvocateforolderparents/80608570.png'); ?>" alt="Facilitator" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('learntocommunicateandadvocateforolderparents/Agenda_learntocommunicateandadvocateforolderparents.pdf'); ?>" target="_blank" class="button">Agenda</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Welcome to the course, “Learning to Communicate and Advocate for Older Parents.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other. </p>
		...
		<div id="lesson-1-slide-2" class="course-slide">
			<div class="content">
				...
				<p>In this course, we’ll focus on the first two elements of CARE Coaching, that of “Communicating” and “Advocating.”</p>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<p>We have developed a Caregiver Burden Assessment to help you identify aspects of your life that may or may not be impacted by caregiving at this time. Click on the following to access the tool.</p>
				...
				<p>Confusion about the healthcare system and utilization of those services by older adults is a universal experience for caregivers. Later in this course, we will address important ways for you to better understand the key roles and responsibilities of care providers as well as where concise, accurate information may be found to also share with your older parents.</p>

				<p>Guilt is often an ongoing feeling for many caregivers. Sometimes caregivers get so focused on their frail, older parent that they feel guilty focusing on someone else – including themselves. Empower Online addresses these issues for caregivers and provides tools focused on self-care of the caregiver.</p>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>Don't feel anxious if you had a number of "blanks" when working through the previous exercise - it is not a reflection on "bad" caregiving. Your parents have been independent through these many years and may not have felt the need to share much of these matters with "the kids."</p>

				<p>What do we mean by “the talk”? In the context of this course, it is the often difficult discussion about what they are wanting for their future.</p>
		...
		<div id="lesson-1-slide-8" class="course-slide">
			<div class="content">
				...
				<p> Think of this paced way to communicate as "TEMPO." This acronym stands for:</p>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				<h2 class="flowers">A framework to start "the talk" - timing</h2>
				<hr />
				<p>Plan to set aside time for conversations with your parents. You may want to have a “standing day and time” scheduled.</p>

				<p>Be respectful and ask them when would be the best time for them to have these conversations.</p>

				<p>In turn, make sure you have time to listen. No ringing cell phones or texting at this time!</p>

				<p>Above all, be patient. Your parents may feel uncomfortable at first with the idea of these conversations and may want to put them off for some time.</p>
		...
		<div id="lesson-1-slide-10" class="course-slide">
			<div class="content">
				<h2 class="flowers">A framework to start "the talk" – experience</h2>
				<hr />
				...
				<p>"Dad, I just came from my attorney's office. We finished updating my will. I was wondering when the last time you took a look at yours?"</p>

				<p>"Mom, a colleague of mine at work just had an unfortunate experience. His father had a sudden heart attack, and it took a long time before they could notify him because his dad did not have any emergency contact information in place. Can we go over how your information is organized particularly since my office recently moved and I have new phone numbers?"</p>

				<p>"It's really gotten to be a challenge driving out there. I'm on the road all day and see quite a few bad drivers, especially those on their cell phones. I'm concerned about how you're feeling about driving these days."</p>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				<h2 class="flowers">What are the motivators in your situation?A framework to start "the talk" – place</h2>
				<hr />
				<p>The place where these conversations take place needs to be a "safe space" as your parents would define that.</p>

				<p>It may not necessarily be in their home.</p>

				<p>Some of these topics are sensitive and so one parent may feel more comfortable taking the lead in the conversations. </p>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				<h2 class="flowers">What may be a comfortable place for your conversations?A framework to start "the talk" – outcome</h2>
				<hr />
				<p>One conversation is not going to address all the important topics that need to be discussed.</p>

				<p>The initial conversations may be laying the groundwork for you to better understand your parents’ feelings.</p>

				<p>Not only do you want to get information, but you also want to share information.</p>

				<p> What outcomes would be your goal in your conversations?</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>In the role of PARENT – you are in charge, make the rules, and set the agenda. Negotiating is unnecessary. You are a “teller of information.”</li>
					</li>
					<li> In the role of PARTNER – you have a common goal, mutual interests, and work towards collaborating on common goals. You are a “listener for information.”</li>
					</li>
				</ul>

				<p>You are on the same team as your parents and want to collaborate with them as a partner in their best future. You may need to reassure them that you are on the same team and you want to be a partner in their best future. Your goal is to collaborate with them to uphold their needs, beliefs, and values. It is not your intention to switch to a “parenting” role so as not to diminish their independence.</p>

				<p>Self-Coaching Hint: As reinforcement, you need to make sure your intentions are clear. You are not trying to subtly coerce them or manipulate them in some way. You intend to make every action and word worthy of trust. Practice holding that intention in your mind and heart, and it will make a difference in how you listen and influence what you say!</p>
		...
		<div id="lesson-1-slide-16" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>Communicating in CARE Coaching focuses on asking a version of the question, “What do you want?” through your conversation with older parents to support their participation in decisions. It is the first step towards better communication with your older parents about their needs and preferences.</li>
					<li>Plan to set aside time for conversations with your older parents. Be patient, as it may take some time for everyone to be comfortable with discussions about their future.</li>
					<li>Try to relate your own experiences or those of others in situations of difficult conversation as openers to difficult conversations.</li>
					<li>Difficult conversations should focus on what is the positive outcome being sought (such as better quality of life or personal safety) rather than the negative (“If you keep driving, you are going to kill yourself or somebody else!). </li>
					<li>Focus on being an Advocate to your older parents. Sometimes you may feel that you are now the parent. Try to see yourself as a partner on the same team with your parents – your goal is to uphold their needs, beliefs, and values to support their independence as long as possible. </li>
				</ol>
