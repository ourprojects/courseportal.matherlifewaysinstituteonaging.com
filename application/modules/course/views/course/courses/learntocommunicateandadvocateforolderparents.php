...
<div id="sidebar">
	...
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('learntocommunicateandadvocateforolderparents/166312138.png'); ?>" id="certificate" alt="{t}Image{/t}">
	</div>
	<div class="box-sidebar one">
		...
		<img src="<?php echo $this->getImagesUrl('learntocommunicateandadvocateforolderparents/80608570.png'); ?>" alt="{t}Facilitator{/t}" id="facilitator">
	</div>
	<div class="box-sidebar one">
...
<div class="column-wide">
	...
	<table style="border-bottom: 2px solid black; border-top: 2px solid black; margin-top: 10px;">
		<tr>
			...
			<td>
				<p>
					<a href="<?php echo $this->createDownloadUrl('learntocommunicateandadvocateforolderparents/Agenda_learntocommunicateandadvocateforolderparents.pdf'); ?>" target="_blank" class="button">{t}Agenda{/t}</a>
				</p>
			</td>
		</tr>
		<tr>
	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Welcome to the course, “Learning to Communicate and Advocate for Older Parents.” This course is geared towards family members who provide support or care to an older adult who may be a parent, spouse, other relative, or a significant other. {/t}</p>
		...
		<div id="lesson-1-slide-2" class="course-slide">
			<div class="content">
				...
				<p>{t}In this course, we’ll focus on the first two elements of CARE Coaching, that of “Communicating” and “Advocating.”{/t}</p>
		...
		<div id="lesson-1-slide-3" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Caregiving commonly brings up feelings of burden, confusion, and guilt for caregivers. Communicating is the first component of CARE Coaching. As a first step, using some key communication skills can relieve some of these concerns.{/t}</p>

				<p>{t} Does this scenario sound familiar? You are in a restaurant having dinner with your older parents. Your mother has some memory problems which means she takes quite a long time to figure out what to order. The waiter is standing over your table, and your father gets frustrated waiting for her to order. He says, “Helen, just order the chicken. You like the chicken!” She says, “I guess I’ll have the chicken.”{/t}</p>

				<p>{t}After the waiter leaves (and in front of your mother), he says, “She takes too long to order. She’s distracted with other things going on. She can’t figure it out, so it’s easy for her if I just tell her, and all she has to do is repeat it.” Your mother subsequently doesn’t say much through the rest of the evening. The mood around the table is not much better.{/t}</p>
		...
		<div id="lesson-1-slide-6" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('learntocommunicateandadvocateforolderparents/Exercise_Understanding_Needs_and_Preferences.doc'); ?>" target="_blank" class="button">Download Exercise</a>
				</p>
		...
		<div id="lesson-1-slide-7" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Don't feel anxious if you had a number of "blanks" when working through the previous exercise - it is not a reflection on "bad" caregiving. Your parents have been independent through these many years and may not have felt the need to share much of these matters with "the kids."{/t}</p>

				<p>{t}What do we mean by “the talk”? In the context of this course, it is the often difficult discussion about what they are wanting for their future.{/t}</p>
		...
		<div id="lesson-1-slide-9" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Plan to set aside time for conversations with your parents. You may want to have a “standing day and time” scheduled.{/t}</p>
				...
				<p>{t}Above all, be patient. Your parents may feel uncomfortable at first with the idea of these conversations and may want to put them off for some time.{/t}</p>
		...
		<div id="lesson-1-slide-10" class="course-slide">
			<div class="content">
				...
				<p>{t}"Dad, I just came from my attorney's office. We finished updating my will. I was wondering when the last time you took a look at yours?"{/t}</p>

				<p>{t}"Mom, a colleague of mine at work just had an unfortunate experience. His father had a sudden heart attack, and it took a long time before they could notify him because his dad did not have any emergency contact information in place. Can we go over how your information is organized particularly since my office recently moved and I have new phone numbers?"{/t}</p>

				<p>{t}"It's really gotten to be a challenge driving out there. I'm on the road all day and see quite a few bad drivers, especially those on their cell phones. I'm concerned about how you're feeling about driving these days."{/t}</p>

				<p>{t}Try this yourself.{/t}</p>

				<ul>
					<li>{t}Identify the difficult topic you are wanting to bring up with your parent.{/t}</li>
					</li>
					<li>{t}Think of an experience you or someone you may know that addresses this topic.{/t}</li>
					</li>
					<li>{t}Describe the experience and impact in no more than two sentences.{/t}</li>
					</li>
				</ul>
		...
		<div id="lesson-1-slide-11" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}A framework to start "the talk" – experience{/t}</h2>
				<hr />
				<p>{t}Relate the topic back to you or your concerns about your parent. It is very important not to put blame on your parent. For example, looking at the last opener noted above, saying to your parent, “You really seem confused sometimes behind the wheel” will not move the conversation forward. Rather, saying “I’m concerned about how you’re feeling about driving these days” puts the focus on you rather than setting up a potential confrontation. A framework to start "the talk" – motivation.{/t}</p>

				<p>{t}Be clear about your motive for having the conversation.{/t}</p>

				<p>{t}The motivating factors should be related to safety, quality of life, and well-being - both theirs and yours.{/t}</p>

				<p>{t}Their best interests are prime consideration, but your life and the lives of your family also matter.{/t}</p>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}What are the motivators in your situation?A framework to start "the talk" – place{/t}</h2>
				<hr />
				<p>{t}The place where these conversations take place needs to be a "safe space" as your parents would define that.{/t}</p>

				<p>{t}It may not necessarily be in their home.{/t}</p>

				<p>{t}Some of these topics are sensitive and so one parent may feel more comfortable taking the lead in the conversations. {/t}</p>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}What may be a comfortable place for your conversations?A framework to start "the talk" – outcome{/t}</h2>
				<hr />
				<p>{t}One conversation is not going to address all the important topics that need to be discussed.{/t}</p>

				<p>{t}The initial conversations may be laying the groundwork for you to better understand your parents’ feelings.{/t}</p>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<p>
					<a href="<?php echo $this->createDownloadUrl('learntocommunicateandadvocateforolderparents/Activity_Practice_the_Talk.doc'); ?>" target="_blank" class="button">Download Activity</a>
				</p>
		...
		<div id="lesson-1-slide-15" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>{t}“I just can’t get them to listen to me!”</li>
					<li>{t}“They just won’t talk to me about their problem, even though I’ve got the answer!”</li>
					<li>{t}“They never take my advice – even though it’s for their own good!”</li>
				</ul>
				...
				<ul>
					<li>{t}In the role of PARENT – you are in charge, make the rules, and set the agenda. Negotiating is unnecessary. You are a “teller of information.”{/t}</li>
					</li>
					<li>{t} In the role of PARTNER – you have a common goal, mutual interests, and work towards collaborating on common goals. You are a “listener for information.”{/t}</li>
					</li>
				</ul>

				<p>{t}You are on the same team as your parents and want to collaborate with them as a partner in their best future. You may need to reassure them that you are on the same team and you want to be a partner in their best future. Your goal is to collaborate with them to uphold their needs, beliefs, and values. It is not your intention to switch to a “parenting” role so as not to diminish their independence.{/t}</p>

				<p>{t}Self-Coaching Hint: As reinforcement, you need to make sure your intentions are clear. You are not trying to subtly coerce them or manipulate them in some way. You intend to make every action and word worthy of trust. Practice holding that intention in your mind and heart, and it will make a difference in how you listen and influence what you say!{/t}</p>
		...
		<div id="lesson-1-slide-16" class="course-slide">
			<div class="content">
				...
				<ol>
					<li>{t}Communicating in CARE Coaching focuses on asking a version of the question, “What do you want?” through your conversation with older parents to support their participation in decisions. It is the first step towards better communication with your older parents about their needs and preferences.{/t}</li>
					<li>{t}Plan to set aside time for conversations with your older parents. Be patient, as it may take some time for everyone to be comfortable with discussions about their future.{/t}</li>
					<li>{t}Try to relate your own experiences or those of others in situations of difficult conversation as openers to difficult conversations.{/t}</li>
					<li>{t}Difficult conversations should focus on what is the positive outcome being sought (such as better quality of life or personal safety) rather than the negative (“If you keep driving, you are going to kill yourself or somebody else!). {/t}</li>
					<li>{t}Focus on being an Advocate to your older parents. Sometimes you may feel that you are now the parent. Try to see yourself as a partner on the same team with your parents – your goal is to uphold their needs, beliefs, and values to support their independence as long as possible. {/t}</li>
				</ol>
