	...
	<div id="lesson-1">
		<div id="lesson-1-slide-1" class="course-slide">
			<div class="content">
				...
				<p>{t}Mather LifeWays Institute on Aging creates Ways to Age Well for older adults by conducting translational research and education for professionals who serve them.{/t}</p>
				<h5>
					<a href="http://www.alz.org" target="_blank">Alzheimer's Association ‐ Greater Illinois Chapter</a>
				</h5>
				<p>{t}The Alzheimer's Association is the leading, global voluntary health organization in Alzheimer's care and support, and the largest private, nonprofit funder of Alzheimer's research.{/t}</p>
				<h4>{t}Use of Information{/t}</h4>
				<p>{t}Any person is hereby authorized to view the information available from this guide for informational purposes only. No part of the information on this guide can be redistributed, copied, or reproduced without prior written consent of Mather LifeWays Institute on Aging.{/t}</p>
				<h4>{t}Copyright{/t}</h4>
				<p>{t}Information and materials of Mather LifeWays Institute on Aging included in its guides are protected by the copyright laws of the United States and international treaties.{/t}</p>
			</div>
			<div class="buttons">
		...
		<div id="lesson-1-slide-4" class="course-slide">
			<div class="content">
				...
				<p>{t}Module Four ‐ Planning for the Future, addresses a number of ways to prepare for changes that are likely to occur over the course of progressive memory loss. The need for legal and financial planning and other community resources are covered.{/t}</p>
				<p>{t}Module Five ‐ Effective Ways of Coping and Caring, addresses how to involve the person with memory loss in a variety of activities and discusses ways for family members to take care of themselves.{/t}</p>
				<h4>{t}Companion Book{/t}</h4>
				<p>
					<a href="http://www.amazon.com/Alzheimers-Early-Stages-Friends-Caregivers/dp/0897933974" target="_blank">{t}Alzheimer’s Early Stages: First steps for family, friends and caregivers.{/t}</a>
				</p>
		...
		<div id="lesson-1-slide-5" class="course-slide">
			<div class="content">
				...
				<p>{t}It is important to note that every effort has been made to include accurate information, but sometimes health care professionals have differing opinions. Also, future scientific advances may make some of this information outdated. The developers of this course will make periodic revisions as needed. We want to encourage participants to address their specific concerns with licensed professionals. We can offer general information and guidance for participants to seek out solutions to their unique challenges.{/t}</p>
				<p>{t}This program was developed as an overview for families on what to expect as early memory loss progresses. Each module is meant to provide basic information only. Following this course, you may wish to locate content experts who can address specific issues such as legal and financial planning.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-10" class="course-slide">
			<div class="content">
				...
				<p>{t}Module number two covers communication skills that will help you and others in caring for your relative. Module three prepares you for the major decisions that need to be made as memory loss progresses: when to stop driving; health; and financial decisions. In module number four, planning for the future is the focus.{/t}</p>
				<p>{t}Finally, in module five we talk about how to keep your relative engaged in meaningful activities and the need to take steps to care for yourself. It is our belief that if you take good care of yourself, your relative with memory loss will be better off too.{/t}</p>
		...
		<div id="lesson-1-slide-11" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						{t}In the past, referred to as senility or <i>hardening or the arteries</i>{/t}
					</li>
				</ul>
				<p>{t}Dementia is not a specific disease. It is an overall term that describes a wide range of symptoms associated with a decline in memory or other thinking skills severe enough to reduce a person's ability to perform everyday activities. Alzheimer's disease accounts for 60 to 80% of cases. Vascular dementia, which occurs after a stroke, is the second most common dementia type. But there are many other conditions that can cause symptoms of dementia, including some that are reversible, such as thyroid problems and vitamin deficiencies.{/t}</p>
				<p>{t}Dementia is often incorrectly referred to as senility or senile dementia, which reflects the formerly widespread but incorrect belief that serious mental decline is a normal part of aging.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-12" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}Attention{/t}</li>
					<li>{t}Ability to perform tasks in sequence{/t}</li>
				</ul>
				<p>{t}Dementia typically unfolds gradually over a period of many years but it can begin suddenly or unexpectedly. It affects some or all of these brain functions listed below.{/t}</p>
				...
				<p class="forum">{t}Did you ever forget a name or forget an appointment or get lost? What did it feel like at the time? Please describe those experiences on the Forum{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}Imagine how difficult it would be to experience this type of problem on a regular basis. We address the experience of living dementia during the next module.{/t}</p>
				<p>{t}Is everyone familiar with terms like congestive heart failure, liver failure and kidney failure? When the brain fails to do its work, dementia is the appropriate medical term.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-13" class="course-slide">
			<div class="content">
				...
				<table>
					<tr>
						<th>
							<p>{t}Reversible Dementias{/t}</p>
						</th>
						<th>
							<p>{t}Irreversible Dementias{/t}</p>
						</th>
					</tr>
					<tr>
						<td>
				...
				<p>{t}On the left hand side of this slide is a list of more common reversible conditions that sometime mimic irreversible conditions such as Alzheimer's.{/t}</p>
				<h5>{t}Irreversible Dementias{/t}</h5>
				<p>{t}Most dementias are irreversible in nature. Sometimes two or more types of these dementias may occur together as a "mixed dementia." There are several dozen types of dementia and the major types can be found on the Internet.{/t}</p>
		...
		<div id="lesson-1-slide-14" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}Only if indicated: Psychological testing, HIV test, Brain biopsy, PET scan, Lumbar puncture, EEG{/t}</li>
				</ul>
				<p>{t}A medical evaluation is always needed to clarify the diagnosis so that both reversible and irreversible conditions can be identified, treated, and understood by all concerned.{/t}</p>
				<p>{t}Basic elements of a medical evaluation by a doctor consist of the following: an accurate history of the symptoms; a brief mental status test; a physical examination; blood tests (Complete Blood Count, Chemistry profile, thyroid function, syphilis serology, Vitamin B12, and Folate); and brain imaging through either a CT or MRI scan.{/t}</p>
				<p>{t}Sometimes additional tests are ordered for the sake of thoroughness in diagnosing the exact type of dementia. There is no single test, such as a blood test, available to diagnose AD, as is the case with diabetes, for example. However, when other disorders have been ruled out and common symptoms of AD such as progressive loss of memory have been documented, there is a high probability for obtaining an accurate diagnosis by an experienced physician.{/t}</p>
				<div id="question1" class="question">
					<p>
						<b>{t}Is a medical evaluation necessary to clarify the diagnosis of a reversible or irreversible dementia?{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}Yes{/t}</option>
							<option value="0">{t}No{/t}</option>
		...
		<div id="lesson-1-slide-17" class="course-slide">
			<div class="content">
				...
				<p>{t}AD is rather common among the older population. According to the Alzheimer's Association, an estimated 5.4 million Americans of all ages had Alzheimer's disease in 2012. This figure includes 5.2 million people age 65 and older, and 200,000 individuals under age 65 who have youngeronset Alzheimer's.{/t}</p>
				<p class="forum">{t}Taking into account the figures above, can you guess how many Americans have AD today? How many people in our state are estimated to have AD? Can you guess how many people are expected to have AD 40 years from now? Search the Internet to help with your answers, and post them to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-1-slide-18" class="course-slide">
			<div class="content">
				...
				<p>{t}Based on projections of the older population in the coming decades, it is expected that the number of Americans with AD will grow dramatically.{/t}</p>
				<p class="forum">{t}Search the Alzheimer's Association's website for the most current facts on figures on the growth of AD. Record your findings on the Forum{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-1-slide-19" class="course-slide">
			<div class="content">
				...
				<p>{t}Alzheimer’s disease was first described in 1906 by Dr. Alois Alzheimer, a German neurologist and pathologist. He was the first scientist to describe the symptoms in a female patient and connect them to damaged areas in her brain. Following her death, Dr. Alzheimer performed an autopsy and found shrinkage of the brain as well as tiny abnormalities he referred to as tangles and amyloid plaques.{/t}</p>
				<div id="question1" class="question">
					<p>
						<b>{t}Alzheimer's disease is an irreversible, progressive brain disease that slowly destroys memory and thinking skills, and eventually even the ability to carry out the simplest tasks.{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
		...
		<div id="lesson-1-slide-21" class="course-slide">
			<div class="content">
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}Forgetting appointments, misplacing things, difficulty managing a checkbook, word finding problems, and loss of initiative are typical changes at this stage. Symptoms may be inconsistent, with "good days" and "bad days" making life unpredictable for all concerned. One’s ability to manage self‐care tasks is still intact at this point but reminders and supervision are needed with activities of daily living (ADLs) such as cooking, shopping, and paying bills.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-22" class="course-slide">
			<div class="content">
				...
				<p>{t}As AD progresses to the middle stages, symptoms become more obvious. Memory loss and disorientation worsen, language difficulties increase, and walking ability may slow. Independence with daily tasks becomes compromised. The ability to make health care and financial decisions is very questionable at this stage and others must assume the role of decision makers.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-23" class="course-slide">
			<div class="content">
				...
				<p>{t}In the late stages of AD, all brain functions become severely impaired. Speech and long‐term memory are significantly compromised at this point. Individuals may misidentify familiar people, places, and objects. Constant supervision of the person with late stage AD is required for the sake of safety and care.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
					...
					<tr>
						...
						<td>
							<ul>
								...
								<li>{t}Seemingly oblivious to surroundings{/t}</li>
		...
		<div id="lesson-1-slide-26" class="course-slide">
			<div class="content">
				...
				<p>{t}This is a human brain removed from the skull after death. On the left, this brain looks normal and appears free of disease. It weighs about three and a half pounds and it looks like a giant walnut.{/t}</p>
				<p>{t}On the right, notice the deep crevices in this brain compared to the plump brain in the last photo. This brain has shrunk in size and weight due to advanced AD. It is also loaded with plaques and tangles that one can see only with a microscope.{/t}</p>
				<p>{t}The dark spots in the middle are called ventricles that are spaces for the flow of blood and spinal fluid. As you can see, the difference between the two brains is quite dramatic. In this photo, the ventricles are greatly enlarged due to damage resulting from advanced AD. Most illnesses result in physical changes in a person’s body. For example, when someone has had a major stroke, it is usually easy to see the paralysis or weakness.{/t}</p>
				<p>{t}On the other hand, AD cannot be usually seen except for changes in a person’s memory, thinking and behavior. Yet this photo shows that such changes are caused by brain damage. It is important to keep this in mind when you sometimes wonder why a person with memory loss is acting in a peculiar way.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-27" class="course-slide">
			<div class="content">
				...
				<p>{t}Circumstances that put one at risk for diseases are referred to as risk factors. For example, inhaling tobacco smoke is known to increase one’s risk of getting lung and heart diseases. High blood pressure, high cholesterol levels, and obesity significantly increase one’s chances for heart disease. Identification of these risk factors has led to advances in prevention, treatments, and cures. There are clear risk factors for AD.{/t}</p>
		...
		<div id="lesson-1-slide-28" class="course-slide">
			<div class="content">
				...
				<p>{t}In rare cases, perhaps less than one percent of the total number, genetics plays a strong role in the development of AD in persons younger than age 65. This is often referred to as early onset AD. Thus far, a few genetic mutations have been identified that result in AD being passed from one generation to the next. This hereditary form is called: Familial Alzheimer’s Disease. Again, this occurs in a relatively small number of families in which symptoms may develop as early as 35 years of age. Research has focused on specific abnormalities of genes on several chromosomes.{/t}</p>
				<p>{t}AD typically occurs late in life, and one gene has been identified thus far that increases the likelihood of developing this form of the disease. The gene for Apolipoprotein E (ApoE) is located on chromosome 19. The ApoE gene comes in three varieties, called alleles: e2, e3, and e4. Everyone’s ApoE gene has two alleles, one inherited from each parent, so there are six possible combinations in any individual’s DNA. One e4 allele approximately doubles risk of AD and two e4 alleles boosts risk 8 to 10‐fold.{/t}</p>
				<p>{t}Although a blood test can identify which APOE alleles a person has, it cannot predict who will or will not develop Alzheimer's disease. It is unlikely that genetic testing will ever be able to predict the disease with 100 percent accuracy because too many other factors may influence its development and progression.{/t}</p>
				<p>{t}At present, APOE testing is used in research settings to identify study participants who may have an increased risk of developing Alzheimer's. This knowledge helps scientists look for early brain changes in participants and compare the effectiveness of treatments for people with different APOE profiles. Most researchers believe that APOE testing is useful for studying Alzheimer's disease risk in large groups of people but not for determining any one person's specific risk.{/t}</p>
				<p>{t}In doctors' offices and other clinical settings, genetic testing is used for people with a family history of early‐onset Alzheimer's disease. However, it is not generally recommended for people at risk of late‐onset Alzheimer's.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-29" class="course-slide">
			<div class="content">
				<h2 class="flowers">{t}Possible Risk Factors for AD{/t}</h2>
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/91318735.png'); ?>" alt="image">
				<ul>
					<li>{t}Environmental toxins{/t}</li>
					<li>{t}Low formal education &amp; low occupational attainment{/t}</li>
					<li>{t}Previous head trauma{/t}</li>
					<li>{t}Cerebrovascular disease{/t}</li>
					<li>{t}Dietary factors{/t}</li>
				</ul>
				<p>{t}Possible risk factors are those suspected of being somehow linked to AD, but the linkage has not been proven. Weak or strong associations with AD may be attributed to a complex number of factors still unidentified. Possible risk for AD has been associated with the areas listed above.{/t}</p>
				<div id="question1" class="question">
					<p>
						<b>{t}The greatest known risk factor for Alzheimer's is advancing age.{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}True{/t}</option>
							<option value="0">{t}False{/t}</option>
		...
		<div id="lesson-1-slide-31" class="course-slide">
			<div class="content">
				...
				<p>{t}While there is no cure for Alzheimer's disease, there are five prescription drugs approved by the U.S. Food and Drug Administration (FDA) to treat its symptoms.{/t}</p>
				<p>{t}Donepezil, galantamine, rivastigmine and tacrine are called "cholinesterase inhibitors." These drugs prevent the breakdown of a chemical messenger in the brain important for learning and memory. The fifth drug, memanatine, regulates the activity of a different chemical messenger in the brain that is also important for learning and memory. Both types of drugs help manage symptoms but work in different ways.{/t}</p>
				<p>{t}Understanding available treatment options can help you and the person with the disease cope with symptoms and improve quality of life.{/t}</p>
				<h5>{t}What are cholinesterase inhibitors?{/t}</h5>
				<p>{t}Cholinesterase inhibitors are prescribed to treat symptoms related to memory, thinking, language, judgment and other thought processes. Three different cholinesterase inhibitors are commonly prescribed:{/t}</p>
				<ul>
				...
				<p>{t}Tacrine (Cognex), the first cholinesterase inhibitor, was approved in 1993 but is rarely prescribed today because of associated side effects, including possible liver damage.{/t}</p>
				...
				<p>{t}Scientists have made remarkable progress in understanding how Alzheimer's affects the brain. Their insights point toward promising new treatments to slow or stop the disease. Ultimately, the path to effective therapies is through clinical studies.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-32" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}Creteria for inclusion and exclusion{/t}</li>
					<li>{t}Informed consent{/t}</li>
					<li>{t}Other types of research studies{/t}</li>
				</ul>
				<p>{t}All of the medications just mentioned underwent a rigorous testing process for many years prior to approval by the FDA. Testing first takes place with animals and then a small number of people to ensure safety and potential effectiveness. The next phase involves a large number of human subjects to determine whether or not a medication is effective. Volunteers are always needed to participate in this effort.{/t}</p>
				<p>{t}An adventurous attitude is required since it is not known if these experimental drugs are truly effective—that is the purpose of the research. Such drug studies require close cooperation among volunteers, their families, and medical staff. In spite of one’s willingness to participate in a given study, there is always a strict set of inclusion and exclusion criteria so that many people do not qualify for a variety of reasons.{/t}</p>
				<p>{t}All eligible participants in any research study must sign a consent form that spells out the risks and benefits of participation. Apart from drug studies, researchers conduct a wide variety of studies into the nature of AD and its treatment or prevention. Again, all such studies are subject to informed consent so that the rights of participants are protected.{/t}</p>
				<p>{t}If interested in exploring participation in drug studies or other research studies your local area, the Alzheimer’s Disease Education and Referral Center lists all current studies on it is website.{/t}</p>
				<p>{t}Many research studies now in progress are aiming to prevent or slow down the progression of AD. As mentioned earlier, some people exhibit persistent forgetfulness but lack any other symptoms of AD. They are referred to as having mild cognitive impairment and many develop additional symptoms of AD over time. Many drug trials today are aiming to slowly the course of AD in such persons.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-34" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>
						{t}<i>Use it or Lose It</i>{/t}
					</li>
					<li>{t}Diet{/t}</li>
				</ul>
				<h5>{t}Physical Exercise{/t}</h5>
				<p>{t}Several recent studies have shown that physical exercise may prevent or slow cognitive decline among otherwise healthy people. In this regard, walking just a few times weekly has been shown to be helpful compared to little or no activity. The benefits of exercise for people with AD have not been fully explored.{/t}</p>
				<h5>{t}Use it or Lose it{/t}</h5>
				<p>{t}Use it or lose it refers to the notion that keeping one’s brain active with intellectual, physical, and social pursuits may help prevent AD. There is growing evidence that keeping mentally active may reduce the risk of developing AD. Regardless of the actual benefit of this approach, it certainly cannot hurt to keep active. There are no bad side effects! Even if activities like reading books, attending lectures, or playing games such bridge or chess slightly reduce the odds of developing AD, they may be worthwhile.{/t}</p>
				<h5>{t}Diet{/t}</h5>
				<p>{t}As already mentioned, there is growing evidence that what may be good for the heart may also be good for the brain. Eating nutritious foods may be essential for a healthy heart and a healthy brain. Participants in one large study, who consumed fish once per week or more, had 60 percent less risk of AD compared with those who rarely or never ate fish. Total intake of n‐3 polyunsaturated fatty acids was also associated with reduced risk of AD. In a study of Chicago residents, eating foods rich with Vitamin E such as green leafy vegetables was associated with lower risk of AD. Future research will shed more light on types of food to take or avoid as ways to reduce the risk of AD.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-1-slide-36" class="course-slide">
			<div class="content">
				...
				<hr />
				<h4>{t}Closing{/t}</h4>
				<p>{t}Please know that this first class is the most technical in nature. Although there were not many opportunities for sharing your ideas, the remaining four classes offer plenty of time for your input. Facts about the medical causes and treatments for memory loss are important. However, we will spend the remaining weeks talking about how to cope with the practical, day‐to‐day challenges of living with someone with memory loss.{/t}</p>
				<p>{t}Finally, we wish to introduce the companion book, Alzheimer’s Early Stages: First Steps for Family, Friends and Caregivers. We recommend that you purchase it, as we will be recommending specific that reinforce key points covered in these classes.{/t}</p>
	...
	<div id="lesson-2">
		<div id="lesson-2-slide-1" class="course-slide">
			<div class="content">
				...
				<div id="question1" class="question">
					<p>
						<b>{t}Does Alzheimer's disease affect communication?{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}Yes{/t}</option>
							<option value="0">{t}No{/t}</option>
		...
		<div id="lesson-2-slide-4" class="course-slide">
			<div class="content">
				<h2 class="flowers">
					{t}<i>What we see depends on where we sit</i>{/t}
				</h2>
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/122422633.png'); ?>" alt="image">
				<p>{t}This quote speaks to the fact that your perception is crucial in making necessary accommodations to the challenges of caring for someone with memory loss. It also speaks to the fact that your relative often sees things in a much different way than you do. This is important to remember as we discuss the memory changes your family member may be experiencing and how this may affect his/her ability to communicate.{/t}</p>
				<p>{t}You and the person with memory loss may be experiencing the same reality but in different ways. For example, your relative may not be as upset with the changes in memory and communication as you might be. You can easily remember your relative as a completely capable individual whereas he or she may have slowly adapted to the changes in memory and thinking over time. It is typical for that person to lack insight into all of the changes that have taken place.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-2-slide-6" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}Gestures, facial expression, body language{/t}</li>
				</ul>
				<h4>{t}Communication{/t}</h4>
				<p>{t}Communication is the exchange of information, ideas, and emotions. It is how we convey our thoughts, wishes, and feelings.{/t}</p>
				<p>{t}In order for communication to occur, the message needs to not only be sent, but received. We need to not only hear but to also understand the message – otherwise, communication has not really occurred. We have all had experiences where we thought we made ourselves clear, only to find that the other person interpreted the message differently than we intended! The following exercise is designed to demonstrate the importance of good communication and that it involves more than just words.{/t}</p>
				<p>{t}Communication is complicated! It involves not just speaking our minds, but also listening to the other person. As this exercise teaches us, it entails speaking, listening, and watching others for cues.{/t}</p>
				<p>{t}Listening is not as easy as it seems. To truly listen, we need to be completely attentive to the other person. Often, we may think we are listening to the other person when we are actually distracted. Maybe what we are doing, e.g., driving a car or trying to decide which kind of soup to buy at the grocery store, distracts us. We are distracted because we are thinking about something else while the person is talking, or because we are busy thinking about what our response to the person will be. It is hard to truly listen – and it takes practice.{/t}</p>
				<p>{t}Reading and writing are forms of communication. Some of us respond better to messages that are received in writing than we do to verbal messages. Some of us may find that it helps to write things down as a way of thinking them through. Sometimes we have trouble communicating because our preferred way of communicating may not be the other person’s. For example, maybe you like to write notes or send emails to someone who prefers to talk face‐to‐face or over the telephone. It is important to be sensitive to how we communicate and make sure we communicate appropriately.{/t}</p>
				<p>{t}Body language is another important component of communication. Gestures, facial expressions, and body posture are often as important in communication (if not more) as the words.{/t}</p>
      ...
      -->
		...
		<div id="lesson-2-slide-7" class="course-slide">
			<div class="content">
				...
				<p>{t}There are different kinds of memory. Understanding them and how they work can help us to understand some of the communication challenges faced by persons with dementia.{/t}</p>
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}It is important to understand the different types of memory so that we can see how impairment in these may affect one’s ability to communicate. Note that people with early stage memory loss tend to have more problems with working and short‐term memory than with long‐term, episodic and procedural memory. When conversing with someone with memory loss, it is important to remember that they may have difficulty recalling recent events or may need more time to retrieve the information.{/t}</p>
				<p>{t}Next, we are going to look at some of the changes that may occur with communication as memory becomes impaired.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-2-slide-8" class="course-slide">
			<div class="content">
				...
				<p>{t}Word finding refers to that tip of the tongue phenomenon that we all experience from time to time. We know what we want to say but just cannot immediately find the word. People who have memory loss experience this phenomenon to such a degree that it interferes with their ability to communicate.{/t}</p>
				<p>{t}The comprehension of information often becomes impaired. The person may have a difficult time tracking conversations or following instructions with more than one step.{/t}</p>
				<p>{t}The person with memory loss is more likely to digress during conversations – jumping from the original topic to another related one. Once the person digresses, they may have a difficult time remembering the original topic of conversation. Because of changes in memory, it is also common for the person with memory loss to repeat himself/herself, forgetting what has recently been said.{/t}</p>
				<p>{t}Reading and writing may be affected. The person may have difficulty understanding written material or may not be able to communicate clearly in writing.{/t}</p>
				<p>{t}People with memory loss often have difficulty with abstract concepts. Many people have trouble with talking on the telephone because they may rely more on the body language and facial expressions of others when communicating. The person may have a difficult time comprehending the conversation, may not remember to whom he is speaking, or may not recall the conversation later.{/t}</p>
		...
		<div id="lesson-2-slide-9" class="course-slide">
			<div class="content">
				...
				<p>{t}As memory becomes impaired, the person with memory loss may find that he has to concentrate very hard in order to follow conversations. Anything that interferes with the ability to concentrate, e.g. noise or movement, may make it even more difficult for the person.{/t}</p>
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}If you do something like that, others tend to write it off to having a bad day or being distracted, right? But if a person with memory loss does the same thing it is looked at differently and the person may no longer be allowed to cook. The stakes are much higher, so the fear of making mistakes is greater. You may need to adjust to this by giving the person with memory loss more time to do things, and be as patient as possible.{/t}</p>
				<h5>{t}Attention problems may appear to be hearing loss{/t}</h5>
				<p>{t}People who are distracted or who have difficulty concentrating may sometimes miss bits and pieces of a conversation. This can sometimes make it seem as though the person has a hearing problem. On the other hand, do not rule out hearing loss as a possible issue if the person is having problems hearing when the conversation is happening in a place with few distractions.{/t}</p>
		...
		<div id="lesson-2-slide-10" class="course-slide">
			<div class="content">
				...
				<p class="forum">{t}Using your own experience, or by searching the Internet, post on the Forum some examples using the above listed communication tips.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-2-slide-11" class="course-slide">
			<div class="content">
				...
				<p>
					{t}We are all familiar with the saying, <i>"it is not what you say, but also how you say it."</i> We have all had experiences where we were put off by a person's tone of voice or facial expression, even if what they said was not really all that offensive.{/t}
				</p>
				...
				<p>{t}Body language and facial expressions are other concerns. If your words are calm but your body language is tense or your facial expression does not match what you are saying, the message will be mixed. The person with memory loss may react to the look on your face or your body language instead of what is being said.{/t}</p>
				<p class="forum">{t}Think of a time when you talked to someone who you knew was not telling the truth. Their words may have been convincing, but somehow you knew something was not right. How did you know this? What gave them away? Post your responses to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>
					{t}The saying, <i>"it is not what you say; it is how you say it"</i> is important to remember in all forms of communication, but especially when talking to someone with memory loss.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-2-slide-12" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						{t}Allow circumlocution - <i>talking around</i>{/t}
					</li>
					<li>{t}Allow time for processing{/t}</li>
					<li>{t}Keep conversations on track{/t}</li>
					<li>
						{t}Enable ventilation - <i>letting off steam</i>{/t}
					</li>
		...
		<div id="lesson-2-slide-15" class="course-slide">
			<div class="content">
				...
				<p>
					{t}For more ideas about communication strategies, please refer to chapters 5 and 8 of the book, <i>Alzheimer's Early Stages</i>. Chapter 5 is especially helpful in understanding the communication challenges faced by persons with memory loss. If possible, read these chapters during the coming week.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> {t}Complete Module{/t}</a>
	...
	<div id="lesson-3">
		<div id="lesson-3-slide-1" class="course-slide">
			<div class="content">
				...
				<div id="question1" class="question">
					<p>
						<b>{t}There are different kinds of memory. Understanding them can help us to understand some of the communication challenges faced by persons with dementia.{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}True{/t}</option>
							<option value="0">{t}False{/t}</option>
		...
		<div id="lesson-3-slide-3" class="course-slide">
			<div class="content">
				...
				<h5>
					<i>{t}"Not to decide is to decide."{/t}</i>
				</h5>
				...
				<p class="forum">{t}Are you the chief decision maker in your household? Post your response to the Forum{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-3-slide-5" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>
					<i>{t}Honey, I have been through two world wars, the Great Depression, taught 3,297 children, administered four elementary schools and outlived every one of the people I worked with. I am 89 years old and you are telling me it is bedtime?{/t}</i>
				</p>
		...
		<div id="lesson-3-slide-6" class="course-slide">
			<div class="content">
				...
				<p class="forum">{t}Search the Internet and find examples or explanations for each of the listed items above, and post your findings to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}A number of rehabilitation centers have specially trained staff members, usually occupational therapists, who can assess a person’s driving capacity through a series of tests. These exams can cost around $250‐ 400 but it may be worthwhile to get a professional opinion. A physician might recommend this course of action before a decision is reached.{/t}</p>
				<p>{t}The privilege of driving is so terribly important for some people that taking it away may harm the self esteem of the person affected by this decision. It is important to consider alternative means of transportation to minimize the impact of this decision. Does your local area have bus transportation for seniors? Is your family prepared to take on the “chauffeur” role?{/t}</p>
				<p>{t}If persuasion alone is insufficient to keep an unsafe driver off the road, taking action through the state department of motor vehicles to revoke that person’s license may be the only alternative. Other options are to disable the car or get rid of it altogether.{/t}</p>
		...
		<div id="lesson-3-slide-7" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>
					<i>{t}When I die, I want to go peacefully, like my grandfather did, in his sleep; not screaming like the other passengers in his car.{/t}</i>
				</p>
				<p>{t}This humorous quote illustrates the serious consequences of unsafe driving. It is better to err on the side of safety when considering whether or not a person with memory loss should continue driving. Again, the issue of personal freedom versus public safety must be carefully weighed.{/t}</p>
				<ul>
					<li>{t}Capacity exists unless given up voluntarily{/t}</li>
				...
				<p>{t}Making personal decisions over one’s health and financial affairs is a personal right that is threatened by memory loss. Assessing when and how to intervene is difficult unless the person with memory loss voluntarily gives up this authority.{/t}</p>
				...
				<p>{t}Nevertheless, due to the person's impaired memory and judgment, someone else must be in a position of monitoring risks. Otherwise, problems such as failing to pay important bills can emerge.{/t}</p>
		...
		<div id="lesson-3-slide-8" class="course-slide">
			<div class="content">
				...
				<p>{t}Generally, the ability to handle personal care tasks like bathing and dressing remain intact in the early stages. Such things have been done so often that they tend to happen almost automatically, but some instances of forgetting these basics may occur from time to time. More complex tasks such as cooking a meal or fixing a broken appliance are often problematic.{/t}</p>
		...
		<div id="lesson-3-slide-11" class="course-slide">
			<div class="content">
				...
				<p class="forum">{t}Search the Internet for handouts or downloadable forms that help organize family meetings. Please share your results on the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
				...
				<table>
					...
					<tr>
						...
						<td>
							<ul>
								<li>
									{t}<i>“What they do not know won't hurt them”</i>{/t}
								</li>
		...
		<div id="lesson-3-slide-13" class="course-slide">
			<div class="content">
				...
				<p class="forum">
					{t}Can you define the term, "<i>armchair quarterback?</i>" Post your answer to the Forum.{/t}
				</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
		...
		<div id="lesson-3-slide-14" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}Develop new relationships by attending support groups, finding others who can relate with your situation.{/t}</li>
				</ul>
				<div id="question1" class="question">
					<p>
						<b>{t}Positive peer pressure can be one of the most powerful motivators around.{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}True{/t}</option>
							<option value="0">{t}False{/t}</option>
		...
		<div id="lesson-3-slide-16" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Contact your class leader in order to address specific issues that did not get answered on the Forum. Chapters 6 and 7 in the book, <i>Alzheimer's Early Stages</i>, relate to this class. Please read those chapters for more information about the issues we covered today. Next module will focus on planning for the future. Thanks your for participating.{/t}
				</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
	...
	<div id="lesson-4">
		...
		<div id="lesson-4-slide-2" class="course-slide">
			<div class="content">
				...
				<p class="forum">{t}Forum Posting: What kind of questions might you be interested in having answered? Take a few minutes before you respond.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
		...
		<div id="lesson-4-slide-4" class="course-slide">
			<div class="content">
				...
				<ul>
					<li>
						<a href="http://www.medicare.gov" target="_blank">{t}Medicare.gov{/t}</a>
					</li>
					<li>
						<a href="http://www.ssa.gov" target="_blank">{t}Social Security Administration website{/t}</a>
					</li>
					<li>
						<a href="http://medicaid.gov" target="_blank">{t}Medicaid.gov{/t}</a>
					</li>
				</ul>
			</div>
			<div class="buttons">
		...
		<div id="lesson-4-slide-5" class="course-slide">
			<div class="content">
				...
				<p>{t}Medicare is a national health insurance program administered by the federal government that guarantees health insurance for people age 65 or older, people under age 65 with certain disabilities, and people of all ages with end‐stage renal disease (permanent kidney failure requiring dialysis or a kidney transplant).{/t}</p>
		...
		<div id="lesson-4-slide-6" class="course-slide">
			<div class="content">
				...
				<p>{t}The Centers for Medicare and Medicaid Services (CMS) can answer questions about Medicare and help you enroll for one of the drug discount cards. People with Medicare, family members, and caregivers should visit the Official U.S. Government Site for People with Medicare, for the latest information on Medicare enrollment, benefits, and other helpful tools.{/t}</p>
				<p>
					{t}You may also search the CMS website for their guide titled: <i>Medicare and You</i>, an outline of the Medicare program that includes up‐to‐date information regarding eligibility and costs, such as deductibles and copays.{/t}
				</p>
				<div id="question1" class="question">
					<p>
						<b>{t}Medicare Part A (Hospital Insurance) helps cover inpatient care in hospitals, as well as skilled nursing facility, hospice, and home health care.{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}Yes{/t}</option>
							<option value="0">{t}No{/t}</option>
					...
					<p class="wrong-answer hide">{t}Incorrect. Please ensure you understand the various parts of Medicare before continuing.{/t}</p>
				</div>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-4-slide-9" class="course-slide">
			<div class="content">
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}An adult daughter shared her story of the struggles she encountered in getting her father to attend an adult day center. Each morning, her father would grumble, curse, and occasionally become combative. When she would pick her father up at the end of the day, he was often agitated.{/t}</p>
				<p>
					{t}She would ask, <i>“How was your day, Dad?”</i> and he would reply with disparaging remarks about the program and staff. However, when she would speak with the staff she would receive a positive and reassuring account of the day's activities. Her father would take part in activities, including baking with a majority of female participants, and would sing along with an exuberant voice whenever guests came to play the guitar or piano.{/t}
				</p>
		...
		<div id="lesson-4-slide-10" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}Supervision of caregivers{/t}</li>
		...
		<div id="lesson-4-slide-11" class="course-slide">
			<div class="content">
				...
				<ul>
					...
					<li>{t}They run more than 4,500 support groups throughout the country and connect people across the globe through our online message boards.{/t}</li>
					<li>{t}They provide caregivers and families with comprehensive online resources and information through our Alzheimer's and Dementia Caregiver Center, which features sections on early‐stage, middle‐stage and late‐stage caregiving.{/t}</li>
					<li>{t}They help people find clinical trials through our free service Alzheimer’s Association TrialMatch, which makes it easy to search opportunities based on personal criteria.{/t}</li>
					<li>{t}They deliver 20,000 education programs annually and offer online information in 17 languages.{/t}</li>
					<li>{t}Their free online tool, Alzheimer's Navigator, provides individuals with Alzheimer's and their caregivers with step‐by‐step guidance and customized action plans, and our online Community Resource Finder provides instant access to community resources and services.{/t}</li>
					<li>{t}They house the Alzheimer's Association Green‐Field Library, the nation's largest library and resource center devoted to increasing knowledge about Alzheimer's disease and related dementias.{/t}</li>
					<li>{t}Their safety services, Comfort Zone and MedicAlert® + Alzheimer’s Association Safe Return®, provide location management for people with Alzheimer’s who wander.{/t}</li>
					<li>{t}Their annual Walk to End Alzheimer's is the nation's largest event to raise awareness and funds for Alzheimer's care, support and research.{/t}</li>
				</ul>
				<p class="forum">{t}Search the Internet for your local chapter and contact information. This information can be found on the Alzheimer's Association’s website. Also, there may be other organizations in your area that offer similar programs and services. Post your findings on the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-4-slide-12" class="course-slide">
			<div class="content">
				...
				<hr />
				<ul>
					<li>{t}Administration on Aging - Serves the growing senior population{/t}</li>
		...
		<div id="lesson-4-slide-14" class="course-slide">
			<div class="content">
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>
					{t}As usual, post any specific concerns you may have to the Forum. Your supplemental reading, in the companion book, includes Chapters 9 and 12. These chapters cover the material we covered today in greater detail. Thank you for participating. The next module is the final one, and we will discuss <i>Effective Ways of Coping and Caring</i>. We look forward to your participation.{/t}
				</p>
			</div>
			<div class="buttons">
				<a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> {t}Complete Module{/t}</a>
	...
	<div id="lesson-5">
		<div id="lesson-5-slide-1" class="course-slide">
			<div class="content">
				...
				<div id="question1" class="question">
					<p>
						<b>{t}Medicare is a health insurance program; parts, A, B, C and D.{/t}</b>
						<select>
							<option selected="selected" value="select">{t}Select{/t}</option>
							<option value="1">{t}Yes{/t}</option>
							<option value="0">{t}No{/t}</option>
		...
		<div id="lesson-5-slide-2" class="course-slide">
			<div class="content">
				...
				<p>
					{t}In this module, we will focus on effective ways of coping and caring. We will first learn about one of the most effective ways of coping activity. In its purest form, activity means <i>doing</i>. For the first half of the module, we will:{/t}
				</p>
				<ul>
					<li>
						{t}Discuss the importance of <i>doing</i>{/t}
					</li>
		...
		<div id="lesson-5-slide-3" class="course-slide">
			<div class="content">
				<h2 class="flowers">
					{t}Recognize the importance of <i>doing</i> in your life &amp; in the life of your family member{/t}
				</h2>
				<hr />
				...
				<p class="forum">{t}Think of your own life. What things do you enjoy doing? Post your responses on the Forum.{/t}</p>
		...
		<div id="lesson-5-slide-5" class="course-slide">
			<div class="content">
				...
				<p>{t}We are all creatures of habit; we tend to have a pattern to our days. This routine is important to us and when it is disrupted we tend to feel a bit off. Think of times in your life when your daily routine is disrupted: when you are sick, when you are on vacation; or on a business trip; when you have had a new addition to your family. Even if the circumstance itself is positive, the disruption to your schedule takes some getting used to.{/t}</p>
				<p>{t}With memory loss, having a predictable pattern to the day, or a particular routine when doing things, can be helpful. This does not mean that every day needs to be exactly the same or that there is no room for new experiences. But generally, following the person’s preferred routine may be helpful, as it provides familiarity and comfort.{/t}</p>
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}Have the group brainstorm about this. You may need to start the discussion by giving an example of something that you do as a routine, having a cup of coffee in the morning before going to work, or taking a walk every evening. Ask the group to think about activities that they engage in every day as a routine – activities that they miss when they are unable to get to them. Discuss how unsettling it can feel when one's timetable is interrupted through illness, scheduling difficulties, or travel. Remind the group that a person with memory loss may have a particularly difficult time with a change in routine.{/t}</p>
				<p>{t}Some people with early memory loss describe the difficulty they have in changing their routines or switching from one activity or event to another. The person may feel that she needs to finish the first activity completely before going on to the next so as to not leave a project half done.{/t}</p>
				<p class="forum">{t}Has your family member or friend ever had difficulty with sudden changes to routine? What do you think you might be able to do to make transitions from one event to another easier? What daily activities seem to be important to your family member/friend, and what do you do to accommodate them? Post your responses to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		...
		<div id="lesson-5-slide-6" class="course-slide">
			<div class="content">
				...
				<hr />
				<p>{t}Life does not end when a family member is diagnosed with a memory disorder. There are still plenty of opportunities for you and your family member/friend to enjoy one another's company, and yes, even have fun!{/t}</p>
		...
		<div id="lesson-5-slide-7" class="course-slide">
			<div class="content">
				...
				<p>{t}Even people experiencing mild memory loss occasionally have the experience of getting lost in an activity – losing their place and becoming confused about what to do next. This can be frightening and confusing to friends and family as well as to the person with memory loss.{/t}</p>
				...
				<p>{t}People with normal memory are able to look at a task like teeth brushing or getting dressed in the morning as a simple activity, going through the motions without needing to give it much thought. But a person with memory loss may lose their way because in reality these activities are very complicated and have many steps.{/t}</p>
				...
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<p>{t}This exercise is to help us understand why the simple tasks we take for granted can sometimes seem overwhelming to a person with even mild memory loss. A task like making toast seems pretty easy and straightforward to us until we try to break it down into smaller steps. It is easy to see how a person experiencing memory loss may have difficulty remembering all of the steps or may get off track.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-8" class="course-slide">
			<div class="content">
				...
				<p>
					{t}Let's take Ted as an example. Ted always enjoyed gardening. Last week his wife, Mary, found Ted in the shed, staring at his garden tools and looking confused. Mary asked Ted <i>what was wrong</i> and he said, <i>I need to pull weeds but I do not remember what I am supposed to use to do that.</i>{/t}
				</p>
				<p>{t}When Mary looks at the garden, she notices that Ted has pulled out three small tomato plants, mistaking them for weeds. It is obvious that Ted can not garden without supervision anymore, but gardening has always been very important to him.{/t}</p>
				<p class="forum">{t}What should Mary do? Post your response to the Forum.{/t}</p>
				<img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
				<h5>{t}Summary{/t}</h5>
				<p>{t}It is the things we do that give our lives meaning – our work, hobbies, and daily routines. Our challenge as family members, partners, and friends of people experiencing early memory loss is to help these individuals do the things they have always liked to do, while considering adaptations when necessary.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-10" class="course-slide">
			<div class="content">
				...
				<p>{t}Being well informed about current therapies, research and practice will help you immensely in the months and years ahead. By enrolling in this course, you have taken the first step in finding out what you need to know about memory loss. As time goes on, you will find that the needs of your family member will change, and you will need additional information.{/t}</p>
				<p>{t}The Alzheimer's Association is a good resource. Other resources include hospitals and medical centers, particularly those with neurology or memory loss clinics, research or educational organizations, and online resources like the Alzheimer's Disease Education and Referral Center (ADEAR) and the National Institutes of Health.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-11" class="course-slide">
			<div class="content">
				...
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
				<p>{t}It is very important to find a physician you can trust. You will have many questions as time goes on, and you will certainly want to keep up with current treatment options. If your physician does not understand memory loss, does not appear to be familiar with current treatments, or minimizes the seriousness of your relative’s symptoms, you should consider changing physicians. Contact the Alzheimer's Association for referrals to physicians who are sensitive to the needs of persons experiencing memory loss.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-13" class="course-slide">
			<div class="content">
				...
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
				<p>{t}As we discussed in the last class, it is important to put legal and financial plans in place now. Durable powers of attorney for finance, health care and advance directives may not be pleasant to think about, but having these legal tools in place can be useful in preventing struggles and conflicts down the road.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-14" class="course-slide">
			<div class="content">
				...
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
				<p>{t}You may feel that you do not need help from anyone else right now. As time goes on you may need assistance from others. One of the best things that you can do for yourself now, and in anticipation of the future, is to keep in touch with your friends and other family members. Let them know what is happening. If they offer to help you, find something for them to do, even if it is a small favor like running an errand or owing your lawn. You may not feel as though you need the help now, but cultivating these relationships will help you immensely down the road. If you turn people away now, they may not feel comfortable offering you assistance later, when you really need it.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-15" class="course-slide">
			<div class="content">
				...
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
				<p>{t}Everyone needs a listening ear now and then. As the demands of caring for a person with memory loss grow over time, you may find that you benefit from talking to a trusted friend or family member about your experience. If you do not feel that you have such a person in your life, you may want to consider talking to a counselor or a clergy person. There are also support groups available to assist you.{/t}</p>
				<p>{t}The important thing is to make sure that you have an outlet for your thoughts and feelings as you go through this journey. Your confidante should be someone you trust, who will listen to you in a nonjudgmental way and offer you emotional support and assistance.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-19" class="course-slide">
			<div class="content">
				...
				<hr />
				<img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
				<p>{t}You may not consider yourself to be a religious or spiritual person. But we all have some source of inspiration and spiritual renewal. What inspires you? What gives you the energy to get through the day?{/t}</p>
				<p>{t}Whatever source you have for spiritual growth, this is the time to go to that source and take advantage of the strength you draw from it. For some people, that may mean reading scriptures or attending worship services. For others, it may mean taking walks in the woods or going fishing. Others may find inspiration in art: music, dance, drama, or the visual arts. Still others may gain inspiration and support from friends or family.{/t}</p>
				<p>{t}Whatever the source that works for you, make sure that you find ways to renew your spirit. This may be the most important thing that you can do for yourself as you love and care for a person with memory loss.{/t}</p>
			</div>
			<div class="buttons">
				<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
			</div>
		...
		<div id="lesson-5-slide-21" class="course-slide">
			<div class="content">
				...
				<p>{t}To end the course, I would like to share with you one last message that conveys the feeling of caring for someone with memory loss and invite you to remember this quote from Helen Keller.{/t}</p>
