...
<div id="sourceMessage">
	...
	<div id="missing">
		...
		<div id="acceptedLanguageTranslations">
	    	...
	    	if(TranslateModule::translator()->canUseGoogleTranslate()) {
				echo CHtml::ajaxButton(
						...
						array(
							...
							'success' => 'js:function(data){$.fn.yiiGridView.update("missing-accepted-language-grid");}',
			...
			$this->widget('translate.widgets.messageSource.MissingAcceptedLanguageGrid', 
		...
		<div id="translations">
			...
			$this->widget('translate.widgets.messageSource.MissingTranslationGrid', 
