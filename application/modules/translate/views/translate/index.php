...
<div id="sidebar">
  <div class="box-sidebar one">
    <h3> <?php echo TranslateModule::t('Statistics'); ?> </h3>
    <table id="statistics">
      <tr>
  ...
  <div class="box-sidebar one">
    <h3> {t}Translation Management{/t} </h3>
    <p style="text-align:center; font-weight:bold;"><a href="https://developers.google.com/translate/" target="_blank">Google Translate API - Login</a></p>
    
    <!-- need to update with correct image path
    <p><img class="block center" 
    src="<?php # echo $this->getImagesUrl('/application/assets/admin/images/googledeveloperslogo.png'); ?>" 
    alt="Google Developers"></p>
    -->
    <p>{t}With Google Translate, you can dynamically translate text between thousands of language pairs. The Google Translate API lets websites and programs integrate with Google Translate programmatically. This Google Translate API widget is available as a paid service. See the sidebar for login instructions and access.{/t}</p>
    <p style="text-align:center; font-weight:bold;"><a href="https://translate.google.com/manager/website/" target="_blank">Google Website Translator Gadget</a></p>
  </div>
</div>
<div class="column-wide">
  <h2 class="flowers">Translation Management</h2>
  <p> {t}Please use this interface to administer our Google Translate API subscription.{/t}</p>
  <div class="box-white">
    <h2> <?php echo TranslateModule::t('Select the area below you would like to configure:'); ?> </h2>
    <ul id="configOptions">
