...
class TViewRenderer extends CViewRenderer
{
	...
	protected function getViewFile($file, $language = null)
	{
		...
		{
			return TranslateModule::getRuntimePath().DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR.sprintf('%x', crc32(__CLASS__.Yii::getVersion().dirname($file))).DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.basename($file);
		}
