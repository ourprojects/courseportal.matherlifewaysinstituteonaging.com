 ...
 *
 */
class TMessageSourceLanguageWrapper extends CMessageSource
{
	...
	{
		return $this->_messageSource->loadMessages($category, $language);
	}
	...
	{
		return $this->_messageSource->translate($category, $message, $language);
	}
	...
	{
		return $this->_messageSource->translateMessage($category, $message, $language);
	}
	...
	{
		$this->_messageSource->onMissingTranslation($event);
	}
