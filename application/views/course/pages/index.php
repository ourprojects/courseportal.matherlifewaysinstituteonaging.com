...
<div id="single-column">
  ...
  <img src="<?php echo $this->getImagesUrl('image-nurse.png'); ?>"
		class="image-right" />
  <h3> <a href="http://www.matherlifewaysinstituteonaging.com/senior-living-providers/gerontology-online/"> {t}Gerontology Online program{/t} </a> </h3>
  ...
  <hr />
  <h3> <a href="http://www.matherlifewaysinstituteonaging.com/senior-living-providers/aging-in-the-workplace/"> {t}Aging in the Workplace Survey{/t} </a></h3>
  ...
  <hr />
  <h3> <a href="http://www.matherlifewaysinstituteonaging.com/senior-living-providers/aging-in-the-workplace/">{t}Aging in the Workplace Toolkits{/t} </a></h3>
  <p>{t}The Aging in the Workplace toolkits and survey are designed to provide employers with strategic aging-related workforce management information. With a large percent of the 78 million boomers planning to remain in the workforce past traditional retirement age, organizations in the nonprofit, private, and public sectors will need tools and resources to make the best use of their knowledge and skills in order to increase organizational effectiveness and business performance.{/t}</p>
  ...
  <hr />
  <h3><a href="http://www.matherlifewaysinstituteonaging.com/health-care-professionals/making-sense-of-memory-loss-class-leader-toolkit/"> {t}Making Sense of Memory Loss Class Leader Toolkit{/t} </a> </h3>
