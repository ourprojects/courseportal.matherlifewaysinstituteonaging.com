...
shrinkage of the brain as well as tiny abnormalities he referred to as tangles and amyloid plaques.'); ?></p>
        <div id="question1" class="question">
          <p><b><?php echo t('Alzheimer\'s disease is an irreversible, progressive brain disease that slowly destroys memory and thinking skills, and eventually even the ability to carry out the simplest tasks.'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
          ...
          <p class="wrong-answer hide"> <?php echo t("Incorrect. Please ensure you understand what Alzheimer\'s disease is before continuing."); ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
...
unidentified. Possible risk for AD has been associated with the areas listed above.'); ?></p>
        <div id="question1" class="question">
          <p><b><?php echo t('The greatest known risk factor for Alzheimer\'s is advancing age.'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('True'); ?> </option>
              <option value="0"> <?php echo t('False') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t("Correct!"); ?> </p>
          <p class="wrong-answer hide"> <?php echo t("Incorrect. Search the Alzheimer\'s Association website for AD risk factors."); ?> </p>
        </div>
  ...
  <div id="lesson-2">
    <div id="lesson-2-slide-1" class="course-slide">
      <div class="content">
        ...
        <div id="question1" class="question">
          <p><b><?php echo t('Does Alzheimer\'s disease affect communication?'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('Yes'); ?> </option>
              <option value="0"> <?php echo t('No') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t("Correct! People with Alzheimer\'s lose particular communication abilities during the early, middle, and late stages of the disease."); ?> </p>
          <p class="wrong-answer hide"> <?php echo t("Incorrect. Please review Module One."); ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Start Course &raquo;'); ?></a></div>
    </div>
    <div id="lesson-2-slide-2" class="course-slide">
      <div class="content">
        ...
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/135545925.png'); ?>" alt="image">
        <p><?php echo t('Welcome to the second module of MSML Online. One of the more frustrating and difficult aspects of memory loss is that the person\'s ability to communicate may be compromised. In this section, we will discuss how to adapt to these changes. We will cover these general topics and get into specifics along the way.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Agenda for Module 2'); ?></h2>
        <hr />
    ...
    <div id="lesson-2-slide-4" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('<i>What we see depends on where we sit</i>'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/122422633.png'); ?>" alt="image">
        <p><?php echo t('This quote speaks to the fact that your perception is crucial in making necessary accommodations to the
...
changes your family member may be experiencing and how this may affect his/her ability to communicate.
'); ?></p>
        <p><?php echo t('
You and the person with memory loss may be experiencing the same reality but in different ways. For
...
into all of the changes that have taken place.
    ...
    <div id="lesson-2-slide-5" class="course-slide">
      <div class="content">
        ...
        <li><?php echo t('Role of Denial'); ?></li>
        <li><?php echo t('No Awareness'); ?></li>
        <li><?php echo t('Partial Awareness'); ?></li>
        <li><?php echo t('Much Awareness'); ?></li>
        </ul>
        <p class="forum"><?php echo t('Search the Internet for explanations on each of these listed levels. Post your findings on the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-6" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li><?php echo t('Gestures, facial expression, body langauge'); ?></li>
        </ul>
...
wishes, and feelings.'); ?></p>
        <p><?php echo t('In order for communication to occur, the message needs to not only be sent, but received. We need to not
...
involves more than just words.'); ?></p>
        <p><?php echo t('Communication is complicated! It involves not just speaking our minds, but also listening to the other
person. As this exercise teaches us, it entails speaking, listening, and watching others for cues.'); ?></p>
        <p><?php echo t('Listening is not as easy as it seems. To truly listen, we need to be completely attentive to the other person.
...
practice.'); ?></p>
        <p><?php echo t('Reading and writing are forms of communication. Some of us respond better to messages that are
...
how we communicate and make sure we communicate appropriately.'); ?></p>
        <p><?php echo t('Body language is another important component of communication. Gestures, facial expressions, and body
posture are often as important in communication (if not more) as the words.'); ?></p>
    ...
    <div id="lesson-2-slide-7" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li><?php echo t('Short-ter memory'); ?></li>
          <li><?php echo t('Long-term or remote memory'); ?></li>
          <li><?php echo t('Episodic memory'); ?></li>
          <li><?php echo t('Procedural memory'); ?></li>
        </ul>
        <h5><?php echo t('Types of Memory'); ?></h5>
        <p><?php echo t('There are different kinds of memory. Understanding them and how they work can help us to understand
some of the communication challenges faced by persons with dementia.'); ?></p>
        <p class="forum"><?php echo t('Search the Internet for examples or explanations on each of these listed types of memory. Post your findings to the Forum.'); ?></p>
        <p><?php echo t('It is important to understand the different types of memory so that we can see how impairment in these
...
have difficulty recalling recent events or may need more time to retrieve the information.'); ?></p>
        <p><?php echo t('Next, we are going to look at some of the changes that may occur with communication as memory
becomes impaired.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-8" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('Word finding refers to that tip of the tongue phenomenon that we all experience from time to time. We
know what we want to say but just cannot immediately find the word. People who have memory loss
experience this phenomenon to such a degree that it interferes with their ability to communicate.'); ?></p>
        <p><?php echo t('The comprehension of information often becomes impaired. The person may have a difficult time tracking
conversations or following instructions with more than one step.'); ?></p>
        <p><?php echo t('The person with memory loss is more likely to digress during conversations – jumping from the original
...
memory loss to repeat himself/herself, forgetting what has recently been said.'); ?></p>
        <p><?php echo t('Reading and writing may be affected. The person may have difficulty understanding written material or
may not be able to communicate clearly in writing.'); ?></p>
        <p><?php echo t('People with memory loss often have difficulty with abstract concepts. Many people have trouble with
...
not remember to whom he is speaking, or may not recall the conversation later.'); ?></p>
        <p class="forum"><?php echo t('What communication challenges with your relative have you noticed?'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-9" class="course-slide">
      <div class="content">
        ...
        <h5><?php echo t('More distracted by noise and/or motion'); ?></h5>
        <p><?php echo t('As memory becomes impaired, the person with memory loss may find that he has to concentrate very
hard in order to follow conversations. Anything that interferes with the ability to concentrate, e.g. noise or
movement, may make it even more difficult for the person.'); ?></p>
        <p class="forum"><?php echo t('If you want to have a conversation with a person with memory loss and you sense that she becomes easily distracted, what could you do? Record your response on the Forum.'); ?></p>
        <h5><?php echo t('Fear of making mistakes'); ?></h5>
        <p class="forum"><?php echo t('Has anyone here had the experience of burning something on the stove or the oven? Record that experience on the Forum.'); ?></p>
        <p><?php echo t('If you do something like that, others tend to write it off to having a bad day or being distracted, right? But
...
possible.'); ?></p>
        <h5><?php echo t('Attention problems may appear to be hearing loss'); ?></h5>
        <p><?php echo t('People who are distracted or who have difficulty concentrating may sometimes miss bits and pieces of a
...
conversation is happening in a place with few distractions.'); ?></p>
        <p class="forum"><?php echo t('So, what can we do to help overcome these challenges? Record your responses on the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-10" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li><?php echo t('Eliminate distractions'); ?></li>
          <li><?php echo t('Gain the person\'s attention'); ?></li>
          <li><?php echo t('Give reassurance'); ?></li>
          <li><?php echo t('Be a patient and active listener'); ?></li>
          <li><?php echo t('Be an astute observer'); ?></li>
          <li><?php echo t('Try not to challenge or correct mistakes'); ?></li>
          <li><?php echo t('Maintain a sense of humor'); ?></li>
        </ul>
        <p class="forum"><?php echo t('Using your own experience, or by searching the Internet, post on the Forum some examples using the above listed communicaition tips.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-11" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('As we discussed at the beginning of the lesson, nonverbal communication refers to the things that we do in addition to what we say. The most basic of these are tone of voice, body language, and facial expressions.'); ?></p>
        <p><?php echo t('We are all familiar with the saying, <i>"it is not what you say, but also how you say it."</i> We have all had experiences where we were put off by a person\'s tone of voice or facial expression, even if what they said was not really all that offensive.'); ?></p>
        <p><?php echo t('Nonverbal communication can be very important when having conversation with people with memory loss.'); ?></p>
        <p><?php echo t('We are going to take a little time to discuss this, because it is so important.'); ?></p>
        <p class="forum"><?php echo t('On the Forum, please post your responses to the following questions.'); ?></p>
        <ul class="forum">
        ...
        <p><?php echo t('Nonverbal communication becomes especially important when having a conversation with someone with memory loss. 
	  
	  '); ?></p>
        <p><?php echo t('	  
	  A calm tone of voice can reassure a person who is frustrated or anxious. It can also help to keep us calm. Our own anxiety and anger escalates when our voices get louder, and of course the person to whom we are talking becomes upset as well. As hard as it can be to do, keeping your voice tone calm, low, and reassuring can help to keep situations from getting out of control.'); ?></p>
        <p><?php echo t('Body language and facial expressions are other concerns. If your words are calm but your body language is
...
being said.'); ?></p>
        <p class="forum"><?php echo t('Think of a time when you talked to someone who you knew was not telling the truth. Their words may
have been convincing, but somehow you knew something was not right. How did you know this? What
gave them away? Post your responses to the Forum.'); ?></p>
        <p><?php echo t('The saying, <i>"it is not what you say; it is how you say it"</i> is important to remember in all forms of
communication, but especially when talking to someone with memory loss.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-12" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('Allow circumlocution - <i>talking around</i>'); ?></li>
          <li><?php echo t('Allow time for processing'); ?></li>
          <li><?php echo t('Keep conversations on track'); ?></li>
          <li><?php echo t('Enable ventilation - <i>letting off steam</i>'); ?></li>
          <li><?php echo t('Offer limited choices if needed'); ?></li>
        </ul>
        <p class="forum"><?php echo t('Search the Internet for examples or explanations using these listed verbal expressions. Post your findings to the Forum.'); ?></p>
        <p class="forum"><?php echo t('For example: What is your favorite color? is an open‐ended question. Think about all of the choices that we actually make when we answer this question. First of all, we need to remember the meaning of the word
color. Then, we need to remember what it means to have a favorite color. Next, we need to think of the whole palette of colors until we come to the one we like the best and we need to identify its name. So this can be a more complex process than you might imagine. What seems like a simple question, in fact, has many layers of decisions and things to think through in order to answer it correctly.'); ?></p>
        <p class="forum"><?php echo t('How can we simplfy this question? Post your response on the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-2-slide-13" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('Arguing'); ?></li>
          <li><?php echo t('Giving orders'); ?></li>
          <li><?php echo t('Oversimplying'); ?></li>
        </ul>
        <h5><?php echo t('Arguing'); ?></h5>
        <p><?php echo t('It is hard to win an argument with someone who is experiencing memory loss, because his or her view of
things may be very different from yours. Let\'s say that your Aunt Mae can’t remember having gone to a restaurant the day before, and is upset over the doggie bag in the refrigerator because she claims, “I did not put that there, and I’m not going to eat someone else’s leftovers!”'); ?></p>
        <p><?php echo t('Our natural inclination is to set things right and use facts to prove our point. But if the person truly does
not remember the experience of going to the restaurant, no amount of facts will change her mind. It won\'t help to pull out the calendar to show Aunt Mae that she wrote down 6 pm ‐ dinner at Andy’s Restaurant with Susan or showing her the receipt, or even showing her a matchbook from the restaurant. Aunt Mae does not remember the experience. For her it simply never happened.'); ?></p>
        <p><?php echo t('So arguing with her is going to frustrate both of you. Before arguing about something like this, you need to
stand back and ask yourself, Is this really worth it? If a person’s safety is at stake, the answer might be yes. But in a situation like this one, it may be better to say, I’ll just take this out of your refrigerator. You will have avoided a needless argument.'); ?></p>
        <h5><?php echo t('Giving orders'); ?></h5>
        <p><?php echo t('No one likes to be told what to do, especially by our spouses or other family members. There is a world of
difference between Joe! Will you take out the trash already? and Joe, I’d really appreciate it if you would take out the trash.'); ?></p>
        <p><?php echo t('Sometimes, people with memory loss do not respond to our requests the way we would like them to respond. We’ll talk about this more in Class 5, but breaking tasks down into smaller steps may be the key. Maybe Joe does not take out the trash because he can’t remember all of the steps involved in this task. He used to be in charge of recycling and separating everything, and now he gets confused by all of the containers. As a result, he avoids having anything to do with the trash. If you sense this is the problem, you need to give Joe a smaller task to accomplish. For instance, ask him to stack the newspapers and put them
in the recycling bin, rather than being responsible for separating and carrying out all of the trash.'); ?></p>
        <h5><?php echo t('Oversimplifying'); ?></h5>
        <p><?php echo t('The goal is to simplify only if needed, and without being condescending. In other words, simplify when necessary and do not dumb down. People with early memory loss may be very sensitive to the feeling that they are being treated as a child, or disrespectfully.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-2-slide-15" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('Coping with Communication Challenges in Alzheimer’s Disease by Marie T. Rau, San Diego, CA: Singular Publishing Company, 1993.'); ?></li>
          <li><?php echo t('My Journey into Alzheimer’s Disease by Robert Davis. Carol Stream, lL: Tyndale House Publishers, 1989.'); ?></li>
          <li><?php echo t('Steps to Enhancing Communication: Interacting with Persons with Alzheimer’s Disease (brochure) available through the Alzheimer’s Association.'); ?></li>
        </ul>
        <h4><?php echo t('Closing'); ?></h4>
        <h5><?php echo t('In this module, we have learned:'); ?></h5>
        <ul>
        ...
        <p><?php echo t('For more ideas about communication strategies, please refer to chapters 5 and 8 of the book, <i>Alzheimer\'s Early Stages</i>. Chapter 5 is especially helpful in understanding the communication challenges faced by persons with memory loss. If possible, read these chapters during the coming week.'); ?></p>
      </div>
      <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> <?php echo t('Complete Lesson'); ?></a></div>
    </div>
  </div>
  <div id="lesson-3">
    <div id="lesson-3-slide-1" class="course-slide">
      <div class="content">
        ...
        <div id="question1" class="question">
          <p><b><?php echo t('There are different kinds of memory. Understanding them can help us to understand some of the communication challenges faced by persons with dementia.'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('True'); ?> </option>
              <option value="0"> <?php echo t('False') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t('Correct!'); ?> </p>
          <p class="wrong-answer hide"> <?php echo t('Incorrect. Please review module two.') ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Start Course &raquo;'); ?></a></div>
    </div>
    <div id="lesson-3-slide-2" class="course-slide">
      <div class="content">
        ...
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/135545925.png'); ?>" alt="image">
        <p><?php echo t('Welcome to the third module of MSML Online.'); ?></p>
        <p class="forum"><?php echo t('Before you begin, post any questions or comments related to module two, "Communication Strategies", to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Module Three: Making Decisions'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/100640358.png'); ?>" alt="image">
        <h5><i><?php echo t('"Not to decide is to decide."'); ?></i></h5>
        <p><?php echo t('In this module, we go into depth about the changes that occur in the relationship between you and your
relative as a result of memory loss. Your role gradually must change so that you become the chief decision maker
in the relationship.'); ?></p>
        <p class="forum"><?php echo t('Are you the cheif decision maker in your household? Post your response to the Forum'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-4" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('Preserve independence and meet dependence'); ?></li>
          <li><?php echo t('Make decisions - along or together'); ?></li>
          <li><?php echo t('Quietly take the lead as if a great dancer'); ?></li>
        </ul>
        <h5><?php echo t('Preserve independence and meet dependence'); ?></h5>
        <p><?php echo t('When you begin to recognize the limits of your relative’s memory and thinking abilities, you become
...
dependence. This requires much tact and patience in making decisions.'); ?></p>
        <p class="forum"><?php echo t('Let’s consider the following example:'); ?></p>
        <p class="forum"><?php echo t('Your 81‐year‐old mother has Alzheimer’s disease and lives alone. One day she says that you are
...
what is best for me. I’m not a child just because I can’t do what I used to do.'); ?></p>
        <p class="forum"><?php echo t('How might you address her complaint? Take about 5 minutes to brainstorm a solution that is satisfactory to both parties, and post your response to the Forum.'); ?></p>
        <h5><?php echo t('Making decisions – alone or together'); ?></h5>
        <p><?php echo t('Instead of involving someone with memory loss in every decision and run the risk of causing confusion, it is
...
decisions like what furniture to keep or discard.'); ?></p>
        <h5><?php echo t('Quietly take the lead as if a great dancer'); ?></h5>
        <p><?php echo t('One way to visualize the lead role you must now take is to consider a couple engaged in ballroom dancing.
...
cooperation of the other person.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-5" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Cartoon of a young and old woman:'); ?></h2>
        <hr />
        <p><i><?php echo t('Honey, I have been through two world wars, the Great Depression, taught 3,297 children, administered four elementary schools and outlived every one of the people I worked with. I am 89 years old and you are telling me it is bedtime?'); ?></i></p>
        <p><?php echo t('These two people are clearly not in harmony. This scene typifies the universal need for control over one’s
...
choices must be given so that conflicts can be prevented.'); ?></p>
        <p class="forum"><?php echo t('How might this particular scenario have been played out differently? Take a few minutes for ideas, and post your response to the Forum.'); ?></p>
        <p><?php echo t('Now let\'s turn to handling some practical issues…'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-6" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('Mixed results of research studies thus far'); ?></li>
          <li><?php echo t('No clear markers for risk of accidents'); ?></li>
          <li><?php echo t('No disease specific public policy in most states'); ?></li>
          <li><?php echo t('Personal freedom versus public safety'); ?></li>
          <li><?php echo t('Voluntary versus involuntary ways to restrict or stop driving'); ?></li>
        </ul>
        <p><?php echo t('Driving a car is not only a means of getting around but is also a symbol of personal independence. AD often impairs brain functions that affect driving ability but sometimes those functions are spared so that, for a while, driving may continue without difficulty.'); ?></p>
        <p class="forum"><?php echo t('Search the Internet and find examples or explanations for each of the listed  items above, and post your findgins to the Forum.'); ?></p>
        <p><?php echo t('A number of rehabilitation centers have specially trained staff members, usually occupational therapists,
...
action before a decision is reached.'); ?></p>
        <p><?php echo t('The privilege of driving is so terribly important for some people that taking it away may harm the selfesteem
...
seniors? Is your family prepared to take on the “chauffeur” role?'); ?></p>
        <p><?php echo t('If persuasion alone is insufficient to keep an unsafe driver off the road, taking action through the state
department of motor vehicles to revoke that person’s license may be the only alternative. Other options
are to disable the car or get rid of it altogether.'); ?></p>
        <p class="forum"><?php echo t('Please share a story about you have addressed the issue of driving your their family, on the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-7" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p><i><?php echo t('When I die, I want to go peacefully, like my grandfather did, in his sleep; not sreaming like the other passengers in his car.'); ?></i></p>
        <p><?php echo t('This humorous quote illustrates the serious consequences of unsafe driving. It is better to err on the side
of safety when considering whether or not a person with memory loss should continue driving. Again, the
issue of personal freedom versus public safety must be carefully weighed.'); ?></p>
        <ul>
          <li><?php echo t('Capacity exists unles given up voluntarily'); ?></li>
          <li><?php echo t('Personal freedom versus risk of exploitation'); ?></li>
          <li><?php echo t('Mismanagement of money and medications'); ?></li>
          <li><?php echo t('Means to share or give up authority'); ?></li>
        </ul>
        <h5><?php echo t('Capacity exists unless given up voluntarily'); ?></h5>
        <p><?php echo t('Making personal decisions over one’s health and financial affairs is a personal right that is threatened by
memory loss. Assessing when and how to intervene is difficult unless the person with memory loss
voluntarily gives up this authority.'); ?></p>
        <h5><?php echo t('Personal freedom versus risks'); ?></h5>
        <p><?php echo t('As memory loss advances over time, the risks of continuing to manage one\'s own affairs will become more obvious to others, but in the early stage there may be legitimate differences of opinion about the person’s ability to handle these affairs alone.'); ?></p>
        <p><?php echo t('Nevertheless, due to the person\'s impaired memory and judgment, someone else must be in a position of
monitoring risks. Otherwise, problems such as failing to pay important bills can emerge.'); ?></p>
        <h5><?php echo t('Mismanagement of finances and medical compliance'); ?></h5>
        <p><?php echo t('What are some of the risks? Persons with memory loss can lose track of money or stop paying bills. They may also be at risk of exploitation by others. They can forget to take their medication(s), take too much or too often, all of which can lead to a health crisis.'); ?></p>
        <p><?php echo t('It is fairly easy to assess if someone with memory loss is having trouble with managing finances or taking medication. It is important to raise these issues in a delicate manner in order to maintain trust and enlist the person\'s cooperation.'); ?></p>
        <p class="forum"><?php echo t('Please share a story on this topic by posting it to the Forum.'); ?></p>
        <h5><?php echo t('Means to share or give up authority'); ?></h5>
    ...
    <div id="lesson-3-slide-8" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('Generally, the ability to handle personal care tasks like bathing and dressing remain intact in the early
...
meal or fixing a broken appliance are often problematic.'); ?></p>
        <p><?php echo t('Anything requiring a prescribed sequence of steps for completion may be disrupted due to memory loss. As a result, the person with memory loss tends to avoid new or unfamiliar tasks that require learning or memory beyond their capacity to be successful.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-9" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('Like anything unfamiliar, traveling to new or different places may be more stressful, but should not be
...
precautions should be taken to minimize the chance of becoming lost.'); ?></p>
        <p class="forum"><?php echo t('What are some steps that might be taken to prevent or minimize confusion? With proper planning, how might you handle a crisis such as the person with memory loss getting lost while away from home? Post your responses to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-3-slide-11" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('History re-emerges, for better or worse'); ?></li>
          <li><?php echo t('Uneven division of labor among members'); ?></li>
          <li><?php echo t('Roles are often unclear'); ?></li>
          <li><?php echo t('Different levels of acceptance/denial'); ?></li>
        </ul>
        <p><?php echo t('Although major responsibility of caring for a loved one with memory loss often falls on the shoulders of
just one person, other family members living locally or at a distance and have their own personal reactions to the situation.'); ?></p>
        <h5><?php echo t('History re‐emerges, for better or worse'); ?></h5>
...
depends largely on that family’s past experience.'); ?></p>
        <h5><?php echo t('Uneven division of labor among members'); ?></h5>
        <p><?php echo t('As already noted, one family member usually assumes most responsibilities of caring for someone.
...
action or gladly accept assigned duties whereas others might refuse to help.'); ?></p>
        <p class="forum"><?php echo t('Search the Internet for examples or explanations for the third and fourth above listed bullet points, and post your findings to the Forum.'); ?></p>
        <p class="forum"><?php echo t('Has anyone here been involved in a family meeting? Please share the details on the Forum.'); ?></p>
        <p class="forum"><?php echo t('Search the Internet for handouts or downloadable forms that help organzie family meetings. Please share your results on the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-12" class="course-slide">
      <div class="content">
        ...
        <table>
          <tr>
            <th><p><?php echo t('Pros'); ?></p></th>
            <th><p><?php echo t('Cons'); ?></p></th>
          </tr>
          <tr>
            <td><ul>
            ...
            <td><ul>
                <li><?php echo t('<i>“What they do not know won\'t hurt them”</i>'); ?></li>
        ...
        <p class="forum"><?php echo t('On the Forum, list some reasons on the pro-side and the con-side.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-13" class="course-slide">
      <div class="content">
        ...
        <hr />
        <ul>
          <li><?php echo t('Rally your supporters'); ?></li>
          <li><?php echo t('Accept hibernators'); ?></li>
          <li><?php echo t('Enlighten armchair quarterbacks'); ?></li>
        </ul>
        <h5><?php echo t('Rally your supporters'); ?></h5>
        ...
        <h5><?php echo t('Accept hibernators'); ?></h5>
...
security of their own lives. For whatever reasons, they cannot or will not play a supportive role.'); ?></p>
        <p><?php echo t('Trying to engage hibernators seldom succeeds despite your repeated efforts. It is difficult to understand them and avoid harsh judgment. However, bitterness and resentment can become self‐destructive. It may not be possible to forgive hibernators for their lack of help, yet it is essential to forget counting on them. Appreciating the efforts of those who are involved will contribute to your well‐being.'); ?></p>
        <h5><?php echo t('Enlighten armchair quarterbacks'); ?></h5>
        <p class="forum"><?php echo t('Can you define the term, "<i>armchair quarterback?</i>" Post your answer to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-14" class="course-slide">
      <div class="content">
        ...
        <ul>
          ...
          <li><?php echo t('Show appreciation for the concern and help provided; and'); ?></li>
          <li><?php echo t('Develop new relationships by attending support groups, finding others who can relate with your
situation.'); ?></li>
        </ul>
        <div id="question1" class="question">
          <p><b><?php echo t('Positive peer pressure can be one of the most powerful motivators around.'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('True'); ?> </option>
              <option value="0"> <?php echo t('False') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t('Correct!'); ?> </p>
          <p class="wrong-answer hide"> <?php echo t('Incorrect. Please search the Internet for examples of how to get others involved.') ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-15" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li><?php echo t('The relationship has changed -- I now lead it'); ?></li>
          <li><?php echo t('I must change, not the person with the disease'); ?></li>
          <li><?php echo t('I can learn how to cope effectively'); ?></li>
          <li><?php echo t('I have limits and mistakes will be made'); ?></li>
          <li><?php echo t('My own well-being is important too'); ?></li>
          <li><?php echo t('I must reach out and accept the help of others'); ?></li>
        </ul>
        <p><?php echo t('Based on our experience with family members and friends of people with memory loss, we have identified
...
way. These statements appear to be signs of healthy coping.'); ?></p>
        <p class="forum"><?php echo t('Search the Internet for examples or explanations of the above listed major milestones, and post your findings on the Forum'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-3-slide-16" class="course-slide">
      <div class="content">
        ...
        <h4><?php echo t('Closing'); ?></h4>
        <p><?php echo t('We have just finished module three'); ?></p>
        <p class="forum"><?php echo t('Please post any questions about this module to the Forum.'); ?></p>
        <p><?php echo t('Contact your class leader in order to address specific issues that did not get answered on the Forum. Chapters 6 and 7 in the book, <i>Alzheimer\'s Early Stages</i>, relate to this class. Please read those chapters for more information about the issues we covered today. Next module will focus on planning for the future. Thanks your for participating.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> <?php echo t('Complete Lesson'); ?></a></div>
    </div>
  </div>
  <div id="lesson-4">
    <div id="lesson-4-slide-1" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Module Four: Planning for the Future'); ?></h2>
        <hr />
        <p><?php echo t('Welcome to the fourth module. We are glad you continued to participate. The title of this module is <i>Planning for the Future</i>. In our previous modules we touched on changes that impact the person experiencing memory loss, as well as challenges to those providing care: family members, friends, and professionals.'); ?></p>
        <p><?php echo t('Please contact your class leader if your needs and questions are not being addressed. We have a great deal of information to cover in this module. To best utilize your time here, be sure that your informational needs and questions are addressed.'); ?></p>
        <p class="forum"><?php echo t('Please post a response if you are interested in learning more about the following module purposes:'); ?></p>
        <h4><?php echo t('Purposes'); ?></h4>
        <ul>
    ...
    <div id="lesson-4-slide-2" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Communicating with Healthcare Professionals'); ?></h2>
        <hr />
        <h5><?php echo t('You are an advocate; Physicians are your consultants'); ?></h5>
        <p><?php echo t('Frequent and effective communication with your loved one’s physician is a necessity. View yourself as an
...
will allow you the freedom to provide an update on any changes you wish to discuss privately.'); ?></p>
        <h5><?php echo t('Prepare for visits'); ?></h5>
        <p><?php echo t('Put your questions in writing ahead of time and ask for what you need and be direct.'); ?></p>
        <h5><?php echo t('Ask questions'); ?></h5>
        <p><?php echo t('Ask questions about the disease, medications, or other instructions that are unclear to you.'); ?></p>
        <p class="forum"><?php echo t('Forum Posting: What kind of questions might you be interested in having answered? Take a few minutes befor you respond.'); ?></p>
        <h5><?php echo t('Shop around if dissatisfied'); ?></h5>
        <p><?php echo t('Unfortunately, not all physicians are knowledgeable about AD and related dementias. The Alzheimer\'s Association or other organizations can assist you in finding a specialist.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Using Advanced Directives'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/152177237.png'); ?>" alt="image">
        <ul>
          <li><?php echo t('Durable Power of Attorney: For Healthcare and Property'); ?></li>
          <li><?php echo t('Living Wills'); ?></li>
          <li><?php echo t('Living Trusts'); ?></li>
          <li><?php echo t('Other legal tools: Guardianship of the Estate Person'); ?></li>
        </ul>
        <p><?php echo t('It is never too early to begin legal and financial planning. Doing so can allow you to involve the person with memory loss in decision‐making. For many families, legal and financial issues are not easy to discuss. If you are an adult child, it is common that these issues may be handled or discussed independently from you. Early planning can often make an emergency situation easier to handle, such as a sudden hospitalization.'); ?></p>
        <p class="forum"><?php echo t('Searching the Internet to help you define the above listed types of advance directives, and post your findings to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-4" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Who Can Assist with Legal Planning?'); ?></h2>
        <hr />
        <ul>
          <li><?php echo t('National Academy of Elder Law Attorney website'); ?></li>
          <li><?php echo t('Local Bar Associations'); ?></li>
          <li><?php echo t('Non-Profit Legal Agencies'); ?></li>
        </ul>
        <p><?php echo t('An attorney who is well versed in elder law can best assist you in legal planning. The National Academy of Elder Law Attorneys is a non‐profit organization assisting lawyers, bar associations and those who work with older clients and their families. By visiting their website, you can locate attorneys nearest you. Nonprofit legal agencies also provide legal council to families, and often offer financial assistance or reduced rates.'); ?></p>
        <p class="forum"><?php echo t('You may know of elder law attorneys and non‐profit legal agencies in your local area. Prepare a list and post it to the Forum.'); ?></p>
        <p><?php echo t('Again, this next section is meant as an overview only. Cover the basic information and refer participants to the Medicare website, Centers for Medicare & Medicaid Services website and their local Social Security Administration office for more detailed information about Medicare and Medicaid.'); ?></p>
        <ul>
          <li><a href="http://www.medicare.gov" target="_blank"><?php echo t('Medicare.gov'); ?></a></li>
          <li><a href="http://www.ssa.gov" target="_blank"><?php echo t('Social Security Administration website'); ?></a></li>
          <li><a href="http://medicaid.gov" target="_blank"><?php echo t('Medicaid.gov'); ?></a></li>
        </ul>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-5" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Understanding Medicare - A health insurance program'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/medicareScreenShot.png'); ?>" alt="image">
        <ul>
          <li><?php echo t('Part A - covers inpatient hospital, skilled nursing, hospice, long-term acute care, and home health services'); ?></li>
          <li><?php echo t('Part B - covers outpatient medically necessary services and preventive services'); ?></li>
          <li><?php echo t('Part C - are Medicare Advantage Plans offered by private companies that contract with Medicare to cover Part A and B benefits'); ?></li>
          <li><?php echo t('Part D - covers prescription drugs'); ?></li>
        </ul>
        <p><?php echo t('Medicare is a national health insurance program administered by the federal government that guarantees
health insurance for people age 65 or older, people under age 65 with certain disabilities, and people of all
ages with end‐stage renal disease (permanent kidney failure requiring dialysis or a kidney transplant).'); ?></p>
        <p class="forum"><?php echo t('Search the Internet, and post the descriptions of the various parts of Medicare.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-6" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Who Can Answer Questions About Medicare?'); ?></h2>
        <hr />
        <ul>
          <li><?php echo t('The Centers for Medicare and Medicaid Services website'); ?></li>
          <li><?php echo t('The Medicare website'); ?></li>
          <li><?php echo t('Phone 800-MEDICARE (US Only)'); ?></li>
        </ul>
        <p><?php echo t('The Centers for Medicare and Medicaid Services (CMS) can answer questions about Medicare and help
...
Medicare enrollment, benefits, and other helpful tools.'); ?></p>
        <p><?php echo t('You may also search the CMS website for their guide titled: <i>Medicare and You</i>, an outline of the Medicare program that includes up‐to‐date information regarding eligibility and costs, such as deductibles and copays.'); ?></p>
        <div id="question1" class="question">
          <p><b><?php echo t('Medicare Part A (Hospital Insurance) helps cover inpatient care in hospitals, as well as skilled nursing facility, hospice, and home health care.'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('Yes'); ?> </option>
              <option value="0"> <?php echo t('No') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t("Correct! Medicare Part A is hospital insurance."); ?> </p>
          <p class="wrong-answer hide"> <?php echo t("Incorrect. Please ensure you understand the various parts of Medicare before conintuing."); ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-7" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Understanding Medicaid'); ?></h2>
        <hr />
        <p><?php echo t('       
...
provide other optional benefits.'); ?></p>
        <p><?php echo t('Federal law also requires states to cover certain mandatory eligibility groups, including qualified parents,
...
expand coverage before this date.'); ?></p>
        <p class="forum"><?php echo t('Search the CMS website to help you post responses to the following questions:'); ?></p>
        <ul class="forum">
          <li><?php echo t('How do you get Medicaid?'); ?></li>
          <li><?php echo t('What does Medicaid cost?'); ?></li>
          <li><?php echo t('What does Medicaid cover?'); ?></li>
          <li><?php echo t('How does the Affordable Care Act expand options for community-based care?'); ?></li>
        </ul>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-8" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Who can answer questions about Medicaid?'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/139539392.png'); ?>" alt="image">
        <ul>
          <li><?php echo t('State agencies administering Medicaid'); ?></li>
          <li><?php echo t('The CMS website'); ?></li>
          <li><?php echo t('Phone 800-MEDICARE (US Only)'); ?></li>
        </ul>
        <p><?php echo t('The Centers for Medicare and Medicaid Services can also answer questions about Medicaid. You can contact them by phone or through their website. You may also contact your State Agency that administers Medicaid.'); ?></p>
        <p class="forum"><?php echo t('Search the Internet for the contact information of the State Agency responsible for administering Medicaid in your area, and post your findings to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-9" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Respite Care Options'); ?></h2>
        <hr />
        <ul>
          <li><?php echo t('Informal or Volunteer Respite Care'); ?></li>
          <li><?php echo t('Adult Day Services'); ?></li>
          <li><?php echo t('In-Home Services'); ?></li>
          <li><?php echo t('Short-Term Residential Care'); ?></li>
        </ul>
        <p><?php echo t('These are several types of respite options that may be available to you,'); ?></p>
        <p class="forum"><?php echo t('Search the Internet for examples or an explanation for each of the above listed respite care options, and post your findings to the Forum'); ?></p>
        <p><?php echo t('An adult daughter shared her story of the struggles she encountered in getting her father to attend an
adult day center. Each morning, her father would grumble, curse, and occasionally become combative.
When she would pick her father up at the end of the day, he was often agitated.'); ?></p>
        <p><?php echo t('She would ask, <i>“How was your day, Dad?”</i> and he would reply with disparaging remarks about the program and staff. However, when she would speak with the staff she would receive a positive and reassuring account of the day\'s activities. Her father would take part in activities, including baking with a majority of female participants, and would sing along with an exuberant voice whenever guests came to play the guitar or piano.'); ?></p>
        <p><?php echo t('With this in mind, she was able to feel much better about bringing her father to the center each day. Has anyone had the experience of enrolling a relative in an adult day program?'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-10" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Evaluating Respite Programs'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/145924457.png'); ?>" alt="image">
        <ul>
          <li><?php echo t('Licensed program (where required)'); ?></li>
          <li><?php echo t('Qualifications and training of caregivers'); ?></li>
          <li><?php echo t('Costs/what services are included'); ?></li>
          <li><?php echo t('Supervisoin of caregivers'); ?></li>
          <li><?php echo t('Handling emergencies'); ?></li>
        </ul>
        <p><?php echo t('When evaluating a respite program, there are several questions to ask:'); ?></p>
        <ul>
          <li><?php echo t('Is the program licensed (where required)?'); ?></li>
          <li><?php echo t('Do caregivers have the qualifications necessary for the job? How are they screened?'); ?></li>
          <li><?php echo t('How are caregivers trained and how do they receive regular updates to improve care?'); ?></li>
          <li><?php echo t('May family members interview and be part of the decision to hire caregivers?'); ?></li>
          <li><?php echo t('Is transportation provided for the caregiver/older adult?'); ?></li>
          <li><?php echo t('What is the cost of respite and what is included in the cost?'); ?></li>
          <li><?php echo t('How are caregivers supervised and evaluated?'); ?></li>
          <li><?php echo t('How do caregivers handle emergencies?'); ?></li>
        </ul>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-11" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Community-Based Programs and Services'); ?></h2>
        <hr />
        <h5><?php echo t('Alzheimer\'s Association - '); ?></h5>
        <p><?php echo t('The Alzheimer\'s Association works on a global, national and local level to enhance care and support for all those affected by Alzheimer\'s and related dementias.'); ?></p>
        <p><?php echo t('The Alzheimer\'s Association works on a global, national and local level to enhance care and support for all
...
'); ?></p>
        <ul>
          <li><?php echo t('Have local chapters across the nation, providing services within each community.'); ?></li>
          <li><?php echo t('Professionally staffed 24/7 Helpline (U.S. 800‐272‐3900) offers information and advice to more than 250,000 callers each year and provides translation services in more than 170 languages.'); ?></li>
          <li><?php echo t('They run more than 4,500 support groups throughout the country and connect people across the
globe through our online message boards.'); ?></li>
          <li><?php echo t('They provide caregivers and families with comprehensive online resources and information
through our Alzheimer\'s and Dementia Caregiver Center, which features sections on early‐stage,
middle‐stage and late‐stage caregiving.'); ?></li>
          <li><?php echo t('They help people find clinical trials through our free service Alzheimer’s Association TrialMatch,
which makes it easy to search opportunities based on personal criteria.'); ?></li>
          <li><?php echo t('They deliver 20,000 education programs annually and offer online information in 17 languages.'); ?></li>
          <li><?php echo t('Their free online tool, Alzheimer\'s Navigator, provides individuals with Alzheimer\'s and their
caregivers with step‐by‐step guidance and customized action plans, and our online Community Resource Finder provides instant access to community resources and services.'); ?></li>
          <li><?php echo t('They house the Alzheimer\'s Association Green‐Field Library, the nation\'s largest library and
resource center devoted to increasing knowledge about Alzheimer\'s disease and related dementias.'); ?></li>
          <li><?php echo t('Their safety services, Comfort Zone and MedicAlert® + Alzheimer’s Association Safe Return®,
provide location management for people with Alzheimer’s who wander.'); ?></li>
          <li><?php echo t('Their annual Walk to End Alzheimer\'s is the nation\'s largest event to raise awareness and funds
for Alzheimer\'s care, support and research.'); ?></li>
        </ul>
        <p class="forum"><?php echo t('Search the Internet for your local chapter and contact information. This information can be found
on the Alzheimer\'s Association’s website. Also, there may be other organizations in your area that offer similar programs and services. Post your findings on the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-12" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Other Related Programs and Services'); ?></h2>
        <hr />
        <ul>
          <li><?php echo t('Administration on Aging - Serves the growning senior population'); ?></li>
          <li><?php echo t('Department of Veterans Affairs'); ?></li>
          <li><?php echo t('National (888) 222-VETS (US only)'); ?></li>
        </ul>
        <p><?php echo t('The Administration on Aging has designated a network of Area Agencies on Aging (AAAs) throughout the
...
programs and services to persons age 60 and older. Some of the programs include:'); ?></p>
        <ul>
          <li><?php echo t('Older American Act & the Aging Network;'); ?></li>
          <li><?php echo t('Home & Community Based Long‐Term Care;'); ?></li>
          <li><?php echo t('Health, Prevention, and Wellness Program;'); ?></li>
          <li><?php echo t('Elder Rights Protection;'); ?></li>
          <li><?php echo t('Special Projects; and'); ?></li>
          <li><?php echo t('Tools/Resources for Professionals.'); ?></li>
        </ul>
...
800‐677‐1116) or Administration on Aging website can help you find this information.'); ?></p>
        <p><?php echo t('Originally established as an independent agency in 1930 and elevated to cabinet level in 1989, the
...
more than 100 cemeteries throughout the United States.'); ?></p>
        <p class="forum"><?php echo t('Class leaders should provide contact information for local Veterans’ Service Centers.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-13" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Choosing Residential Care'); ?></h2>
        <hr />
        <ul>
          <li><?php echo t('Considering a Move'); ?></li>
          <li><?php echo t('Weigh advantages and disadvantages'); ?></li>
          <li><?php echo t('Preparing the person with memory loss'); ?></li>
        </ul>
        <p><?php echo t('In their book, <a href="http://www.amazon.com/Moving-Relative-With-Memory-Loss/dp/0970760914" target="_blank">Moving a Relative with Memory Loss: A Family Caregiver\'s Guide</a>, authors Laurie White and Beth Spencer share their many years of experience working with families struggling with the decision to move a family member.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/logo04.jpg'); ?>" alt="image">
        <p><?php echo t('Making the decision to move a family member with memory loss to a new home, whether it is your home,
an assisted living facility, or nursing home, is not easy. An emergency situation or crisis often opens our eyes to a loved one\'s increased care needs. Even if you do not think that a move is imminent, looking into different residential care options now is a good idea. That way, if and when the time comes for a move, you have done your homework and will have an idea of what places would be a good fit for your family member. If possible, taking your family member on the tours is helpful, as he/she can offer their opinions of the places you are considering.'); ?></p>
        <p><?php echo t('Of course, your family may decide that you would prefer to keep your family member in his/her home as long as possible. There are advantages and disadvantages to this.'); ?></p>
        <p class="forum"><?php echo t('Can you think for a moment about some advantages and disadvantages? List your responses on the Forum'); ?></p>
        <p><?php echo t('It is important for families to weigh the advantages and disadvantages, while keeping in mind the best interest of the person with memory loss.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-4-slide-14" class="course-slide">
      <div class="content">
        ...
        <h4><?php echo t('Closing'); ?></h4>
        <p class="forum"><?php echo t('Please post any questions to the Forum.'); ?></p>
        <p><?php echo t('As usual, post any specific concerns you may have to the Forum. Your supplemental reading, in the companion book, includes Chapters 9 and 12. These chapters cover the material we covered today in greater detail.
Thank you for participating. The next module is the final one, and we will discuss <i>Effective Ways of Coping and Caring</i>. We look forward to your participation.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> <?php echo t('Complete Lesson'); ?></a></div>
    </div>
  </div>
  <div id="lesson-5">
    <div id="lesson-5-slide-1" class="course-slide">
      <div class="content">
        ...
        <h4><?php echo t('Purposes'); ?></h4>
        <ul>
          <li><?php echo t('Discuss the importance of doing things'); ?></li>
          <li><?php echo t('Consider the impact the environment can have on participation in activities and tasks for a person experiencing memory loss'); ?></li>
          <li><?php echo t('Learn how to analyze and adapt tasks and activities'); ?></li>
          <li><?php echo t('Review key points of the MSML Online course'); ?></li>
        </ul>
        <div id="question1" class="question">
          <p><b><?php echo t('Medicare is a health insurance program; parts, A, B, C and D.'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('Yes'); ?> </option>
              <option value="0"> <?php echo t('No') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t("Correct! Good job!"); ?> </p>
          <p class="wrong-answer hide"> <?php echo t("Incorrect. Please ensure you understand the various parts of Medicare before conintuing."); ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    ...
    <div id="lesson-5-slide-2" class="course-slide">
      <div class="content">
        ...
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/135545925.png'); ?>" alt="image">
        <p><?php echo t('Welcome to the fifth and final module of MSML Online. We are glad to see your continued participation.'); ?></p>
        <p><?php echo t('In this module, we will focus on effective ways of coping and caring. We will first learn about one of the most effective ways of coping activity. In its purest form, activity means <i>doing</i>. For the first half of the module,
we will:'); ?></p>
        <ul>
          <li><?php echo t('Discuss the importance of <i>doing</i>'); ?></li>
    ...
    <div id="lesson-5-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Recognize the importance of <i>doing</i> in your life &amp; in the life of your family member'); ?></h2>
        <hr />
        <p><?php echo t('Think about when you meet someone new. What do you talk about? The first thing you do is probably
exchange names and a few pleasantries. As the conversation continues, however, you probably begin to talk about what you do – your occupation, hobbies, and interests. What we do is important to us and helps other people understand us.'); ?></p>
        <p class="forum"><?php echo t('Think of your own life. What things do you enjoy doing? Post your responses on the Forum.'); ?>
        <p class="forum"><?php echo t('After reviewing your Personal Activity List, to take two minutes to make a list of a few things that they really enjoy doing – things you feel improve your quality of life. Post that new list to the Forum.'); ?></p>
        <p class="forum"><?php echo t('Now, look at your list. Imagine what your life would be like if you were no longer able to do these things. How would you feel? Allow a short time to reflect, then post your responses to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-4" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('I would feel...'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/113558101.png'); ?>" alt="image">
        <p><?php echo t('Activity, or doing things, is an important consideration in terms of quality of life for all people, but
...
simply stop doing the activities they enjoyed doing and may experience some of the feelings listed here.'); ?></p>
        <p><?php echo t('When we talk about <i>activities</i> in this context, we do not only mean leisure and recreational pursuits, but
every interaction that we have daily with other people or with our environment.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-5" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Structuring the day through meaningful activity'); ?></h2>
        <hr />
        <h5><?php echo t('Activity: Any interaction between an individual and the environment'); ?></h5>
        <p><?php echo t('       
        We are all creatures of habit; we tend to have a pattern to our days. This routine is important to us and
...
some getting used to.'); ?></p>
        <p><?php echo t('With memory loss, having a predictable pattern to the day, or a particular routine when doing things, can
...
familiarity and comfort.'); ?></p>
        <p class="forum"><?php echo t('Think about your own typical day. What are some of the routines that you engage in every day? Post your responses to the Forum.'); ?></p>
        <p><?php echo t('Have the group brainstorm about this. You may need to start the discussion by giving an example of
...
person with memory loss may have a particularly difficult time with a change in routine.'); ?></p>
        <p><?php echo t('
Some people with early memory loss describe the difficulty they have in changing their routines or
switching from one activity or event to another. The person may feel that she needs to finish the first
activity completely before going on to the next so as to not leave a project half done.'); ?></p>
        <p class="forum"><?php echo t('Has your family member or friend ever had difficulty with sudden changes to routine? What do you think you might be able to do to make transitions from one event to another easier? What daily activities seem
to be important to your family member/friend, and what do you do to accommodate them? Post your responses to the Forum.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-6" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('5. Find a Confidante'); ?></h2>
        <hr />
        <p><?php echo t('Life does not end when a family member is diagnosed with a memory disorder. There are still plenty of
opportunities for you and your family member/friend to enjoy one another\'s company, and yes, even have fun!'); ?></p>
        <p><?php echo t('Families and friends may want to make note of situations and events that the person with memory loss enjoys. If the person with memory loss is able to have a successful experience, then you can make every effort to include that experience in his or her routine. On the other hand, if the person clearly cannot tolerate an activity, make a note to avoid that situation in the future. For example, a person who once loved large family get‐togethers may find these overwhelming; a better option may be to visit with family and friends in smaller, more intimate groups.'); ?></p>
        <p class="forum"><?php echo t('Let\'s take a moment to think about this. On the Forum create a two columns posting. On one side, post a few things that your family member enjoys doing on his/her own. On the other side, post down a few things that you enjoy doing together. Ater that, post your response to the following questions:'); ?></p>
        <ul class="forum">
          <li><?php echo t('How often are you able to do these things?'); ?></li>
          <li><?php echo t('What opportunities does your family member/friend have to engage in his/her preferred activities?'); ?></li>
        </ul>
        <p><?php echo t('Please keep these lists. Think about them later and maybe even add items as they come to mind.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-7" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Task Analysis'); ?></h2>
        <hr />
        <h5><?php echo t('Breaking an activity down into its smallest possible steps'); ?></h5>
        <p><?php echo t('Even people experiencing mild memory loss occasionally have the experience of getting lost in an activity –
losing their place and becoming confused about what to do next. This can be frightening and confusing to
friends and family as well as to the person with memory loss.'); ?></p>
        <p><?php echo t('We can help by anticipating places where the person may become confused and offering cues to help the person accomplish the task independently.'); ?></p>
        <p><?php echo t('People with normal memory are able to look at a task like teeth brushing or getting dressed in the morning
...
steps.'); ?></p>
        <h5><?php echo t('Task Analysis Exercise'); ?></h5>
        <p class="forum"><?php echo t('On the Forum, list all the tasks of breaking down the activity of making toast. Think about every step along the way, no matter how small or inconsequential it seems.'); ?></p>
        <p class="forum"><?php echo t('For example, before getting the bread, you need to remember that the bread is in the kitchen and where it is kept. So step number one may actually be walking to the kitchen. Please think through all of the steps.'); ?></p>
        <p><?php echo t('This exercise is to help us understand why the simple tasks we take for granted can sometimes seem
...
experiencing memory loss may have difficulty remembering all of the steps or may get off track.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-8" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Making Adaptations'); ?></h2>
        <hr />
        <ul>
          <li><?php echo t('Simplify activities'); ?></li>
          <li><?php echo t('Offer supervision'); ?></li>
          <li><?php echo t('Do a little at a time'); ?></li>
          <li><?php echo t('Look for new alternatives'); ?></li>
        </ul>
        <p><?php echo t('Sometimes we may find that a person with memory loss has difficulty doing activities that she used to enjoy. This does not necessarily mean they need to stop engaging in that activity altogether – adapting the activity may be a better alternative.'); ?></p>
        <p><?php echo t('Let\'s take Ted as an example. Ted always enjoyed gardening. Last week his wife, Mary, found Ted in the
shed, staring at his garden tools and looking confused. Mary asked Ted <i>what was wrong</i> and he said, <i>I
need to pull weeds but I do not remember what I am supposed to use to do that.</i>'); ?></p>
        <p><?php echo t('When Mary looks at the garden, she notices that Ted has pulled out three small tomato plants, mistaking
them for weeds. It is obvious that Ted can not garden without supervision anymore, but gardening has always been very important to him.'); ?></p>
        <p class="forum"><?php echo t('What should Mary do? Post your response to the Forum.'); ?></p>
        <h5><?php echo t('Summary'); ?></h5>
        <p><?php echo t('It is the things we do that give our lives meaning – our work, hobbies, and daily routines. Our challenge as
family members, partners, and friends of people experiencing early memory loss is to help these
individuals do the things they have always liked to do, while considering adaptations when necessary.'); ?></p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-9" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Ten Steps for Living with Memory Loss'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/90329967.png'); ?>" alt="image">
        <p><?php echo t('We have covered a lot of information in these past five modules. We are going to take a bit of time now to
review and discuss a few new ideas that you may want to consider as you continue on this journey.'); ?></p>
        <div id="question1" class="question">
          <p><b><?php echo t('Could you describe dementia, Alheimer\'s disease, Medicare and its various parts?'); ?></b>
            <select>
              <option selected="selected" value="select"> <?php echo t('Select'); ?> </option>
              <option value="1"> <?php echo t('Yes'); ?> </option>
              <option value="0"> <?php echo t('No') ?> </option>
          ...
          <p class="right-answer hide"> <?php echo t("Great! Please continue."); ?> </p>
          <p class="wrong-answer hide"> <?php echo t("Please consider reviewing the previous four modules before continuing."); ?> </p>
        </div>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-10" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('1. Educate Yourself'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('Being well informed about current therapies, research and practice will help you immensely in the months
...
and you will need additional information.'); ?></p>
        <p><?php echo t('The Alzheimer\'s Association is a good resource. Other resources include hospitals and medical centers,
...
Institutes of Health.'); ?></p>
    ...
    <div id="lesson-5-slide-11" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('2. Finding an Understanding Physician'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('It is very important to find a physician you can trust. You will have many questions as time goes on, and
        ...
        referrals to physicians who are sensitive to the needs of persons experiencing memory loss.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-12" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Cartoon --'); ?></h2>
        <hr />
        <h5><?php echo t('Please don\'t waste the doctor\'s time with questions!'); ?></h5>
        <img src="<?php echo $this->getImagesUrl('msml/168733398.png'); ?>" alt="image"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-13" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('3. Obtain Advice on Legal and Financial Planning'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('As we discussed in the last class, it is important to put legal and financial plans in place now. Durable
powers of attorney for finance, health care and advance directives may not be pleasant to think about, but
having these legal tools in place can be useful in preventing struggles and conflicts down the road.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-14" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('4. Rally Your Supporters'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('You may feel that you do not need help from anyone else right now. As time goes on you may need
...
offering you assistance later, when you really need it.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-15" class="course-slide">
      <div class="content">
        ...
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('Everyone needs a listening ear now and then. As the demands of caring for a person with memory loss
...
talking to a counselor or a clergy person. There are also support groups available to assist you.'); ?></p>
        <p><?php echo t('The important thing is to make sure that you have an outlet for your thoughts and feelings as you go
through this journey. Your confidante should be someone you trust, who will listen to you in a
nonjudgmental way and offer you emotional support and assistance.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-16" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('6. Take Time for Yourself'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('      
        What do you like to do? Do you like to go for long walks? Do you like to read? Whatever your interest, it is
important that you get into the habit of taking time for yourself. This may sound selfish and frivolous, but
in reality it is necessary if you want to continue being able to care for your family member.'); ?></p>
        <p><?php echo t('As your family member\'s memory loss progresses, they will need more and more of your attention. If you
do not take time for yourself, you may find that you feel stressed out, tired and impatient. Worse, you may
begin to experience stress‐related illnesses. So caring for yourself is not selfish, it is essential.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-17" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('7. Use Community Resources'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('        As we discussed in class four, there are a number of resources in your community that can assist you as
you care for a family member with memory loss. Knowing what resources are available is the first step, the
second is recognizing when it is time to begin utilizing these resources.'); ?></p>
        <p><?php echo t('Some people have a good support network of family and friends, and are able to handle the majority of
the care of the person experiencing memory loss. Others do not have the same support and may need to
utilize community resources earlier on in the disease process.'); ?></p>
        <p><?php echo t('Seeking assistance is nothing to be ashamed of. It is very healthy. By seeking outside assistance, you are
able to give yourself a break from your role as caregiver.'); ?></p>
        <p><?php echo t('Options like adult day programs not only give you a break, but also have the benefit of keeping your family
...
For more information about community resources, contact the local Area Agency on Aging.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-18" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('8. Maintain a Sense of Humor'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('
        Memory loss is nothing to laugh at. But life is full of absurdities. Funny things can and do happen! Learn to
enjoy these moments.'); ?></p>
        <p><?php echo t('Memory loss does not mean an end to the relationship you enjoyed with your family member. The
relationship may change, but it is not over. You can still enjoy one another\'s company and do fun things
together. And yes, you can still have moments of joy, despite the memory loss.'); ?></p>
        <p><?php echo t('
...
be found even in the difficult moments.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-19" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('9. Explore your Spiritual Beliefs'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('
        You may not consider yourself to be a religious or spiritual person. But we all have some source of
inspiration and spiritual renewal. What inspires you? What gives you the energy to get through the day?'); ?></p>
        <p><?php echo t('Whatever source you have for spiritual growth, this is the time to go to that source and take advantage of
...
family.'); ?></p>
        <p><?php echo t('
Whatever the source that works for you, make sure that you find ways to renew your spirit. This may be
the most important thing that you can do for yourself as you love and care for a person with memory loss.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    <div id="lesson-5-slide-20" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('10. Set Realistic Goals'); ?></h2>
        <hr />
        <img src="<?php echo $this->getImagesUrl('msml/94403180.png'); ?>" alt="image">
        <p><?php echo t('We often expect far too much of ourselves, becoming our own worst enemy.'); ?></p>
        <ul>
          <li><?php echo t('I will walk five miles every day.'); ?></li>
          <li><?php echo t('I will call all of the home health agencies on my list this week to find the right one for me.'); ?></li>
          <li><?php echo t('I will lose ten pounds by my niece’s wedding!'); ?></li>
        </ul>
        <p><?php echo t('As we have learned throughout this course, our goals need to be realistic in order for us to achieve them.
...
to walk around the block three times a week.'); ?></p>
        <p><?php echo t('Thank you all for participating in Making Sense of Memory Loss. We hope that you have learned some tips
and techniques that will assist you in the future.'); ?></p>
        <p><?php echo t('As a summary and to make sure we have answered all of your questions let’s review our chart of questions
from the first class.'); ?></p>
        <p><?php echo t('While moving down the chart read each question aloud and ask:'); ?></p>
        <ul>
          <li><?php echo t('Do you feel like this has been covered during the five weeks?'); ?></li>
          <li><?php echo t('Answer any remaining questions.'); ?></li>
        </ul>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
...
someone with memory loss and invite you to remember this quote from Helen Keller.'); ?></p>
    ...
    <div id="lesson-5-slide-22" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('Please complete the Post-Course Evaluation. It is acceissble via the course page, in the sidebar.'); ?></p>
        <p><?php echo t('Your feedback is greatly appreciated, and will help us to better serve family members in the future. We ask that you
