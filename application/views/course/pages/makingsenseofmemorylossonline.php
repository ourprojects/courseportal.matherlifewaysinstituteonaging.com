...
alert("Coming Soon!");
  ...
  <div class="box-sidebar one">
    ...
    <br />
    <img src="<?php echo $this->getImagesUrl('msml/286x352_Grafix_1in5.png'); ?>" alt="image" />
  ...
  <div class="box-sidebar one">
    ...
    <p> <a href="https://www.alz.org/alzheimers_disease_10_signs_of_alzheimers.asp" target="_blank"><img class="block-center" src="<?php echo $this->getImagesUrl('msml/alz.png'); ?>" alt="image" /></a></p>
    ...
    <div id="lesson-2-slide-11" class="course-slide">
      <div class="content">
        ...
        <p class="forum">{t}Think of a time when you talked to someone who you knew was not telling the truth. Their words may
          have been convincing, but somehow you knew something was not right. How did you know this? What gave them away? Post your responses to the Forum.{/t}</p>
        <img src="<?php echo $this->getImagesUrl('msml/forum_icon.png'); ?>" alt="image">
  ...
  <div id="lesson-3">
    ...
    <div id="lesson-3-slide-6" class="course-slide">
      <div class="content">
        ...
        <p>{t}The privilege of driving is so terribly important for some people that taking it away may harm the self esteem
    ...
    <div id="lesson-3-slide-7" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p><i>{t}When I die, I want to go peacefully, like my grandfather did, in his sleep; not screaming like the other passengers in his car.{/t}</i></p>
  ...
  <div id="lesson-5">
    ...
    <div id="lesson-5-slide-4" class="course-slide">
      <div class="content">
        ...
        <p>{t}When we talk about <i>activities</i> in this context, we do not only mean leisure and recreational pursuits, but every interaction that we have daily with other people or with our environment.{/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-5-slide-8" class="course-slide">
      <div class="content">
        ...
        <p>{t}Let's take Ted as an example. Ted always enjoyed gardening. Last week his wife, Mary, found Ted in the shed, staring at his garden tools and looking confused. Mary asked Ted <i>what was wrong</i> and he said, <i>I need to pull weeds but I do not remember what I am supposed to use to do that.</i>{/t}</p>
    ...
    <div id="lesson-5-slide-9" class="course-slide">
      <div class="content">
        ...
        <div id="question1" class="question">
          <p><b>{t}Could you describe dementia, Alzheimer's disease, Medicare and its various parts?{/t}</b>
            <select>
              <option selected="selected" value="select"> {t}Select{/t} </option>
              <option value="1"> {t}Yes{/t} </option>
              <option value="0"> {t}No{/t} </option>
