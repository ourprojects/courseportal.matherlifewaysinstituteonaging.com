  ...
  <div id="lesson-1">
    <div id="lesson-1-slide-1" class="course-slide">
      <div class="content">
        ...
        <h4><?php echo t('Course Description'); ?></h4>
    ...
    <div id="lesson-1-slide-2" class="course-slide">
      <div class="content">
        ...
        <ol>
          <li>
            <h4><?php echo t('Overview of:'); ?></h4>
          </li>
          <ul>
            <li>
              <h5><?php echo t('Brain Health Now and Later'); ?></h5>
            </li>
            <li>
              <h5><?php echo t('Dementia and Cognitive Reserve'); ?></h5>
            </li>
            <li>
              <h5><?php echo t('Brain Plasticity'); ?></h5>
            </li>
            <li>
              <h5><?php echo t('Peak Performance'); ?></h5>
            </li>
          </ul>
          <li>
            <h4><?php echo t('Introduction to Program Format'); ?></h4>
          </li>
          <li>
            <h4><?php echo t('Memory Exercise'); ?></h4>
          </li>
          <li>
            <h4><?php echo t('Goal Setting'); ?></h4>
          </li>
        </ol>
      </div>
    ...
    <div id="lesson-1-slide-3" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Brain Health'); ?></h2>
        <hr />
...
To describe some of the key concepts underlying the field of brain health, we will start by talking a bit about how to protect brain health as you age.'); ?></p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-1-slide-4" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Dementia is not inevitable'); ?></h2>
        <hr />
...
'); ?></p>
    ...
    <div id="lesson-1-slide-17" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('CR Contributions Logs'); ?></h2>
        <hr />
        <p><?php echo t('Knowing if we are doing enough for our brains can be a challenge, so in an effort to help you take account of your brain healthy activities, we created the CR (Cognitive Reserve) Contribution Log.  You would not expect to invest in your financial retirement account without keeping track of your investments would you?  With this log you can get a better idea of how you’re investing in your brain health, and if you choose to increase your investment, you can monitor that too, watching your gains grow over time.'); ?></p>
...
--> 
    ...
    <div id="lesson-1-slide-18" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Memory Strategy #1'); ?></h2>
        <hr />
        <h4><?php echo t('5 Minute Explanation – 10 Minute Practice'); ?></h4>
        <h5><?php echo t('Memory Tip #1 - Improve Memory by Improving Attention '); ?></h5>
        <p><?php echo t('In each section, you will learn a new strategy for improving your memory in your everyday life.  Today, please focus on helping build a cognitive skill that is not “memory” per se but is essential for having a better memory.'); ?></p>
        <p><?php echo t('Today we are going to help you improve your memory by helping you improve your ATTENTION.  The reason we are starting here is because attention is the gateway to memory. You can’t expect to remember things that you don’t see, hear, feel or otherwise experience, right?  How can we expect our brains to hold onto information that doesn’t get in in the first place?'); ?></p>
        <p><?php echo t('What are some ways that you can improve your attention?'); ?></p>
...
--> 
    ...
    <div id="lesson-1-slide-19" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Improving Attention'); ?></h2>
        <hr />
        ...
        <p><?php echo t('This handout list some strategies that are used to help people with attention deficits improving their attention – we list them here because they are also important for many of us.'); ?></p>
...
--> 
    ...
    <div id="lesson-1-slide-20" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('Attention Exercise'); ?></h2>
        <hr />
        <p><?php echo t('Allow 10 minutes of time for this activity'); ?></p>
        <p><?php echo t('Once you have completed this activity, please record your experince on the Forum'); ?></p>
...
--> 
    ...
    <div id="lesson-1-slide-21" class="course-slide">
      <div class="content">
        <h2 class="flowers"><?php echo t('This Week\'s Goals Steps'); ?></h2>
        <hr />
        <p><?php echo t('Allow 5 minutes for this activity'); ?></p>
        <p><?php echo t('Ensure that you record a goal and a reward on your handout.'); ?></p>
  ...
  -->
    ...
    <div id="lesson-1-slide-22" class="course-slide">
      <div class="content">
        ...
        <ul>
          <li><?php echo t('Alzheimer’s disease is caused by what?'); ?></li>
          <li><?php echo t('What is cognitive reserve?'); ?></li>
          <li><?php echo t('What is brain plasticity?'); ?></li>
          <li><?php echo t('Do adult brains grow new brain cells?'); ?></li>
          <li><?php echo t('Can brain pathways re-organize?'); ?></li>
          <li><?php echo t('What is the term for the brain’s ability to change throughout life?'); ?></li>
          <li><?php echo t('How will we be working to maximize contributions to our cognitive reserve?'); ?></li>
          <li><?php echo t('Does a good memory depend on good attention?'); ?></li>
          <li><?php echo t('How can you improve your attention?'); ?></li>
