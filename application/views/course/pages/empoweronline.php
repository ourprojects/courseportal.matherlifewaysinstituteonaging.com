...
alert("Coming Soon!");
  ...
  <div class="box-sidebar three">
    ...
    <p><a href="http://www.usa.gov/Citizen/Topics/Health/caregivers.shtml#Government_Benefits" target="_blank"><img class="block center" src="<?php echo $this->getImagesUrl('empower/usagov_logo.gif'); ?>" alt="image"></a> </p>
  </div>
...
<div class="box-white" id="resources">
  ...
  <table>
    <tr>
      <td><a href="#lesson-6-slide-1" data-fancybox-group="lesson-6" class="teal lesson-6"><img src="<?php echo $this->getImagesUrl('flags/United-States-Flag-64.png'); ?>" alt="{t}USA{/t}" /></a></td>
      <td><a href="#lesson-7-slide-1" data-fancybox-group="lesson-7" class="teal lesson-7"><a href="#"><img src="<?php echo $this->getImagesUrl('flags/China-Flag-64.png'); ?>" alt="{t}China{/t}" /></a></td>
  ...
  <div id="lesson-4">
    ...
    <div id="lesson-4-slide-6" class="course-slide">
      <div class="content">
        ...
        <p class="forum">On the Forum, post any <i>"happy activities"</i> that you are currently involved in. If you do not have any, post some that you would like to have.</p>
        <img src="<?php echo $this->getImagesUrl('empower/forum_icon.png'); ?>" alt="{t}image{/t}"> </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a></div>
    </div>
