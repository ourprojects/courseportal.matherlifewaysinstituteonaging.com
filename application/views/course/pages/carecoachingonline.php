...
<div class="column-wide">
  ...
  <h5><?php echo t('Course Syllabus (English)'); ?></h5>
  ...
  <div id="lesson-1">
    <div id="lesson-1-slide-1" class="course-slide">
      <div class="content">
        ...
        <hr />
      <img width="400" height="266" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/3223247-531x800.jpg'); ?>" />
     ...
     <p><?php echo t('There are 7 units in total, and we encourage you to complete at least one unit per week so that your Instructor may monitor and help lead the various weekly unit Discussion areas.'); ?></p>
     ...
     <p><?php echo t('If you have any questions and/or concerns, please don’t hesitate to contact your Instructor via email.  Their information can be found by clicking on the ‘Staff Information’ link in the left toolbar.'); ?></p>
     
     <h4><?php echo t('HELPFUL HINTS'); ?></h4>
     <ul>
     	<li><?php echo t('MAKE A DATE WITH THE COURSE! Putting a specific time in your calendar to participate every week will get you started in the right direction.  So, for example, if you plan to participate every Tuesday at 7:00 pm, try to keep the same schedule every week.'); ?></li><br />
		<li><?php echo t('READ CAREFULLY. The instructions to participate in activities are sometimes very specific but necessary to ensure everyone participates in the same way.  Instructions will become familiar to you over time.'); ?></li><br />
        <li><?php echo t('KEEP ON TASK.  We know your work and family caregiving responsibilities can sometimes disrupt your participation.  The Instructor will send emails each week to remind all students to log on and to share tips for each unit.  They will also let you know what lesson is recommended for the week so you can assess your own progress and timeline.'); ?></li>
        </ul>
        <br />
        <br />
...
<div id="lesson-1-slide-2" class="course-slide">
    ...
    <div id="lesson-1-slide-3" class="course-slide">
      <div class="content">
        ...
        <hr />
        <img width="400" height="266" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/3663024-532x800.jpg'); ?>" />
    ...
    <div id="lesson-1-slide-4" class="course-slide">
      <div class="content">
        ...
        <img width="266" height="396" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/4909913-800x538.jpg'); ?>" />
    ...
    <div id="lesson-1-slide-5" class="course-slide">
      <div class="content">
        ...
        <img width="400" height="268" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/4919555-536x800.jpg'); ?>" />
    ...
    <div id="lesson-1-slide-7" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>  <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivitySelfAwarenessSurvey.pdf'); ?>" target="_blank" /><img width="48px" height="48px" class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('This activity invites you to explore and live several questions. Your responses should open up more self-awareness of what is important to you in your life.'); ?></p>
    ...
    <div id="lesson-1-slide-8" class="course-slide">
      <div class="content">
        ...
        <img width="400" height="266" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/5342290-642x965.jpg'); ?>" />
    ...
    <div id="lesson-1-slide-9" class="course-slide">
      <div class="content">
        ...
        <ol>
          ...
          <p><?php echo t('Most importantly, “When I think about being a good caregiver, what’s important to me?”'); ?></p></li>
    ...
    <div id="lesson-1-slide-10" class="course-slide">
      <div class="content">
        ...
        <p>
<iframe width="560" height="315" src="http://www.youtube.com/embed/0_otisZVT8A?rel=0" frameborder="0" allowfullscreen></iframe>        </p>
        <br /><br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?> </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-1-slide-11" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>
		<a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivityPrinciplesofSuccess.xls'); ?>" target="_blank" /><img class="normal" width="48px" height="48px" src="<?php echo $this->getImagesUrl('spreadsheet.png'); ?>" /></a>
		<?php echo t('This activity focuses on assessing your awareness of ten principles of success and your rating of how you presently live according to them.'); ?></p>
    ...
    <div id="lesson-1-slide-12" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('Because journaling is a private experience, you can create your own unique experience!'); ?></li>
          
          <ol>
          	<li><p><?php echo t('Begin with getting yourself an inexpensive notebook or journal for your entries.'); ?></p></li>
          
          <li><p><?php echo t('Make daily entries about your accomplishments – no matter how big or small. They may be accomplishments in relation to either work or your personal life.'); ?></p></li>
         ...
         <li style="text-decoration:underline;"><?php echo t('In what areas of my life do I appear most satisfied or content?'); ?></li>
          ...
          <li><p><?php echo t('Create a personal “bragging” statement. Be authentic and positive in your statement. Print out the statement and keep it visible so that you can refer to it often.'); ?></p></li>
          <li><p><?php echo t('Recite it out loud daily, saying, “This is me….This is what makes me special.”'); ?></p></li>
        </ol>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?> </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-1-slide-14" class="course-slide">
      <div class="content">
        ...
        <p><?php echo t('Try and record your goals to start:'); ?></p>
        <div class="box-white">
        <p><?php echo t('Goal #1: '); ?> <input type="text" size="75%"></p>
                <p><?php echo t('Goal #2: '); ?> <input type="text" size="75%"></p>

        <p><?php echo t('Goal #3: '); ?> <input type="text" size="75%"></p>
...
<div id="lesson-4">
  ...
  <div id="lesson-4-slide-2" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img width="300" height="284" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/Dining-MGEV.JPG'); ?>" />
...
'); ?></p>
  ...
  <div id="lesson-4-slide-3" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img width="250" height="378" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/J0285068.JPG'); ?>" />
  ...
  <div id="lesson-4-slide-5" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img width="400" height="267" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/J0289491.JPG'); ?>" />
  ...
  <div id="lesson-4-slide-6" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img width="250" height="350" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/J0315447.JPG'); ?>" />
      ...
      <p>
      <?php echo t('Let’s do an exercise to see your current “PowerPhrase” skill level.  Click on the following icon to take a quick survey.'); ?>
      </p>
  ...
  <div id="lesson-4-slide-8" class="course-slide">
    <div class="content">
      ...
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivityPracticingPowerPhraseswithYourHealthProvide.pdf'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a>
      <?php echo t('Click the icon to access the activity.'); ?>
      </p>
      <br />
      <br />
    </div>
  ...
  <div id="lesson-4-slide-9" class="course-slide">
    <div class="content">
      ...
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/Lesson4Handouts.zip'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <?php echo t('Click the icon below to access the folloiwng handouts: <i>People, Places, and Things and More Things</i>'); ?></p>
      <br />
      <br />
    </div>
    <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> <?php echo t('Complete Lesson'); ?></a></div>
...
<div id="lesson-7-slide-2" class="course-slide">
  <div class="content">
    ...
    <hr />
    <img src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/Untitled1.png'); ?>" />
...
<div class="content">
  ...
  <hr />
  <img width="400" height="268" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/12260091-567x847.jpg'); ?>" />
  ...
  <div id="lesson-7-slide-6" class="course-slide">
    <div class="content">
      ...
      <p>
      <iframe width="560" height="315" src="http://www.youtube.com/embed/55UCToPajd4?rel=0" frameborder="0" allowfullscreen></iframe></p>
      <br />
      <br />
    </div>
    <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
