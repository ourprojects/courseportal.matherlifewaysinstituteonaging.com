...
<div class="column-wide">
 ...
 <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/CARECoachingSyllabus.pdf'); ?>" target="_blank" /><img width="48px" height="48px" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="<?php echo t('Course Syllabus'); ?>" /></a>
  <br />
