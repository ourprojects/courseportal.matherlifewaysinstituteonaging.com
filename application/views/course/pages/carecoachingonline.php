...
<div class="column-wide">
  ...
  <p><?php echo t($course->description); ?></p>
   <h5>{t}Access - 1 year / Completion - 7 weeks (recommended){/t}</h5>
  ...
  <div id="lesson-1">
    ...
    <div id="lesson-1-slide-7" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ActivitySelfAwarenessSurvey.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}This activity invites you to explore and live several questions. Your responses should open up more self-awareness of what is important to you in your life.{/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a></div>
    </div>
    ...
    <div id="lesson-1-slide-11" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ActivityPrinciplesofSuccess.xls'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('spreadsheet.png'); ?>" alt="image" class="normal" /></a> {t}This activity focuses on assessing your awareness of ten principles of success and your rating of how you presently live according to them.{/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a></div>
    </div>
...
chicken for lunch today. So I think I’d like to try their fish!”{/t}</i></p>
    ...
    <div id="lesson-2-slide-8" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ActivityPracticetheTalk.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a> {t}Some caregivers feel that practice sessions are valuable to "test out" the conversations in other situations. Here are some practice activities for you to try out.{/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a></div>
    </div>
  ...
  <div id="lesson-4">
    ...
    <div id="lesson-4-slide-6" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ExercisePowerPhraseSurvey.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" width="48" height="48" class="normal" /></a> {t}PowerPhrase Survey{/t}</p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
    ...
    <div id="lesson-4-slide-8" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ActivityPracticingPowerPhraseswithYourHealthProvide.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" width="48" height="48" class="normal" /></a> {t}Click the icon to access the activity.{/t} </p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
  ...
  <div id="lesson-5">
    ...
    <div id="lesson-5-slide-5" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ActivityRelocatingScenarios.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a> {t}How can I convince my older parents to move to a retirement community? Here are two scenarios for you to respond to.{/t}</p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
    ...
    <div id="lesson-5-slide-7" class="course-slide">
      <div class="content">
        ...
        <p>{t}<i>Assisted living communities</i> provide care for seniors who need some help with activities of daily living yet wish to remain as independent as possible. A middle ground between independent living and nursing homes, assisted living communities aim to foster as much autonomy as the resident is capable of. Most communities offer 24-hour supervision and an array of support services, with more privacy, space, and dignity than many nursing homes at lower costs.     There are approximately 33,000 assisted living communities operating in the U.S. today. The number of residents living in a facility can range from several to 300, with the most common size being between 25 and 120 residents. Assisted living staff helps residents with daily personal care including bathing, dressing, eating, grooming, and getting around. Medical care is limited, but families may contract for some medical needs such as medication administration or home health care. Assisted living communities focus on what is termed a “social model” of care (e.g., promoting social engagement and supporting individual care needs).{/t}</p>
        <br />
        <br />
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
    ...
    <div id="lesson-5-slide-8" class="course-slide">
      <div class="content">
        ...
        <h5><a href="<?php echo $this->getImagesUrl('CCOAssets/GilbertGuideALToolkit.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}Download Gilbert Guide – Assisted Living Evaluation and Moving Kit{/t}</h5>
    ...
    <div id="lesson-5-slide-11" class="course-slide">
      <div class="content">
        ...
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ExerciseVisitingaSeniorLivingCommunity.pdf'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" /></a> {t}Click on the icon to access the activity: Visiting a Senior Living Community{/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
    </div>
    ...
    <div id="lesson-5-slide-13" class="course-slide">
      <div class="content">
        ...
        <hr />
        <p>{t}Read the following scenario and then respond to the CARE coaching questions. We provide some initial “openers” for CARE coaching questions for you to more fully develop your own questions.{/t}</p>
        <p> <a href="<?php echo $this->getImagesUrl('CCOAssets/ActivityCARECoachingthroughLongDistanceCaregiving.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}CARE Coaching through Long Distance Caregiving{/t}</p>
      </div>
      <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
    </div>
    ...
    <div id="lesson-6">
      ...
      <div id="lesson-6-slide-5" class="course-slide">
        <div class="content">
          ...
          <p><a href="<?php echo $this->getImagesUrl('CCOAssets/ActivityUsingYourPowersofObservation.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}Click on the icon to access the activity - Using Your Powers of Observation.{/t}</p>
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
      </div>
      ...
      <div id="lesson-6-slide-7" class="course-slide">
        <div class="content">
          ...
          <p><a href="<?php echo $this->getImagesUrl('CCOAssets/LightingInTheHome.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}<b>Lighting the Way: A Key to Independence</b>. This resource provides a number of recommendations to help older adults see better.  From home lighting to doing small tasks, many suggestions can easily be implemented with simple modifications.{/t}</p>
          <p><a href="<?php echo $this->getImagesUrl('CCOAssets/HomeSafetyChecklist.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}<b>Home Safety Checklist</b>. This is a simple checklist that you can use when visiting your older parents to assess safety issues in their home environment.{/t}</p>
          <br />
          <br />
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
      ...
      <div id="lesson-6-slide-9" class="course-slide">
        <div class="content">
          ...
          <p><a href="<?php echo $this->getImagesUrl('CCOAssets/ExerciseAssessingtheSituation.pdf'); ?>" target="_blank"><img src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="image" class="normal" /></a>{t}Click on the icon to access the activity - Assessing the Situation.{/t}</p>
          <br />
          <br />
        </div>
        <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t}</a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo;</a></div>
