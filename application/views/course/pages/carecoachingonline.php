...
<div class="column-wide">
 ...
 <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/CARECoachingOnlineSyllabus.pdf'); ?>" target="_blank" /><img width="48px" height="48px" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="<?php echo t('Course Syllabus'); ?>" /></a>
  <br />
...
<div id="lesson-1">
  <div id="lesson-1-slide-1" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('3223247r.jpg'); ?>" />
  ...
  <div id="lesson-1-slide-3" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('3663024r.png'); ?>" />
  ...
  <div id="lesson-1-slide-4" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('4909913r.png'); ?>" />
  ...
  <div id="lesson-1-slide-5" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('4919555r.png'); ?>" />
  ...
  <div id="lesson-1-slide-7" class="course-slide">
    <div class="content">
      ...
      <hr />
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivitySelfAwarenessSurvey.pdf'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('This activity invites you to explore and live several questions. Your responses should open up more self-awareness of what is important to you in your life.'); ?></p>
    </div>
    <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?> </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
  </div>
  ...
  <div id="lesson-1-slide-8" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('5342290r.png'); ?>" />
  ...
  <div id="lesson-1-slide-11" class="course-slide">
    <div class="content">
      ...
      <hr />
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivityPrinciplesofSuccess.xls'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('spreadsheet.png'); ?>" /></a> <?php echo t('This activity focuses on assessing your awareness of ten principles of success and your rating of how you presently live according to them.'); ?></p>
    </div>
    <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?> </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
  </div>
...
<div id="lesson-2">
  ...
  <div id="lesson-2-slide-2" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('9146129r.png'); ?>" />
  ...
  <div id="lesson-2-slide-3" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('9869154r.png'); ?>" />
...
chicken for lunch today. So I think I’d like to try their fish!”'); ?></i></p>
  ...
  <div id="lesson-2-slide-7" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('11829067r.png'); ?>" />
      <p><?php echo t('A framework has been developed to help you getting the conversations going. Overall, start small while your parents are still healthy and can fully participate in the discussions about their lives and health without undue pressure.'); ?></p>
  ...
  <div id="lesson-2-slide-8" class="course-slide">
    <div class="content">
      ...
      <hr />
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivityPracticetheTalk.pdf'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <?php echo t('Some caregivers feel that practice sessions are valuable to "test out" the conversations in other situations. Here are some practice activities for you to try out.'); ?></p>
    </div>
    <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?> </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo; </a></div>
  </div>
  ...
  <div id="lesson-2-slide-9" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('11829138r.png'); ?>" />
...
<div id="lesson-3">
  ...
  <div id="lesson-3-slide-4" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('11848241r.jpg'); ?>" />
  ...
  <div id="lesson-3-slide-5" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('12051072r.jpg'); ?>" />
...
<div id="lesson-4">
  ...
  <div id="lesson-4-slide-2" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('Dining-MGEVr.JPG'); ?>" />
...
'); ?></p>
  ...
  <div id="lesson-4-slide-3" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('J0285068r.JPG'); ?>" />
  ...
  <div id="lesson-4-slide-5" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('J0289491r.JPG'); ?>" />
  ...
  <div id="lesson-4-slide-6" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img src="<?php echo $this->getImagesUrl('J0315447r.JPG'); ?>" />
      ...
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ExercisePowerPhraseSurvey.pdf'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <?php echo t('PowerPhrase Survey'); ?></p>
      <br />
      <br />
    </div>
    <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
  ...
  <div id="lesson-4-slide-7" class="course-slide">
    <div class="content">
      ...
      <hr />
      <img width="400" height="267" src="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/J0321054.JPG'); ?>" />
  ...
  <div id="lesson-4-slide-8" class="course-slide">
    <div class="content">
      ...
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivityPracticingPowerPhraseswithYourHealthProvide.pdf'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <?php echo t('Click the icon to access the activity.'); ?> </p>
      <br />
      <br />
    </div>
    <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
  ...
  <div id="lesson-4-slide-9" class="course-slide">
    <div class="content">
      ...
      <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/Lesson4Handouts.zip'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <?php echo t('Click the icon below to access the folloiwng handouts: <i>People, Places, Things and More Things</i>'); ?></p>
      <br />
      <br />
    </div>
    <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> <?php echo t('Complete Lesson'); ?></a></div>
...
<div id="lesson-5-slide-5" class="course-slide">
  <div class="content">
    ...
    <hr />
    <p> <a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <?php echo t('How can I convince my older parents to move to a retirement community? Here are two scenarios for you to respond to.'); ?></p>
    <br />
    <br />
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
...
<div id="lesson-5-slide-8" class="course-slide">
  <div class="content">
    ...
    <h5><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('Download Gilbert Guide – Assisted Living Evaluation and Moving Kit'); ?></h5>
...
<div id="lesson-5-slide-9" class="course-slide">
  <div class="content">
    ...
    <h5><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('Retirement Redefined'); ?></h5>
    ...
    <h5> <a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank"><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('Download Gilbert Guide – Independent Living & CCRC Evaluation Kit'); ?></h5>
    <br />
    <br />
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
...
<div id="lesson-5-slide-11" class="course-slide">
  <div class="content">
    ...
    <p> <a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="" /></a> <?php echo t('Click on the icon to access the activity: Visiting a Senior Living Community'); ?></p>
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
</div>
...
<div id="lesson-5-slide-12" class="course-slide">
  <div class="content">
    ...
    <hr />
    <img src="<?php echo $this->getImagesUrl('78634274r.jpeg'); ?>" />
...
<div id="lesson-5-slide-13" class="course-slide">
  <div class="content">
    ...
    <hr />
    <p><?php echo t('Read the following scenario and then respond to the CARE coaching questions. We provide some initial “openers” for CARE coaching questions for you to more fully develop your own questions.'); ?></p>
    <p> <a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('CARE Coaching through Long Distance Caregiving'); ?></p>
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
</div>
...
<div id="lesson-6-slide-5" class="course-slide">
  <div class="content">
    ...
    <p><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('Click on the icon to access the activity - Using Your Powers of Observation.'); ?></p>
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
</div>
...
<div id="lesson-6-slide-7" class="course-slide">
  <div class="content">
    ...
    <p><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('<b>Lighting the Way: A Key to Independence</b>. This resource provides a number of recommendations to help older adults see better.  From home lighting to doing small tasks, many suggestions can easily be implemented with simple modifications.'); ?></p>
    <p><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('<b>Home Safety Checklist</b>. This is a simple checklist that you can use when visiting your older parents to assess safety issues in their home environment.'); ?></p>
    <br />
    <br />
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
...
<div id="lesson-6-slide-9" class="course-slide">
  <div class="content">
    ...
    <p><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a><?php echo t('Click on the icon to access the activity - Assessing the Situation.'); ?></p>
    <br />
    <br />
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
...
<div id="lesson-6-slide-12" class="course-slide">
  <div class="content">
    ...
    <p><a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="" /></a><b><?php echo t('Driver Self-Assessment'); ?></b><br />
...
<div id="lesson-6-slide-14" class="course-slide">
  <div class="content">
    ...
    <p class="subtopic"><?php echo t('Resources'); ?></p>
    <p> <a href="<?php echo $this->getImagesUrl('here'); ?>" target="_blank" /><img class="normal" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" alt="" /></a> <b><?php echo t('Warning Signs for Older Drivers'); ?></b><br />
...
<div id="lesson-7-slide-3" class="course-slide">
  <div class="content">
    ...
    <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ExerciseIdentifyingSolutionstoSupportChoiceandPreferences.pdf'); ?>" target="_blank" /><img class="normal" width="48" height="48" src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <b><?php echo t('Click the icon to access the Exercise – Identifying Solutions to Support Choice and Preferences'); ?></b></p>
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
</div>
...
<div id="lesson-7-slide-7" class="course-slide">
  <div class="content">
    ...
    <p> <a href="<?php echo $this->getImagesUrl('CARECoachingOnlineImages/ActivityWaystoManageYourOwnStress.pdf'); ?>" target="_blank" /><img class="normal" width="48" height="48"src="<?php echo $this->getImagesUrl('pdf-icon.png'); ?>" /></a> <b><?php echo t('Click the icon to access the Activity'); ?></b></p>
  </div>
  <div class="buttons"> <a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;<?php echo t('Back'); ?></a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();"><?php echo t('Next'); ?>&nbsp;&raquo;</a></div>
</div>
