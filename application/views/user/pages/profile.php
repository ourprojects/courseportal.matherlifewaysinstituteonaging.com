...
<div id="sidebar">
    <div class="box-sidebar one">
        ...
        <p>{t}Our goal is to help better educate our participants by creating a feedback system and means to better
            understanding the shifting needs of the field.{/t}</p>
        <ul id="surveys">
            <?php
            foreach (array(
                         'profile',
