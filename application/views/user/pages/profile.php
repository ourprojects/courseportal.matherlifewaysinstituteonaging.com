...
<div id="sidebar">
  ...
  <div class="box-sidebar two">
    ...
    <img style="margin: 0px; padding: 0px; -webkit-border-bottom-right-radius: 5px; -webkit-border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;" src="<?php echo $this->getImagesUrl('148950191.png'); ?>" alt="Image"> </div>
</div>
<div class="column-wide">
  ...
  <br />
  <div class="box-white"> <?php echo $this->renderPartial('forms/profile_form', array('CPUser' => $CPUser, 'Avatar' => $Avatar)); ?> </div>
  <div class="box-white">
