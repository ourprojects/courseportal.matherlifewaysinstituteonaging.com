...
<div id="sidebar">
	<div class="box-sidebar one" style="background-color: #FFF;">
		...
		<p style="text-align: center; font-weight: bold;">
			{t}For the best experience, download Google Chrome <a href="https://www.google.com/intl/en/chrome/browser/" target="_blank">here</a>!{/t}
		</p>
		<p>
			<img class="block-center" src="<?php echo $this->getImagesUrl('googlechromelogo.png'); ?>" />
		</p>
		<p>
			<strong>Adobe - </strong><a href="http://get.adobe.com/flashplayer/" target="_blank"><strong>Flash Player 11</strong> </a> &amp; <a href="http://get.adobe.com/reader/" target="_blank"><strong>Reader XI</strong> </a>
		</p>
		<p>
			{t}<strong>Word &amp; Spreadsheet Processor -</strong>{/t} <strong>(</strong><a href="http://office.microsoft.com" target="_blank"><strong>Office</strong> </a>, <a href="http://www.apple.com/iwork/" target="_blank"><strong>iWork</strong> </a>,<strong> </strong><a href="http://www.openoffice.org" target="_blank"><strong>OpenOffice</strong> </a>)
		</p>
	</div>
	<div class="box-sidebar three">
		<h3>{t}White papers{/t}</h3>
		<p>
			<a href="http://www.matherlifewaysinstituteonaging.com/wp-content/uploads/2012/03/eLearning-Maturing-Technology.pdf" class="pdf" target="_blank">{t}e-Learning: Maturing Technology Brings Balance &amp; Possibilities to Nursing Education{/t} </a> <a href="http://www.matherlifewaysinstituteonaging.com/wp-content/uploads/2012/03/How-eLearning-Can-Reduce-Expenses-and-Improve-Staff-Performance.pdf" class="pdf" target="_blank">{t}The Bottom Line: How e-Learning Can Reduce Expenses and Improve Staff Performance{/t} </a>
		</p>
	</div>
	...
	<div class="box-sidebar three statistics" style="padding-bottom: 25px;">
		...
		<ul id="quotes">
			<li>
				<img src="<?php echo $this->getImagesUrl('stat-one-quarter.png'); ?>" alt="image" /> <span>1/4</span>&nbsp;{t}of US households has a family caregiver providing some form of care or service to a relative or friend, age 50+{/t}
			</li>
			<li>
				<img src="<?php echo $this->getImagesUrl('stat-two-thirds.png'); ?>" alt="image" /> <span>2/3</span>&nbsp;{t}of these family caregivers are also working{/t}
			</li>
			<li>
				<img src="<?php echo $this->getImagesUrl('stat-half.png'); ?>" alt="image" /> <span>50%</span>&nbsp;{t}of employed caregivers work full-time{/t}
			</li>
		</ul>
	</div>
</div>
<div class="column-wide">
	...
	<p>
		{t}Institution Wide Content Management - 25%{/t}<br /> {t}Online Course Delivery - 25%{/t}<br /> {t}Targeted Collaboration - 50%{/t}
	</p>
