...
<div id="sidebar">
  ...
  <div class="box-sidebar two">
    ...
    <p style="text-align: center;"> <b><a href="http://www.whitehouse.gov/the-press-office/2012/11/01/presidential-proclamation-national-family-caregivers-month-2012" target="_blank">{t}Presidential Proclamation -- National Family Caregivers Month{/t}</a> </b> </p>
  ...
  <div class="box-sidebar three">
    ...
    <p> <a href="http://www.matherlifewaysinstituteonaging.com/wp-content/uploads/2013/08/Survey-of-Working-Caregiver-Needs-and-Resources.pdf" target="_blank">{t}Survey of Working Caregiver Needs and Resources{/t}</a> </p>
  </div>
  
  <!-- sidebar for Participating locations here --><!-- sidebar on Resent Research here --> 
...
<div id="tutorial" class="hide">
  ...
  <div id="slide-1" class="course-slide">
    ...
    <div class="buttons"> <a href="#" onclick="parent.jQuery.fancybox.close();" class="button left"> {t}Exit{/t} </a> </div>
  </div>
</div>
