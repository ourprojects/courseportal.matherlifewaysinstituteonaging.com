...
<div id="sidebar">
	...
	<div class="box-sidebar two">
		...
		<p style="text-align: center;">
			<b><a href="http://www.eapassn.org/files/public/EACCroster2012.pdf" target="_blank">{t}Employee Assistance Certification Commission (EACC){/t}</a> </b>
		</p>
		...
		<p>
			<a href="http://www.eapassn.org/" target="_blank"><img class="block center" src="<?php echo $this->getImagesUrl('EAPlogo.png'); ?>" alt="EAP Assocation Logo"> </a>
		</p>
	</div>
	<div class="box-sidebar three">
		...
		<p>
			<a href="<?php echo $this->getImagesUrl('MLIAsurvey.pdf'); ?>" class="pdf" target="_blank">{t}Survey of Working Caregiver Needs and Resources{/t} </a>
		</p>
	</div>
	...
	<div class="box-sidebar five">
		...
		<div id="flags">
			<table>
				<tr>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/United-States-Flag-64.png'); ?>" alt="{t}USA{/t}" />
					</td>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/China-Flag-64.png'); ?>" alt="{t}China{/t}" />
					</td>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/Hong-Kong-Flag-64.png'); ?>" alt="{t}Hong Kong{/t}" />
					</td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/Brazil-Flag-64.png'); ?>" alt="{t}Brazil{/t}" />
					</td>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/Mexico-Flag-64.png'); ?>" alt="{t}Mexico{/t}" />
					</td>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/Taiwan-Flag-64.png'); ?>" alt="{t}Taiwan{/t}" />
					</td>
				</tr>
				<tr>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/Argentina-Flag-64.png'); ?>" alt="{t}Argentina{/t}" />
					</td>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/United-Kingdom-flag-64.png'); ?>" alt="{t}England{/t}" />
					</td>
					<td>
						<img src="<?php echo $this->getImagesUrl('flags/Luxembourg-Flag-64.png'); ?>" alt="{t}Luxembourg{/t}" />
					</td>
				</tr>
			</table>
		</div>
...
<div id="tutorial" class="hide">
	...
	<div id="slide-1" class="course-slide">
		...
		<div class="buttons">
			<a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Begin Tutorial &raquo;{/t} </a>
		</div>
	</div>
	<div id="slide-2" class="course-slide">
		<div class="content">
			...
			<hr />
			<p>
				{t}<b>Caregiving is not just a social issue, it is a critical workplace issue</b>. Caregiving for an elderly person is usually provided by a family member, and typcially these family members are employed. According to the <a href="http://www.alz.org/downloads/facts_figures_2012.pdf" target="_blank">Alzheimer's disease Facts and Figures (2012)</a> report, a large percentage of the American workforce is estimated to be involved in caregiving. And, as the number of elderly Americans grows, the number of employed caregivers—and the billions in annual cost to business, in addition to the billions associated with health care costs — is likely to continue upwards.{/t}
			</p>
			<p>
				{t}In fact, as reported, in the <b>next two decades</b>, the <b>number of older Americans will more than double</b>. The fastest growing segment of the population are those age 85 and older, a segment that is most likely to be frail and have chronic conditions. Given rising healthcare costs and shorter hospital stays, the care of these older Americans will increasingly fall on their children, friends, and other relatives — unpaid caregivers who are, for the most part, still in the workforce. Many of them are at the peak of their careers.{/t}
			</p>
			<p align="center">
				<iframe width="400" height="225" src="http://www.youtube.com/embed/In1IJocVor8?rel=0" frameborder="0" allowfullscreen></iframe>
			</p>
			<p>
				{t}The current figures are already staggering. Today, <b>millions of caregivers provide assistance to people age 50 and older</b>, and nearly all of the care of older adults is provided by family and friends. Meanwhile, more than <b>half of the nation’s unpaid caregivers are in the workforce</b>.{/t}
			</p>
			<div id="question1" class="question">
				<p>
					<b>{t}The Alzheimer's Association is the world's leading voluntary health organization in Alzheimer's care, support and research.{/t}</b><br />
					<select>
						<option selected="selected" value="select">{t}Select{/t}</option>
						<option value="1">{t}True{/t}</option>
						<option value="0">{t}False{/t}</option>
				...
				<p class="right-answer hide">
					{t}Correct!. Please familarize yourself with the <a href="http://www.alz.org" target="_blank">Alzheimer's Association's website</a>.{/t}
				</p>
				<p class="wrong-answer hide">
					{t}Please familarize yourself with the <a href="http://www.alz.org" target="_blank">Alzheimer's Association's website</a> before continuing.{/t}
				</p>
			</div>
		</div>
		<div class="buttons">
	...
	<div id="slide-3" class="course-slide">
		<div class="content">
			...
			<p>
				<b>{t}Forum Posting{/t}</b> - {t}(Access to the Forum is only available to registered users...){/t}
			</p>
			<img src="<?php echo $this->getImagesUrl('tutorial/ForumScreenShot.png'); ?>" alt="{t}image{/t}">
		</div>
		<div class="buttons">
			<a href="javascript:;" class="button left" onclick="$.fancybox.prev();">&laquo;&nbsp;{t}Back{/t} </a> <a href="javascript:;" class="button right" onclick="$.fancybox.next();">{t}Next{/t}&nbsp;&raquo; </a>
		</div>
		...
		<div class="content">
			...
			<div style="width: 400px;" id="video">
				<div style="height: 340px;">
					<script type="text/javascript" src="http://mediastorm.com/player/embed.php?id=e51981bc412802480288&w=400&h=340&amp;lang=none"></script>
				</div>
	...
	<div id="slide-5" class="course-slide">
		<div class="content">
			...
			<p>
				{t}In general, individuals responsible for caregiving — including employee caregivers — have more health-related problems than employees who are non-caregivers. A survey from <a href="http://www.commonwealthfund.org/Surveys/2005/2005-Commonwealth-Fund-International-Health-Policy-Survey-of-Sicker-Adults.aspx" target="_blank">The Commonwealth Fund (2005)</a> found that 45 percent of caregivers had one or more chronic conditions, compared to 24 percent of those with no caregiving responsibilities.{/t}
			</p>
			<p>
				{t}Caregivers (whether working or not) have higher levels of depression, heart disease, blood pressure and immune function, and are more likely to die earlier than non-caregivers. In 2010, the <a href="https://www.metlife.com/assets/cao/mmi/publications/studies/2011/mmi-caregiving-costs-working-caregivers.pdf" target="_blank">National Alliance for Caregiving and MetLife</a>, found that employee caregivers have a higher incidence of diabetes.{/t}
			</p>
			<p>
				{t}Among female employees age 50 and older providing eldercare, 17 percent reported fair or poor health compared to 9 percent of noncaregivers, the <a href="https://www.metlife.com/assets/cao/mmi/publications/studies/2011/mmi-caregiving-costs-working-caregivers.pdf" target="_blank">MetLife report</a> showed. Further, 10 percent of caregivers had missed at least one day of work over a two week period because of health issues compared to 9 percent for non-caregivers.{/t}
			</p>
			<div id="question1" class="question">
				<p>
					<b>{t}Workers with caregiving responsibility report more difficulty than non-caregivers in taking care of their health.{/t}</b><br />
					<select>
						<option selected="selected" value="select">{t}Select{/t}</option>
						<option value="1">{t}True{/t}</option>
						<option value="0">{t}False{/t}</option>
				...
				<p class="right-answer hide">
					{t}Correct!. According to the <a href="https://www.metlife.com/assets/cao/mmi/publications/studies/2011/mmi-caregiving-costs-working-caregivers.pdf" target="_blank">MetLife study</a>, workers do report more difficulty.{/t}
				</p>
				<p class="wrong-answer hide">
					{t}Incorrect. Please review the <a href="https://www.metlife.com/assets/cao/mmi/publications/studies/2011/mmi-caregiving-costs-working-caregivers.pdf" target="_blank">MetLife study</a> for current statistics.{/t}
				</p>
			</div>
		</div>
		<div class="buttons">
 ...
 -->
	...
	<div id="slide-7" class="course-slide">
		<div class="content">
			...
			<p>
				{t}According to the Health Advocate, their report <a href="http://www.healthadvocate.com/downloads/webinars/caregiving.pdf" target="_blank">Caregiving: Impact on the Workplace</a>, when it comes to caregiving programs, employees say they want:{/t}
			</p>
			<ul>
