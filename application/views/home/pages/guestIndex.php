...
<div id="sidebar">
	...
	<div class="box-sidebar zero">
		...
		<a href="<?php echo $this->createUrl('home/contact'); ?>"
			class="teal"><?php echo t( 'Request Information'); ?></a>
		<a href="#tutorial" class="teal tutorial-box"><?php echo t( 'Tutorial'); ?></a>
	</div>
	...
	<div class="box-sidebar one">
		...
		<div>
			<img
				...
				style="margin-bottom: 8px;" /><br /><?php echo t( '2/3 of working caregivers
...
<div class="column-wide">
	<h2 class="flowers" style="font-family:" SourceSansPro", Arial, sans-serif;"><?php echo t( 'Mather
	...
	<p>
		<a href="<?php echo Yii::app()->request->baseUrl; ?>/limeSurvey/index.php/survey/index/sid/842365"
			class="fancybox extLink button"><?php echo t( 'HR/Employer Survey'); ?></a> 
		<a href="<?php echo Yii::app()->request->baseUrl; ?>/limeSurvey/index.php/survey/index/sid/419973"
			class="fancybox extLink button"><?php echo t( 'Caregiver Survey'); ?></a>
	</p>
