...
<div class="box-sidebar zero"><a
	href="<?php echo $this->createUrl('user/register'); ?>"> <?php echo t('Register'); ?>
</a> <a href="<?php echo $this->createUrl('home/contact'); ?>"
	class="teal"> <?php echo t('Request Information'); ?> </a> <a
	href="#tutorial-slide-1" rel="tutorial" class="teal"> <?php echo t('Tutorial'); ?>
</a> <a href="#tutorial-slide-2" rel="tutorial" style="display: none"></a>
<a href="#tutorial-slide-3" rel="tutorial" style="display: none"></a> <a
	href="#tutorial-slide-4" rel="tutorial" style="display: none"></a> <a
	href="#tutorial-slide-5" rel="tutorial" style="display: none"></a> <a
	href="#tutorial-slide-6" rel="tutorial" style="display: none"></a> <a
	href="#tutorial-slide-7" rel="tutorial" style="display: none"></a></div>
...
<?php echo t('2/3 of working caregivers
					...
					shifting to other employees.'); ?></div>
</div>

<div class="box-sidebar two">
<h3><?php echo t('Recent Research'); ?></h3>
<div style="text-align: center"><img
	src="<?php echo Yii::app()->theme->getImagesUrl(); ?>/metlife.jpg" /></div>
<p><?php echo t('<strong>Double Jeopardy for Baby Boomers Caring for Their Parents</strong><br />
					...
					impact of caregiving on their earnings and lifetime wealth.'); ?></p>
<p><a
	...
	class="pdf"><?php echo t('Read "The MetLife Study of Working Caregivers and
				Employer Health Care Costs"'); ?> </a></p>
</div>

<div class="box-sidebar three">
<h3><?php echo t('Whitepapers'); ?></h3>
<p><a
	...
	class="pdf"><?php echo t('The Bottom Line: How e-Learning Can Reduce Expenses and
				Improve Staff Performance'); ?> </a></p>
</div>

<div class="box-sidebar four"><!-- text here
...
e-newsletter and blog containing the latest research news in the field
of aging.</p>
<p style="text-align: center;"><a
	href="http://twitter.com/aginginaction" target="_blank"> <img
	src="<?php echo Yii::app()->theme->getImagesUrl(); ?>/twitter-bird.png" />
</a></p>
<p>Evanston, IL &bull; <a href="http://www.aginginaction.com">www.aginginaction.com</a>
</p>
<div class="clear"></div>
</div>
...
<div id="customers"><a href="http://www.ibm.com"><img
	...
	alt="Merck Pharmaceuticals" /> </a> <a href="http://www.exxonmobil.com"><img
	src="<?php echo Yii::app()->theme->getImagesUrl(); ?>/customers/exxon.png"
	alt="Merck Pharmaceuticals" /> </a> <a href="http://www.deloitte.com"><img
...
<p><?php echo t('Used by individuals and entire organizations, our nationally
...
<h2 class="flowers top-pad"><?php echo t('Online
				Courses for Caregivers'); ?></h2>
<p style="padding-bottom: 5px;"><?php echo t( 
...
<h2 class="flowers top-pad"><?php echo t('A Closer Look - Lives of Caregivers'); ?>
</h2>

<p style="padding-bottom: 10px;"><?php echo t( 
...
<div class="box-grey" style="float: left;"><?php 
$this->widget(
				'ext.Jplayer.Jplayer',
array(
...
Asssociation</a> <a href="https://github.com/" id="git" target="_blank">GitHub</a>
<a href="http://www.yiiframework.com/" id="yii" target="_blank">Yii
Framework</a> <a href="http://wfd.com/" id="wfd" target="_blank">WFD</a>
<a href="http://www.discoursellc.com/" id="discourse" target="_blank">Discourse,
...
LifeWays Institute on Aging. This short, online tutorial was designed to
help demonstate our course model. Please feel free to contact us if you
have questions, suggestions, or just need help.</p>

<p>This tutorial will briefly explain Dementia, Alzheimer's Disease and
how their related. This short lesson is meant to be a very basic
...
<p><a href="javascript:;" onclick="$.fancybox.next();" class="button">Start
Tutorial&raquo;</a></p>
</div>
...
<ul>
	...
	<li>Explore data and statistics regarding Alzheimer's and Dementia (US)</li>
</ul>

<p>Memory loss and other signs of mental decline have profound effects
on the lives of individuals and families. Nevertheless, we are convinced
that a good quality of life can still be maintained for all concerned by
learning to make changes in lifestyle and outlook. For many family
members, this involves a change in relationships and priorities. At
times the demands may seem overwhelming, but understanding the type of
cognitive impairment can be the first step in combating a challening
situation.</p>
...
functions due to a brain disorder. Dementia is not a specific disease.
It's an overall term that describes a wide range of symptoms associated
with a decline in memory or other thinking skills severe enough to
reduce a person's ability to perform everyday activities. A medical
diagnosis is required to determine the underlying cause or causes of
symptoms.</p>

<p><strong>Symptoms and signs of dementia</strong></p>
...
keeping track of a purse or wallet, paying bills, planning and preparing
...
that slowly destroys memory, thinking skills, behavior, and eventually
...
symptoms first appear after age 60. Alzheimer’s disease is the most
...
<p><strong>Symptoms and signs of Alzheimer's disease</strong></p>
...
<ul>
	...
	<li>Difficulty completing familir tasks at home, at work or at leisure</li>
...
spatial relationships</input><br>
<input type="checkbox" value="2">New problems with words in speaking or
writing</input><br>
<input type="checkbox" value="3">Misplacing things and losing the
ability to retrace steps</input><br>
<input type="checkbox" value="4">Withdrawal from work or social
activities</input><br>
<input type="checkbox" value="5">Changes in mood and personality</input><br>
...
<p><iframe width="450" height="290"
	src="http://www.youtube.com/embed/In1IJocVor8?rel=0" frameborder="0"
	allowfullscreen="" align="right"></iframe></p>

<p><strong>Alzheimer's disease</strong></p>

<ul>
	<li>Alzheimer's is the sixth-leading cause of death in the country and
	the only cause of death among the top 10 in the United States that
	cannot be prevented, cured or even slowed.</li>
	<li>An estimated 800,000 individuals with Alzheimer's (or one in seven)
	live alone.</li>
	<li>A new person develops Alzheimer's disease every 69 seconds -- this
	is projected to increase to every 33 seconds by 2050.</li>
	<li><a href="http://www.alz.org/downloads/facts_figures_2012.pdf"
		target="_blank">2012 Alzheimer's Disease Facts and Figures report</a></li>
</ul>
...
<input type="search" name="q" size="35" maxlength="255" value="" /> <input
	type="submit" value="Google Search" /></form>
...
your experience will be like. Your next step is to register, and begin
participating in the available courses. Click on the icon below to
downlod your certficiate:</p>
...
<p>Was the content depth and detail: <select>
	<option selected="selected" value="select">Select</option>
...
<p>How likely are you to participate in a full course, based on your
