	...
	<table id="options">
		<tr>
			...
			<td class="text-center">
				<?php echo CHtml::link(t('Agree'), $this->createUrl('agree', array('id' => $agreement->id))); ?>
			</td>
			<?php endif; ?>
			<td class="text-center">
				<?php echo CHtml::link(t('Download'), $this->createUrl('download', array('id' => $agreement->id)), array('target' => '_blank')); ?>
			</td>
		</tr>
	</table>
</div>