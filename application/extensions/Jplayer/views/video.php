<div id="<?php echo substr($cssSelectorAncestor, 1); ?>" class="jp-video <?php echo $size['cssClass']; ?>">
	<div class="jp-type-single">
		<div id="<?php echo substr($target, 1); ?>" class="jp-jplayer"></div>
		<div class="<?php echo substr($cssSelector['gui'], 1); ?>">
			<div class="<?php echo substr($cssSelector['videoPlay'], 1); ?>">
				<a href="javascript:;" class="jp-video-play-icon" tabindex="1"><?php echo Yii::t(Jplayer::$componentId, 'Play'); ?></a>
			</div>
			<div class="jp-interface">
				...
				<div class="jp-controls-holder">
					...
					<ul class="jp-toggles">
						<li><a href="javascript:;" class="<?php echo substr($cssSelector['fullScreen'], 1); ?>" tabindex="1" title="<?php echo Yii::t(Jplayer::$componentId, 'Full Screen'); ?>"><?php echo Yii::t(Jplayer::$componentId, 'Full Screen'); ?></a></li>
						<li><a href="javascript:;" class="<?php echo substr($cssSelector['restoreScreen'], 1); ?>" tabindex="1" title="<?php echo Yii::t(Jplayer::$componentId, 'Restore Screen'); ?>"><?php echo Yii::t(Jplayer::$componentId, 'Restore Screen'); ?></a></li>
