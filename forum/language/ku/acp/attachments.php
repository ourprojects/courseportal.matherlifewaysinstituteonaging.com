...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'	=> 'زۆرترین قەبارە بۆ هەر پەڕگەیەک. ئەگەر ئەم نرخە بۆ 0 دانرێت، قەبارەی پەڕگەی بارکراو تەنها دەتوانرێ لەلایەن ڕێکخستنەکانی PHP سنوردار بکرێت.',
	...
	'EXT_GROUP_DOCUMENTS'			=> 'بەڵگەنامەکان',
	'EXT_GROUP_DOWNLOADABLE_FILES'	=> 'پەڕگە بۆداگرتنەکان',
	'EXT_GROUP_FLASH_FILES'			=> 'پەڕگە فلاشەکان',
	'EXT_GROUP_IMAGES'				=> 'وێنەکان',
	'EXT_GROUP_PLAIN_TEXT'			=> 'نەخشەی دەق',
	'EXT_GROUP_QUICKTIME_MEDIA'		=> 'Quicktime ڕەنگاڵە',
	'EXT_GROUP_REAL_MEDIA'			=> 'Real Media',
	'EXT_GROUP_WINDOWS_MEDIA'		=> 'Windows Media',
