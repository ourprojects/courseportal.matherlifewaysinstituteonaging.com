...
$lang = array_merge($lang, array(
	...
	'XS_SH_TAG_VERSION'	=> 'زانیاری وەشانی BBCode نیشانبدە: [version][/version] یان [version /]',
	'XS_SH_TAG_SYNTAX'	=> '<b>بریسکەدارکردنی سیتاکس</b> : [syntax="php"] کۆد لێرە [/syntax] یان [syntax lang="php" filename="file.php" start="10"] کۆد لێرە [/syntax]',
