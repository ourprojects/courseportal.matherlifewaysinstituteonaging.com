...
/** 
*
* acp_common.php [Argentinian Spanish]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD_EXPLAIN'			=> '<var>mbstring.func_overload</var> se debe establecer en 0 o 4. Podes comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
	'ERROR_MBSTRING_ENCODING_TRANSLATION'			=> 'Codificación de caracteres transparentes no está configurado correctamente',
	'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'	=> '<var>mbstring.encoding_translation</var> se debe establecer en 0. Podés comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
	'ERROR_MBSTRING_HTTP_INPUT'						=> 'HTTP conversión de caracteres de entrada no está configurado correctamente',
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> se debe establecer en <samp>pass</samp>. Podes comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP conversión de caracteres de salida no está configurado correctamente',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> se debe establecer en <samp>pass</samp>. Podés comprobar el valor actual en la página de <samp>Información de PHP</samp>.',	
	...
	'WRITABLE_CONFIG'		=> 'En este momento tu archivo de configuración (config.php) permite escritura a todos. Te recomendamos de forma especial que cambiés los permisos a 640 ó al menos 644 (por ejemplo: <a href="http://es.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 644 config.php).',
));
