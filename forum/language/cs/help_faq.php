...
$help = array(
	...
	array(
		0 => 'Co znamená COPPA?',
		1 => 'COPPA, neboli Child Online Privacy and Protection Act of 1998 je zákon ve Spojených Státech, který má za úkol chránit mládež na internetu. Stránky, kde je potencionální možnost ukládání osobních dat o&nbsp;uživateli, kterému je méně než 13&nbsp;let, musí mít souhlas rodičů nebo zákonných zástupců, aby tyto data uložil. Tento zákon však platí pouze v&nbsp;jurisdikci Spojených Států. Pokud si nejste jisti, jestli toto platí i na vašem fóru, doporučujeme kontaktovat vaše právního poradce, phpBB Teams nemůže a&nbsp;nebude poskytovat právní podporu v&nbsp;jakémkoliv kontextu.',
	),
	array(
		0 => 'Proč se nemohu registrovat?',
		1 => 'Je možné, že vlastník fóra zabanoval vaši IP adresu nebo zakázal použití uživatelského jména, které jste si zvolili. Administrátor také mohl vypnout registrace, aby zabránil přístupu nových návštěvníků na fórum. Pro další informace kontaktuje administrátora fóra.',
	),
	array(
  ...
  array(
	...
	array(
		...
		1 => 'Pokud jste členem více skupin, vaše výchozí skupina určuje, jakou barvu bude mít vaše uživatelské jméno. Administrátor fóra vám může udělit oprávnění měnit si svou výchozí skupinu přes uživatelský panel.'
	),
	array(
