...
$help = array(
	...
	array(
		0 => '必要な機能がありません',
		1 => 'このソフトウェアの作成を行ったのは phpBB Group であり著作権は phpBB Group が所有しています。その機能が必要だと思う場合または何らかのバグを報告したい場合、 phpBB Group 運営サイト <a href="http://area51.phpbb.com/">Area51</a> へ訪問してください。詳細はそちらに載せてあります。'
	),
	array(
