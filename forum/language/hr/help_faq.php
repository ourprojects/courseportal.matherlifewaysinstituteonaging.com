...
$help = array(
	...
	array(
		0	=> 'Što ako izgubim lozinku?',
		1	=> 'Nije smak svijeta! Jest da je tvoja trenutna lozinka izgubljena [jer je kriptirana u bazi i ne može ti biti ponovo poslana], no, možeš zatražiti novu.<br />Klikneš na <em>Prijava</em> te na stranici koja će ti se otvoriti klikneš na <em>Zaboravio/la sam lozinku</em>. Ispuniš tražene podatke... Daljnje upute će ti stići e-mailom.',
	),
	array(
		0	=> 'Registriran sam ali se ne mogu prijaviti?',
	...
	array(
		0	=> 'Registriran sam odavno ali se ne mogu prijaviti?',
	...
	array(
		...
		1	=> 'U pravilu, svoj status ne možeš direktno promijeniti.<br />Većina foruma koristi statuse da prikaže broj postova koje je postao/la određeni/a korisnik/ca, te da identificira korisnike/ce koji/e obavljaju određene funkcije na forumu [obično oni/e imaju poseban status, npr. administratori/ce, moderatori/ce].<br />Zloupotrebljavanje foruma, u smislu postanja puno postova samo zato da bi se dosegao što veći status, nema nikakvog smisla jer administratori(ce)/moderatori(ce) mogu <em>smanjiti</em> nečiji status [npr. smanjenjem broja postova...].',
	),
	array(
	...
	array(
		0	=> 'Što su ikone tema?',
		1	=> 'Mogućnost korištenja ikona omogućuje administrator/ica foruma.<br />Ikone teme, koje odabere administrator/ica foruma, je slika povezana s određenim postom koja bi trebala slikovno označavati sam sadržaj posta.',
	),
// Ovaj dio će se prebaciti na FAQ-Pitanja u drugom stupcu
	array(
		0	=> '--',
		1	=> '--',
	),
	...
	array(
		...
		1	=> 'Bookmarkiranje je slično bookmarkiranju web stranica. Ne dobiju se obavijesti o novim postovima, ali se može vratiti na temu bez traženja iste, dovoljno je kliknuti na nju na popisu bookmarkiranih tema.<br /> Pretplatom na temu i/ili forum omogućit ćeš primanje samih obavijesti o novim postovima.',
	),
	array(
	...
	array(
		...
		1	=> 'Administrator/ica određuje postanje kojih privitaka je dopušteno.<br />Ukoliko nisi siguran/na postanje kojih privitaka je dopušteno, kontaktiraj administratora/icu.',
	),
	array(
	...
	array(
		0	=> 'Zašto pojedina mogućnost nije dostupna?',
	...
	array(
		0	=> 'Tko prevodi ovaj forum?',
		1	=> 'Na ovoj verziji prijevoda radi i održava <a href="http://www.phpbb.com.hr/">phpbb.com.hr grupa volontera,</a> a isti je nastavak sa baznog prijevoda prijašnjih, odnosno zastarjelih verzija u izradi Ančice Sečan</a>.',
	),
);
