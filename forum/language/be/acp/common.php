...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD'					=> 'Перагрузка функцый настроена няправільна',
	'ERROR_MBSTRING_FUNC_OVERLOAD_EXPLAIN'			=> 'Параметр <var>mbstring.func_overload</var> павінен быць роўны 0 або 4. Вы можаце праверыць дзеючае значэнне на старонцы <samp>Звесткі аб PHP</samp>.',
	'ERROR_MBSTRING_ENCODING_TRANSLATION'			=> 'Пераўтварэнне кадовак наладжана няправільна',
	'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'	=> 'Параметр <var>mbstring.encoding_translation</var> павінен быць роўны 0. Вы можаце праверыць дзеючае значэнне на старонцы <samp>Звесткі аб PHP</samp>.',
	'ERROR_MBSTRING_HTTP_INPUT'						=> 'Кадоўка ўваходнага струменя HTTP настроена няправільна',
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> 'Параметр <var>mbstring.http_input</var> павінен быць роўны <samp>pass</samp>. Вы можаце праверыць дзеючае значэнне на старонцы <samp>Звесткі аб PHP</samp>.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'Кадоўка выходнага струменя HTTP настроена няправільна',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> 'Параметр <var>mbstring.http_output</var> павінен быць роўны <samp>pass</samp>. Вы можаце праверыць дзеючае значэнне на старонцы <samp>Звесткі аб PHP</samp>.',
