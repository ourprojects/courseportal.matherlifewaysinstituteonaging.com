...
$lang = array_merge($lang, array(
	...
	'BACKUP_NOTICE'					=> 'Стварыце рэзервовую копію канферэнцыі на выпадак ўзнікнення праблем у працэсе абнаўлення.',
	...
	'INST_ERR_DB_INVALID_PREFIX'=> 'Паказаны няправільны прэфікс. Ён павінен пачынацца з літары і можа ўтрымліваць толькі літары, лікі і знакі падкрэслення.',
	...
	'TABLE_PREFIX_EXPLAIN'		=> 'Прэфікс павінен пачынацца з літары і можа ўтрымліваць толькі літары, лікі і знакі падкрэслення.',
