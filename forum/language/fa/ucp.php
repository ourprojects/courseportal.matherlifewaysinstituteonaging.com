...
$lang = array_merge($lang, array(
    ...
    'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'برای تغییر کلمه عبور، آدرس ایمیل ویا نام کاربری خود، شما باید کلمه عبور خود را وارد نمایید.',
	
		'CUR_PASSWORD_EMPTY'		=> 'پسورد فعلی را وارد نکردید.',
