...
function login_yii($username, $password, $ip = '', $browser = '', $forwarded_for = '')
{
	if(defined('YII_PATH')) 
	{
		$webUser = Yii::app()->getUser();
		if(isset($webUser) && !$webUser->getIsGuest())
		{
			global $db, $config;
	...
	{
		return $method($username, $password, $ip, $browser, $forwarded_for);
	}
