 ...
 *
 */
	$system_path = dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'framework';
 ...
 */
	...
	if (isset($aSettings['config']['debug'])) {
        define('YII_DEBUG', $aSettings['config']['debug'] != 0);
...
require_once APPPATH . 'core' . DIRECTORY_SEPARATOR . 'LSYii_Application' . EXT;

Yii::createApplication('LSYii_Application', CONFIGPATH . 'config' . EXT)->run();
