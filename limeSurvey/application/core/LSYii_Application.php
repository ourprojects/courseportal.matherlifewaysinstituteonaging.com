...
class LSYii_Application extends CWebApplication
{
    ...
    */
    public function __construct($config = null)
    {
        ...
        {
            $config = CONFIGPATH . 'config-sample' . EXT;
        }
        parent::__construct($config);
        // Load the default and environmental settings from different files into self.
        $ls_config = require(CONFIGPATH . 'config-defaults' . EXT);
        $email_config = require(CONFIGPATH . 'email' . EXT);
        $version_config = require(CONFIGPATH . 'version' . EXT);
