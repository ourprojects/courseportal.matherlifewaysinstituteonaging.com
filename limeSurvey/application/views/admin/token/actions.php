...
?>
		<a href="#" alt="<?php $clang->eT("Delete the selected entries");?>" 
		   	onclick="if (confirm('<?php $clang->eT("Are you sure you want to delete the selected entries?","js");?>')) { <?php echo convertGETtoPOST($this->createUrl("admin/tokens/delete/$surveyid/")."?action=tokens&amp;sid={$surveyid}&amp;subaction=delete&amp;tokenids=$id&amp;limit={$limit}&amp;start={$start}&amp;order={$order}");?>}" title="<?php $clang->eT("Delete the selected entries");?>">
		...
		onclick="if (confirm('<?php $clang->eT("Are you sure you want to delete the selected entries?","js");?>')) { <?php echo convertGETtoPOST($this->createUrl("admin/tokens/delete/$surveyid/")."?action=tokens&amp;sid={$surveyid}&amp;subaction=delete&amp;tokenids=$id&amp;limit={$limit}&amp;start={$start}&amp;order={$order}");?>}"  />
	<?php }
	...
	{ ?>
		...
		onclick="<?php echo convertGETtoPOST($this->createUrl("admin/tokens/email/surveyid/$surveyid/tids")."?tokenids=$id");?>" />
		...
		onclick="<?php echo convertGETtoPOST($this->createUrl("admin/tokens/remind/surveyid/$surveyid/tids")."?tokenids=$id");?>" />
<?php } ?> -->
